...
use App\Http\Controllers\Guru\WaliKelas\TindakanPelanggaranController;
...
Route::middleware(['token_staff'])->group(function () {
    Route::prefix('guru')->group(function () {
        ...
        Route::prefix('reward-siswa')->group(function () {
            ...
            Route::get('input-reward-insidentil', [InputRewardSiswaController::class, 'viewInputRewardSiswa']);
        ...
        Route::prefix('wali-kelas')->group(function () {
            ...
            Route::post('rekap-pelanggaran-kelas/edit/{id}', [WaliKelasInputPelanggaranController::class, 'actionTindakanPelanggaran']);
        ...
        Route::prefix('rapor-sisipan')->group(function () {
            ...
            Route::prefix('daftar-nilai-sas')->group(function () {
                ...
                Route::get('inputNilai/{id}', [RaporSisipanAkhirController::class, 'inputNilai']);
                Route::get('getNilai/{id}', [RaporSisipanAkhirController::class, 'getNilai']);
                Route::get('print/{id}', [RaporSisipanAkhirController::class, 'printDaftarNilaiSAS']);
                Route::get('pdf/{id_semester}/{id_kelas}', [CetakRaporController::class, 'printCetakRapor2']);
                Route::post('action-daftar-nilai-sas/{mode}/{id}', [RaporSisipanAkhirController::class, 'actionDaftarNilaiSAS']);
