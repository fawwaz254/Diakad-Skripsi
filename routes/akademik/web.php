    ...
    Route::prefix('akademik')->group(function () {
        ...
        Route::prefix('mpmp')->group(function () {
            ...
            Route::prefix('laporan-mgmp')->group(function () {
                ...
                Route::get('/{id_pengguna}', [DataKategoriMGMPController::class, 'showDataByUserId']);
        ...
        Route::prefix('rapor-agama')->group(function () {
            ...
            Route::prefix('cetak-rapor')->group(function () {
                ...
                Route::get('/print/{id_semester}/{id_kelas}', [CetakRaporAgamaController::class, 'printCetakRaporAgama']);
        ...
        Route::prefix('monitoring')->group(function () {
            ...
            // MENU Monitoring Presensi Siswa
            Route::get('monitoring-presensi', [MonitoringPresensiSiswaController::class, 'viewMonitoringPresensiSiswa']);
            Route::get('monitoring-presensi/{id_kelas}/{bulan}/{tahun}', [MonitoringPresensiSiswaController::class, 'viewDetailMonitoringPresensiSiswa']);
