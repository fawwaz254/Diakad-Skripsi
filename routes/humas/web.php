    ...
    Route::group(array('prefix' => 'humas'), function() {
        ...
        Route::group(array('prefix' => 'absensi'), function() {
			...
			Route::group(array('prefix' => 'histori-absensi'), function() {
				...
				Route::get('edit/{id_presensi_pengguna}/{start_date}/{end_date}', 'Humas\Absensi\HistoriAbsensiController@editHistoriAbsensi');
				Route::delete('delete/{id_presensi_pengguna}', 'Humas\Absensi\HistoriAbsensiController@deleteHistoriAbsensi');	
