    ...
    Route::prefix('humas')->group(function () {
        ...
        Route::prefix('form-builder')->group(function () {
            ...
            Route::prefix('rekap-form')->group(function () {
                ...
                Route::get('rekap-bulanan-form-harian/export/{id_form}/{bulan}/{tahun}/{id_kelas?}/{id_pertanyaan?}', [RekapFormHarianController::class, 'exportRekapBulanan']);
        ...
        Route::prefix('absensi')->group(function () {
            ...
            Route::prefix('histori-absensi-siswa-sholat')->group(function () {
                Route::get('/', [HistoriAbsensiSiswaSholatController::class, 'viewHistoriAbsensiSiswa']);
                // Route::get('get-kelas/{id_jurusan}', [HistoriAbsensiSiswaController::class,'getKelas']);
            ...
            Route::prefix('rekap-pertanggal')->group(function () {
                ...
                Route::get('/cetak/{id_bulan}/{tahun}', [RekapPertanggalController::class, 'cetakRekapPertanggal']);
                Route::get('/export-pertanggal/{id_bulan}/{tahun}', [RekapPertanggalController::class, 'exportExcelRekapPertanggal']);
                ...
                Route::get('/cetak/siswa/{id_kelas}/{id_bulan}/{tahun}', [RekapPertanggalController::class, 'cetakRekapPertanggalSiswa',]);
                Route::get('/export-pertanggal-siswa/{id_kelas}/{id_bulan}/{tahun}', [RekapPertanggalController::class, 'exportExcelRekapPertanggalSiswa']);
            });
        });
