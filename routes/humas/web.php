	...
	Route::group(array('prefix' => 'humas'), function () {
		...
		Route::group(array('prefix' => 'absensi'), function () {
			...
			Route::group(array('prefix' => 'histori-absensi'), function () {
				...
				Route::get('/{id_pengguna}/{date}/{start_date}/{end_date}/add', 'Humas\Absensi\HistoriAbsensiController@createHistoriAbsensi');
				Route::post('/{id_pengguna}/{date}/{start_date}/{end_date}/add', 'Humas\Absensi\HistoriAbsensiController@storeHistoriAbsensi');
