...
Route::middleware(['token_staff'])->group(function () {
    Route::prefix('keuangan')->group(function () {
        ...
        Route::prefix('utility')->group(function () {
            ...
            Route::get('tagihan-siswa/view-detail-tagihan-siswa/{id_kelas}/{thn_akademik_semester}/{id_kelompok_biaya}/{id_jalur}/{is_insert_replace}', [TagihanSiswaController::class, 'viewDetailTagihanSiswa']);
            Route::get('tagihan-siswa/datatables/{id_kelas}/{thn_akademik_semester}/{id_kelompok_biaya}/{id_jalur}/{is_insert_replace}', [TagihanSiswaController::class, 'datatablesTagihanSiswa']);
        ...
        Route::prefix('sim')->group(function () {
            ...
            Route::prefix('spp')->group(function () {
                ...
                Route::post('tunggakanAlumni/get-detail-data-tungakan-alumni', [SppController::class, 'getDetailDataTungakanAlumni']);
