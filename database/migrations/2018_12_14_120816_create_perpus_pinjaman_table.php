...
class CreatePerpusPinjamanTable extends Migration {
	...
	public function up()
	{
		Schema::create('perpus_pinjaman', function(Blueprint $table)
		{
			...
			$table->timestamp('tgl_pinjaman')->nullable();
			$table->decimal('lama_pinjaman', 10, 0)->nullable()->comment('dalam hari');
			...
			$table->decimal('denda_kembali', 10, 0)->nullable()->comment('diisi apabila ada denda yg dikenakan kepada siswa');
			$table->timestamps();
