...
class AddDataKpiKelas9SmpYpmInPointKpi extends Migration
{
    /**
     * Run the migrations.
     *
            ...
            try {
                ...
                if ($sekolah->nm_singkat_sekolah == 'smpypm1' || $sekolah->nm_singkat_sekolah == 'smpypm2') {
                    if ($kelompok_kpi1) {
                        ...
                        $point_kpi->id_kelompok_kpi = $kelompok_kpi1->id_kelompok_kpi;
                        $point_kpi->id_semester = $semester->id_semester;
                        $point_kpi->nm_point_kpi = "Kecakapan menghapal lafal adzan dan iqamah beserta jawaban dan do'a sesudah adzan";
                        $point_kpi->tingkat_kelas = '9';
                        $point_kpi->urutan = '3';
                        $point_kpi->deskripsi =  [
                            'A' => "Sangat mampu menghapal lafal adzan dan iqamah beserta jawaban dan do'a sesudah adzan",
                            'B' => "Mampu menghapal lafal adzan dan iqamah beserta jawaban dan do'a sesudah adzan",
                            'C' => "Cukup mampu menghapal lafal adzan dan iqamah beserta jawaban dan do'a sesudah adzan",
                            'D' => "Kurang mampu menghapal lafal adzan dan iqamah beserta jawaban dan do'a sesudah adzan",
                        ];
                        $point_kpi->jenis = '1';
                        $point_kpi->save();
                        $point_kpi = null;
