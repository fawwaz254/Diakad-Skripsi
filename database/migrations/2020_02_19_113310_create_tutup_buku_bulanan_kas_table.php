...
class CreateTutupBukuBulananKasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tutup_buku_bulanan_kas', function (Blueprint $table) {
            ...
            $table->float('kas_spp', 10, 0)->nullable();
            $table->float('kas_rapb_penerimaan', 10, 0)->nullable();
            $table->float('kas_rapb_pengeluaran', 10, 0)->nullable();
            $table->float('kas_akhir_bulan', 10, 0)->nullable();
            $table->timestamps();
