...
class CreateTutupBukuRapbTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tutup_buku_rapb', function (Blueprint $table) {
            ...
            $table->decimal('jml_rapb_penerimaan', 10, 0)->nullable();
            $table->decimal('jml_realisasi_penerimaan', 10, 0)->nullable();
            $table->decimal('jml_selisih_penerimaan', 10, 0)->nullable();
            $table->decimal('jml_rapb_pengeluaran', 10, 0)->nullable();
            $table->decimal('jml_realisasi_pengeluaran', 10, 0)->nullable();
            $table->decimal('jml_selisih_pengeluaran', 10, 0)->nullable();
            $table->timestamps();
