...
class CreateInventarisHabisPakaiJurnalTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('inventaris_habis_pakai_jurnal', function (Blueprint $table) {
            ...
            $table->float('debit_harga', 10, 0)->default(0)->nullable();
            $table->float('debit_jumlah', 10, 0)->default(0)->comment('qty * harga')->nullable();
            $table->integer('kredit_qty')->default(0)->nullable();
            $table->float('kredit_harga', 10, 0)->default(0)->nullable();
            $table->float('kredit_jumlah', 10, 0)->default(0)->comment('qty * harga')->nullable();
            $table->integer('saldo_akhir_qty')->default(0)->nullable();
            $table->float('saldo_akhir_harga', 10, 0)->default(0)->nullable();
            $table->float('saldo_akhir_jumlah', 10, 0)->default(0)->comment('qty * harga')->nullable();
