...
class AddDataKpiKelas10Kel2SmaSmkYpmInPointKpi extends Migration
{
    /**
     * Run the migrations.
     *
                ...
                if (in_array($sekolah->nm_singkat_sekolah, $nm_singkat_sma_smk_ypm)) {
                    if ($kelompok_kpi2) {
                        ...
                        $point_kpi->deskripsi =  [
                            ...
                            'C' => "Jarang melaksanakan Shalat Subuh",
                        ...
                        $point_kpi->deskripsi =  [
                            ...
                            'C' => "Jarang melaksanakan Shalat Ashar",
                        ...
                        $point_kpi->deskripsi =  [
                            ...
                            'C' => "Jarang melaksanakan Shalat Maghrib",
                        ...
                        $point_kpi->deskripsi =  [
                            ...
                            'C' => "Jarang melaksanakan Shalat Isya'",
