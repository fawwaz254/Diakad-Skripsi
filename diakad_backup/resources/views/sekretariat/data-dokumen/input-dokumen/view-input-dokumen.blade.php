<div class="container-fluid">
    <div class="block-header">
        <h2>
            <a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#data-dokumen/input-dokumen/add')}}"><i class="material-icons">note_add</i><span>Tambah Data Dokumen</span></a>
        </h2>
    </div>
