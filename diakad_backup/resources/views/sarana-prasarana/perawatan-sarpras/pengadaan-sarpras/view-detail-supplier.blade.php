        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="body">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        aria-invalid="true" value="{{ $data_rpb_sarpras->tahun_ajaran }} {{ $data_rpb_sarpras->nm_semester }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="block-header">
                        <h2>
                            <a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#perawatan-sarpras/pengadaan-sarpras/add-supplier/'.$data_rpb_sarpras->id_rpb_sarpras)}}"><i class="material-icons">note_add</i><span>TAMBAH PENGADAAN SUPPLIER</span></a>
                        </h2>
                    </div>
...
<script>
    ...
    var datatable_url           = base_url + '/' + role_url + '/' + modul_url + '/' + 'pengadaan-sarpras/datatables/' + id_rpb_sarpras;
    var apv_supplier_url        = base_url + '/' + role_url + '/' + modul_url + '/' + 'action-apv-pengadaan/approve-supplier';
    var apv_edit_supplier_url   = role_url + '#' + modul_url + '/' + 'pengadaan-sarpras/edit-apv-supplier/' + id_rpb_sarpras;
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [
            ...
            { data: 'harga_supplier', name: 'harga_supplier' },
            { data: 'harga_penawaran', name: 'harga_penawaran' },
            { data: 'qty_penawaran', name: 'rpb_sarpras_supplier.qty_penawaran' },
            { data: 'termin_penawaran', name: 'rpb_sarpras_supplier.termin_penawaran' },
            ...
            { data: 'edit_apv_supplier', name: 'edit_apv_supplier', searchable: false, orderable: false,
                render: function(data){
                    return '<a class="target-link btn btn-info btn-circle waves-effect waves-circle waves-float" href="'+ apv_edit_supplier_url + '/' + data.id +'">'+
                        '    <i class="material-icons">edit</i>'+
                        '</a> ';
                }
            },
            { data: 'nm_approve', name: 'nm_approve', searchable: false, orderable: false,
                render: function(data){
                    if(data.is_approve == 0) {
                        return '<button class="btn btn-info btn-circle waves-effect waves-circle waves-float" onclick="cekSupplierAction(\''+ apv_supplier_url +'\', this)" data-idrpbsupplier="'+  data.id_rpb_sarpras_supplier +'">'+
