                ...
                <div class="body">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select class="form-control show-tick" name="id_periode_magang" id="id_periode_magang" required="">
                    ...
                    <div class="row clearfix">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <a class="btn btn-success" target="_blank" href="{{asset('data-magang.xlsx')}}">Download Template Excel</a>
                        </div>
                    </div>
