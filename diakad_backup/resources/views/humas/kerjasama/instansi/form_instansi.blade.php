                    ...
                    <form id="form-validation" method="POST" class="row"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="bidang_usaha" required=""
                                ...
                                value="{{ !empty($instansi) ? $instansi->bidang_usaha : '' }}">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h2 class="card-inside-title"> Kontak </h2>
                            <input type="text" class="form-control" name="kontak" required=""
                                aria-required="true" aria-invalid="true"
                                value="{{ !empty($instansi) ? $instansi->kontak : '' }}">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <textarea class="form-control" name="alamat" required="" aria-required="true" aria-invalid="true" required=""> {{ !empty($instansi) ? $instansi->alamat : '' }} </textarea>
                        </div>
