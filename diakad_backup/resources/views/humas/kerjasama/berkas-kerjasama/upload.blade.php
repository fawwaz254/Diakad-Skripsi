            ...
            <div class="card">
                ...
                <div class="body">
                    <form id="formUpload" method="POST"
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <button class="btn btn-block bg-red waves-effect" disabled id="upload" type="submit"><i
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                            <form style="display: flex; flex-direction: column" id="form-validation" method="POST"
                                ...
                                <a href="{{ $berkas->path }}" target="_blank">
                                    @if (in_array(pathinfo($berkas->nama_file, PATHINFO_EXTENSION),
                                    ['jpg','jpeg','bmp','png']))
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <button class="btn btn-danger bg-red waves-effect" id="delete" type="submit"><i
