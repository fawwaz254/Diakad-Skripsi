    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/post-view-absensi-siswa')}}">
                        {{csrf_field()}}
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="datepicker form-control" name="tgl_mulai" required="" aria-required="true" aria-invalid="true"
                                    value="@if($tgl_mulai != null) {{strftime( '%d %B %Y', strtotime($tgl_mulai))}} @endif" readonly>
                            </div>
                        </div>
                        <h2 class="card-inside-title">
                            Tanggal Selesai <br>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="datepicker form-control" name="tgl_selesai" required="" aria-required="true" aria-invalid="true"
                                    value="@if($tgl_selesai != null) {{strftime( '%d %B %Y', strtotime($tgl_selesai))}} @endif" readonly>
                            </div>
                        </div>
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
