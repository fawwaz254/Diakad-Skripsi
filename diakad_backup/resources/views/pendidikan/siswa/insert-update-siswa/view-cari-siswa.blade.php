    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        CARI DATA UPDATE SISWA
                    </h2>
                </div>
                <div class="body">
                    <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/post-view-update-siswa')}}">
                        {{csrf_field()}}
...
<script>
    ...
    var modul_url       = 'siswa';
    var datatable_url   = base_url + '/' + role_url + '/' + modul_url + '/' + 'insert-update-siswa/datatables/' + nis_nama_siswa ;
    var detail_url        = role_url + '#' + modul_url + '/' + 'insert-update-siswa/view-detail';
