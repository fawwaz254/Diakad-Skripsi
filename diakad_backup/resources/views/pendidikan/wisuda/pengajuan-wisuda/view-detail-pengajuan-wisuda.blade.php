<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                <form id="form-validation-2" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/action-pengajuan-wisuda/pengajuan/0/0/'.$id_periode_wisuda)}}">
                    {{csrf_field()}}
                    <div class="header">
...
<script>
    ...
    var datatable_url   = base_url + '/' + role_url + '/' + modul_url + '/' + 'pengajuan-wisuda/datatables/' + id_periode_wisuda + '/' + id_kelas;
                ...
                render: function(data){
                    if(data.id != null) {
                        if(data.status_wisuda == 2) {
                            ...
                            return '<a class="target-link btn btn-danger btn-circle waves-effect waves-circle waves-float" href="'+ cancel_url + '/' + data.id + '/' + id_periode_wisuda + '/' + id_kelas +'">'+
