        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            EDIT {{$pelatih->nm_pengguna}}
                        </h2>
                    </div>
                    <div class="body">
                        <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/action-setting-pelatih-ekskul/edit/'.$pelatih->id_pelatih_ekskul)}}">
                            {{csrf_field()}}
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    aria-invalid="true" value="{{$pelatih->nm_pengguna}}">
                                </div>
                            </div>
                            <h2 class="card-inside-title">
                                Gelar Depan
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    aria-invalid="true" value="{{$pelatih->gelar_depan}}">
                                </div>
                            </div>
                            <h2 class="card-inside-title">
                                Gelar Belakang
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    aria-invalid="true" value="{{$pelatih->gelar_belakang}}">
                                </div>
                            </div>
                            <h2 class="card-inside-title">
                                No. HP Pelatih
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    aria-invalid="true" value="{{$pelatih->nomor_hp_pelatih_ekskul}}">
                                </div>
                            </div>
                            <h2 class="card-inside-title">
                               Alamat Pelatih
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    aria-invalid="true" value="{{$pelatih->alamat_pelatih_ekskul}}">
                                </div>
                            </div>
                             <h2 class="card-inside-title">
                                Status
