<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link " href="{{url(Request::segment(1).'#rapb/kategori-pengeluaran')}}"><i class="material-icons">backspace</i><span>Kembali Ke Kategori</span></a></h2>
    </div>
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#rapb/kategori-pengeluaran/sub/add/'.$data_kategori_rapb->id_kategori_rapb)}}"><i class="material-icons">note_add</i><span>Tambah Sub-Kategori Pengeluaran</span></a></h2>
    </div>
