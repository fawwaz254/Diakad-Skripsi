<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#' . Request::segment(2) . '/data-prestasi') }}"><i
            ...
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="post"
                        action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/data-prestasi/action/add/0') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="nm_prestasi" required=""
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control show-tick" name="peringkat">
                                    ...
                                    <option value="Juara 11">Juara 1</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="lokasi" required="" aria-required="true"
                                    aria-invalid="true">
                            </div>
