...
<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link " href="{{url(Request::segment(1).'#presensi/rekap-absen-tanpa-jadwal')}}"><i class="material-icons">backspace</i><span>Kembali</span></a></h2>
    </div>
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <div class="block-header">
                        <h2><a class="btn bg-blue waves-effect" target="_blank" href="{{url(Request::segment(1).'/presensi/rekap-absen-tanpa-jadwal/print/'.$id_kelas_mp)}}"><i class="material-icons">print</i><span>Cetak</span></a></h2>
                    </div>
