                ...
                <div class="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <input type="text" class="datepicker form-control" name="on_date" required=""
                                aria-required="true" aria-invalid="true"
                                value="{{ \Carbon\Carbon::today('Asia/Jakarta')->format('Y-m-d') }}">
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <button class="btn btn-block bg-red waves-effect" onclick="onFilterAction()"><i
