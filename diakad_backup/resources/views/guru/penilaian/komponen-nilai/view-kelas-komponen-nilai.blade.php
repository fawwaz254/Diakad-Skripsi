<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link " href="{{url(Request::segment(1).'#penilaian/komponen-nilai')}}"><i class="material-icons">backspace</i><span>Kembali</span></a></h2>
    </div>
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#penilaian/komponen-nilai/add/'.$data_kelas->id_kelas_mp)}}"><i class="material-icons">note_add</i><span>Tambah Komponen Nilai</span></a></h2>
    </div>
...
<script>
    ...
    var datatable_url   = base_url + '/' + role_url + '/' + modul_url + '/' + 'komponen-nilai/datatables/' + id_kelas_mp;
    var edit_url        = role_url + '#' + modul_url + '/' + 'komponen-nilai/edit/' + id_kelas_mp;
    var delete_url      = base_url + '/' + role_url + '/' + modul_url + '/' + 'action-komponen-nilai/delete';
    var add_url         = base_url + '/' + role_url + '#' + modul_url + '/' + 'komponen-nilai/view-sub-komponen/' + id_kelas_mp;
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [
            ...
            { data: 'jumlah_sub_komponen_mp', name: 'jumlah_sub_komponen_mp'},
