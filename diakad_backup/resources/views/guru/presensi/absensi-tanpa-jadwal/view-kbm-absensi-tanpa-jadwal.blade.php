...
<script>
    ...
    var id_mata_pelajaran   = {!! json_encode($id_mata_pelajaran) !!};
    var id_kelas            = {!! json_encode($id_kelas) !!};

    var modul_url       = 'presensi';
    var datatable_url   = base_url + '/' + role_url + '/' + modul_url + '/' + 'absensi-tanpa-jadwal/datatables-kbm/' + id_guru + '/' + id_mata_pelajaran + '/' + id_kelas;
