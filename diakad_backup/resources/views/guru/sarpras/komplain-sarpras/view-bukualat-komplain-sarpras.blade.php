<div class="container-fluid">
    ...
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#sarpras/komplain-sarpras/bukualat-sarpras/add/'.$data_buku_alat->id_buku_alat)}}"><i class="material-icons">note_add</i><span>Tambah Komplain Sarpras</span></a></h2>
    </div>
...
<script>
    ...
    var datatable_url   = base_url + '/' + role_url + '/' + modul_url + '/' + 'komplain-sarpras/bukualat-sarpras/datatables/' + id_buku_alat;
