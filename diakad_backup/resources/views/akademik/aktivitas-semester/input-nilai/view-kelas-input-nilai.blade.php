<div class="container-fluid">
    ...
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#aktivitas-semester/input-nilai/add/'.$id_pengguna.'/'.$id_semester.'/'.$id_kelas_mp)}}"><i class="material-icons">note_add</i><span>Tambah Komponen Nilai</span></a></h2>
    </div>
        ...
        columns: [
            ...
            { data: 'action', name: 'action', searchable: false, orderable: false,
                render: function(data){
                    return '<a class="target-link btn btn-info btn-circle waves-effect waves-circle waves-float" href="'+ add_url + '/' + data.id +'/'+ id_kelas_mp + '/' + id_pengguna + '/' + id_semester +'">'+
