...
class CreateAdmisiTable extends Migration {
	...
	public function up()
	{
		Schema::create('admisi', function(Blueprint $table)
		{
			...
			$table->float('ips', 10, 0)->nullable()->comment('diisi ketika admisi aktif di tengah KBM');
			$table->float('ipk', 10, 0)->nullable()->comment('diisi ketika admisi aktif di tengah KBM');
			...
			$table->dateTime('tgl_keluar')->nullable()->comment('diisi ketika admisi keluar (bukan lulus)');
