...
{
    /** ALL GURU **/
	static function fetchDataAllGuru($auth_data, $id = null,$is_datatable = null) {
    ...
    static function fetchDataKelasGuru($auth_data, $id_pengguna, $id_semester = null) {
        // get id_guru
    ...
    static function fetchDataJadwalKBM($auth_data, $id_pengguna, $id_semester = null, $id_kelas_mp = null, $id_jadwal_kelas_mp = null,  $pertemuan_ke = null) {
        // get id_guru
        $guru = Guru::where('id_pengguna','=',$id_pengguna)->first();
        $id_guru = $guru->id_guru;
    ...
    static function fetchDataJadwalUTS($auth_data, $id_pengguna, $id_semester, $is_online = null, $id_ujian_mp = null) {
        // get id_guru
        $guru = Guru::where('id_pengguna','=',$id_pengguna)->first();
        $id_guru = $guru->id_guru;
    ...
    static function fetchDataJadwalUAS($auth_data, $id_pengguna, $id_semester, $is_online = null, $id_ujian_mp = null) {
        // get id_guru
        $guru = Guru::where('id_pengguna','=',$id_pengguna)->first();
        $id_guru = $guru->id_guru;
    ...
    static function fetchDataKelasMp($auth_data, $id_kelas_mp) {
    ...
    /** Komponen Nilai **/
    static function fetchDataKomponenNilai($auth_data, $id_kelas_mp, $id = null) {
        // get mode view
        if ($id == null){
    ...
    /** Wali Kelas **/
    static function fetchDataWaliKelas($auth_data, $id_kelas, $id = null){
    ...
    static function fetchDataWaliKelasBySemester($auth_data, $id_guru, $id_semester, $id = null){
    ...
    /** Home Visit **/
    static function fetchDataHomeVisit($auth_data, $id_semester, $id_guru, $id = null){
    ...
    static function fetchDataKelasKosong($auth_data) {
