...
class LibDataPelanggaran
{
    ...
    static function fetchDataSubkategoriPelanggaranByKategori($auth_data, $id_kategori_pelanggaran){
    ...
    static function fetchDataTindakanPelanggaran($auth_data, $status = null, $id = null, $is_datatable = null) {
        ...
        if ($id == null){
            ...
            elseif($status == "1") { 
                $tindakanPelanggaran = TindakanPelanggaran::select('tindakan_pelanggaran.id_tindakan_pelanggaran', 'pelanggaran_siswa.id_pelanggaran_siswa', 'pelanggaran_siswa.id_siswa', 'pelanggaran_siswa.id_guru_input', 'kategori_pelanggaran.id_kategori_pelanggaran', 'subkategori_pelanggaran.id_subkategori_pelanggaran',
                    ...
                    'jenis_tindakan.nm_jenis_tindakan', 'tindakan_pelanggaran.catatan_tindakan_pelanggaran', 'tindakan_pelanggaran.catatan_tindakan_pelanggaran_khusus', 'tindakan_pelanggaran.tgl_tindakan_pelanggaran', 'tindakan_pelanggaran.aktor_input_tindakan_pelanggaran', 'tindakan_pelanggaran.created_by as created_by_tindakan', 'p_tindakan.nm_pengguna as nm_input_tindakan', 'p_tindakan.gelar_depan as gelar_depan_tindakan', 'p_tindakan.gelar_belakang as gelar_belakang_tindakan', 'kelas.nm_kelas'
                    )
        ...
        // get mode edit
            ...
            $tindakanPelanggaran = TindakanPelanggaran::select('tindakan_pelanggaran.id_tindakan_pelanggaran', 'pelanggaran_siswa.id_pelanggaran_siswa', 'pelanggaran_siswa.id_siswa', 'pelanggaran_siswa.id_guru_input', 'kategori_pelanggaran.id_kategori_pelanggaran', 'subkategori_pelanggaran.id_subkategori_pelanggaran',
                    'pengguna.nm_pengguna as nm_siswa', 'p_guru.nm_pengguna as nm_guru_input', 'p_guru.gelar_depan as gelar_depan_guru', 'p_guru.gelar_belakang as gelar_belakang_guru', 'p_staff.nm_pengguna as nm_staff_input', 'p_staff.gelar_depan as gelar_depan_staff', 'p_staff.gelar_belakang as gelar_belakang_staff', 'kategori_pelanggaran.tingkat_kategori_pelanggaran', 'subkategori_pelanggaran.tingkat_subkategori_pelanggaran', 'subkategori_pelanggaran.keterangan_subkategori_pelanggaran', 'subkategori_pelanggaran.poin_subkategori_pelanggaran', 'pelanggaran_siswa.catatan_pelanggaran', 'pelanggaran_siswa.catatan_pelanggaran_khusus', 'pelanggaran_siswa.tgl_pelanggaran', 'pelanggaran_siswa.aktor_input_pelanggaran', 'pelanggaran_siswa.is_sudah_tindakan', 'pelanggaran_siswa.created_by',
                    'p_siswa_presensi.nm_pengguna as nm_siswa_presensi', 'p_guru_presensi.nm_pengguna as nm_guru_input_presensi', 'p_guru_presensi.gelar_depan as gelar_depan_guru_presensi', 'p_guru_presensi.gelar_belakang as gelar_belakang_guru_presensi', 'presensi_mp_pelanggaran.catatan_pelanggaran as catatan_pelanggaran_presensi', 'presensi_mp_pelanggaran.created_at as tgl_pelanggaran_presensi', 'presensi_mp_pelanggaran.is_sudah_tindakan as is_sudah_tindakan_presensi', 'presensi_mp_pelanggaran.created_by as created_by_presensi',
                    'jenis_tindakan.id_jenis_tindakan', 'jenis_tindakan.nm_jenis_tindakan', 'tindakan_pelanggaran.catatan_tindakan_pelanggaran', 'tindakan_pelanggaran.catatan_tindakan_pelanggaran_khusus', 'tindakan_pelanggaran.tgl_tindakan_pelanggaran', 'tindakan_pelanggaran.aktor_input_tindakan_pelanggaran', 'tindakan_pelanggaran.created_by as created_by_tindakan', 'kelas.nm_kelas'
                    )
                    ->join('jenis_tindakan','jenis_tindakan.id_jenis_tindakan','tindakan_pelanggaran.id_jenis_tindakan')
                    ->leftJoin('pelanggaran_siswa','pelanggaran_siswa.id_pelanggaran_siswa','=','tindakan_pelanggaran.id_pelanggaran_siswa')
                    ->leftJoin('presensi_mp_pelanggaran','presensi_mp_pelanggaran.id_presensi_mp_pelanggaran','=','tindakan_pelanggaran.id_presensi_mp_pelanggaran')
