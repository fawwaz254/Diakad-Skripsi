...
class LibDataPelanggaran
{
    ...
    public static function fetchDataPresensiPelanggaran($auth_data, $id = null, $is_datatable = null, $role = '-', $status_siswa = null, $filter_tanggal = null)
    {
        // get mode view
        if ($id == null) {
            $presensiMpPelanggaran = PresensiMpPelanggaran::select('presensi_mp_pelanggaran.id_presensi_mp_pelanggaran', 'presensi_mp_pelanggaran.id_siswa', 'siswa.nis_siswa', 'pengguna.nm_pengguna', 'p_guru.nm_pengguna as nm_guru_input', 'p_guru.gelar_depan as gelar_depan_guru', 'p_guru.gelar_belakang as gelar_belakang_guru', 'mata_pelajaran.kd_mata_pelajaran', 'mata_pelajaran.nm_mata_pelajaran', 'presensi_mp_pelanggaran.catatan_pelanggaran', 'presensi_mp_pelanggaran.created_at', 'presensi_mp.pertemuan_ke', 'presensi_mp_pelanggaran.id_presensi_mp', 'kelas.nm_kelas', 'kelas.id_kelas', 'presensi_mp_pelanggaran.id_subkategori_pelanggaran', 'kategori_pelanggaran.id_kategori_pelanggaran', 'subkategori_pelanggaran.nm_subkategori_pelanggaran')
    ...
    public static function fetchDataTindakanPelanggaran($auth_data, $status = null, $id = null, $is_datatable = null, $status_siswa = null, $filter_tanggal = null)
    {
        ...
        if ($id == null) {
            // belum ada tindakan
            if ($status == "0") {
                $tindakanPelanggaran = PelanggaranSiswa::select('pelanggaran_siswa.id_pelanggaran_siswa', 'pelanggaran_siswa.id_siswa', 'pelanggaran_siswa.id_guru_input', 'siswa.nis_siswa', 'kategori_pelanggaran.id_kategori_pelanggaran', 'subkategori_pelanggaran.id_subkategori_pelanggaran', 'pengguna.nm_pengguna', 'p_guru.nm_pengguna as nm_guru_input', 'p_guru.gelar_depan as gelar_depan_guru', 'p_guru.gelar_belakang as gelar_belakang_guru', 'p_staff.nm_pengguna as nm_staff_input', 'p_staff.gelar_depan as gelar_depan_staff', 'p_staff.gelar_belakang as gelar_belakang_staff', 'kategori_pelanggaran.tingkat_kategori_pelanggaran', 'subkategori_pelanggaran.tingkat_subkategori_pelanggaran', 'subkategori_pelanggaran.keterangan_subkategori_pelanggaran', 'subkategori_pelanggaran.poin_subkategori_pelanggaran', 'subkategori_pelanggaran.nm_subkategori_pelanggaran', 'pelanggaran_siswa.catatan_pelanggaran', 'pelanggaran_siswa.catatan_pelanggaran_khusus', 'pelanggaran_siswa.tgl_pelanggaran', 'pelanggaran_siswa.aktor_input_pelanggaran', 'pelanggaran_siswa.is_sudah_tindakan', 'pelanggaran_siswa.created_by', 'kelas.nm_kelas', 'kelas.id_kelas')
                    ->join('siswa', 'siswa.id_siswa', '=', 'pelanggaran_siswa.id_siswa')
                    ->join('kelas', 'pelanggaran_siswa.id_kelas', '=', 'kelas.id_kelas')
                    ->join('pengguna', 'pengguna.id_pengguna', '=', 'siswa.id_pengguna')
                    ->join('status_pengguna', 'pengguna.id_status_pengguna', '=', 'status_pengguna.id_status_pengguna')
                ...
                $tindakanPelanggaran = TindakanPelanggaran::select(
                    ...
                    'siswa.nis_siswa',
                    'siswa_mp.nis_siswa as nis_siswa_mp',
                    ...
                    'subkategori_pelanggaran_mp.nm_subkategori_pelanggaran as nm_subkategori_pelanggaran_mp',
                    ...
                    ->leftJoin('presensi_mp_pelanggaran', 'presensi_mp_pelanggaran.id_presensi_mp_pelanggaran', '=', 'tindakan_pelanggaran.id_presensi_mp_pelanggaran')->leftJoin('subkategori_pelanggaran', 'subkategori_pelanggaran.id_subkategori_pelanggaran', '=', 'pelanggaran_siswa.id_subkategori_pelanggaran')
                    ...
                    ->leftJoin('siswa as siswa_mp', 'siswa_mp.id_siswa', '=', 'presensi_mp_pelanggaran.id_siswa')
                    ...
                    ->orWhereNotNull('presensi_mp_pelanggaran.id_presensi_mp_pelanggaran')
                    ->when($status_siswa !== null && $status_siswa !== '0', function ($q) {
                        $q->where('status_pengguna.nm_status_pengguna', '=', 'AKTIF');
                    })
                    ->where('tindakan_pelanggaran.deleted_at', null)
                    ->orderBy('tindakan_pelanggaran.tgl_tindakan_pelanggaran', 'desc');
    ...
    /** AMBIL DATA PRESENSI MP PELANGGARAN **/
    public static function fetchDataPresensiPelanggaranByKelas($auth_data, $id = null, $is_datatable = null, $role = '-')
    {
        ...
        // get mode view
        if ($id == null) {
            $presensiMpPelanggaran = PresensiMpPelanggaran::select('presensi_mp_pelanggaran.id_presensi_mp_pelanggaran', 'presensi_mp_pelanggaran.id_siswa', 'pengguna.nm_pengguna', 'p_guru.nm_pengguna as nm_guru_input', 'p_guru.gelar_depan as gelar_depan_guru', 'p_guru.gelar_belakang as gelar_belakang_guru', 'mata_pelajaran.kd_mata_pelajaran', 'mata_pelajaran.nm_mata_pelajaran', 'presensi_mp_pelanggaran.catatan_pelanggaran', 'presensi_mp_pelanggaran.created_at', 'presensi_mp.pertemuan_ke', 'presensi_mp_pelanggaran.id_presensi_mp', 'kelas.nm_kelas', 'kelas.id_kelas', 'presensi_mp_pelanggaran.id_subkategori_pelanggaran', 'kategori_pelanggaran.id_kategori_pelanggaran', 'kategori_pelanggaran.tingkat_kategori_pelanggaran', 'subkategori_pelanggaran.nm_subkategori_pelanggaran')
                ->join('siswa', 'siswa.id_siswa', '=', 'presensi_mp_pelanggaran.id_siswa')
                ->join('kelas', 'presensi_mp_pelanggaran.id_kelas', '=', 'kelas.id_kelas')
                ->join('pengguna', 'pengguna.id_pengguna', '=', 'siswa.id_pengguna')
                ->join('pengguna as p_guru', 'p_guru.id_pengguna', '=', 'presensi_mp_pelanggaran.created_by')
    ...
    /** ========== **/
    public static function fetchDataTindakanPelanggaranByKelas($auth_data, $status = null, $id = null, $is_datatable = null)
    {
        $guru = Guru::where('id_pengguna', $auth_data->pengguna->id_pengguna)->first();
        $wali_kelas = WaliKelas::where('id_guru', $guru->id_guru)->where('is_aktif', 1)->first();
        ...
        if ($id == null) {
            // belum ada tindakan
            if ($status == "0") {
                $tindakanPelanggaran = PelanggaranSiswa::select(
                    'pelanggaran_siswa.id_pelanggaran_siswa',
                    'pelanggaran_siswa.id_siswa', 
                    'pelanggaran_siswa.id_guru_input', 
                    'kategori_pelanggaran.id_kategori_pelanggaran', 
                    'subkategori_pelanggaran.id_subkategori_pelanggaran', 
                    'pengguna.nm_pengguna', 'p_guru.nm_pengguna as nm_guru_input', 
                    'p_guru.gelar_depan as gelar_depan_guru', 
                    'p_guru.gelar_belakang as gelar_belakang_guru', 
                    'p_staff.nm_pengguna as nm_staff_input', 
                    'p_staff.gelar_depan as gelar_depan_staff', 
