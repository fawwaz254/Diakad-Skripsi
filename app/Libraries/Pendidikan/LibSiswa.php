...
class LibSiswa
{
    ...
    {
        $siswa = Siswa::select('siswa.id_siswa', 'pengguna.id_pengguna', 'siswa.nis_siswa', 'siswa.nisn_siswa', 'siswa.thn_masuk_siswa', 'pengguna.nm_pengguna', 'status_pengguna.nm_status_pengguna', 'siswa.id_kelas', 'kelas.nm_kelas', 'calon_siswa_baru.jenis_kelamin')
            ->join('pengguna', 'pengguna.id_pengguna', '=', 'siswa.id_pengguna')
            ->join('status_pengguna', 'status_pengguna.id_status_pengguna', '=', 'pengguna.id_status_pengguna')
            ->join('kelas', 'kelas.id_kelas', '=', 'siswa.id_kelas')
    ...
    public static function fetchDataSiswaByPenggunaTanpaKelas($auth_data, $id_pengguna)
    {
        $siswa = Siswa::select('siswa.id_siswa', 'pengguna.id_pengguna', 'siswa.nis_siswa', 'siswa.nisn_siswa', 'siswa.thn_masuk_siswa', 'pengguna.nm_pengguna', 'status_pengguna.nm_status_pengguna',  'calon_siswa_baru.jenis_kelamin')
            ->join('pengguna', 'pengguna.id_pengguna', '=', 'siswa.id_pengguna')
            ->join('status_pengguna', 'status_pengguna.id_status_pengguna', '=', 'pengguna.id_status_pengguna')
            ->leftJoin('calon_siswa_baru', function ($q) {
                $q->on('calon_siswa_baru.id_c_siswa', '=', 'siswa.id_c_siswa')
    ...
    public static function fetchDataDetailSiswa($auth_data, $nis_siswa)
    {
        $siswa = Siswa::select(
            ...
            'siswa.file_akte',
            'siswa.path_file_akte',
            'siswa.file_kk',
            'siswa.path_file_kk',
            'siswa.file_ijazah',
            'siswa.path_file_ijazah',
            ...
            'calon_siswa_baru.kode_voucher',
            'calon_siswa_baru.password',
            'calon_siswa_baru.nm_c_siswa',
            'calon_siswa_baru.nm_panggilan',
            'calon_siswa_baru.nik_siswa',
            'calon_siswa_baru.jenis_kelamin',
            'calon_siswa_baru.nisn_siswa',
            'calon_siswa_baru.id_agama',
            'calon_siswa_baru.id_kota_lahir',
            'calon_siswa_baru.tgl_lahir',
            'calon_siswa_baru.id_kota_ksk',
            'calon_siswa_baru.nomor_ksk',
            'calon_siswa_baru.nomor_identitas',
            'calon_siswa_baru.nomor_akta_lahir',
            'calon_siswa_baru.kewarganegaraan',
            'calon_siswa_baru.nm_kewarganegaraan',
            'calon_siswa_baru.id_kebutuhan_khusus',
            'calon_siswa_baru.alamat_jalan',
            'calon_siswa_baru.alamat_dusun',
            'calon_siswa_baru.alamat_kelurahan',
            'calon_siswa_baru.alamat_rt',
            'calon_siswa_baru.alamat_rw',
            'calon_siswa_baru.alamat_kecamatan',
            'calon_siswa_baru.alamat_kodepos',
            'calon_siswa_baru.alamat_kota',
            'calon_siswa_baru.alamat_provinsi',
            'calon_siswa_baru.alamat_latitude',
            'calon_siswa_baru.alamat_longitude',
            'calon_siswa_baru.nomor_hp',
            'calon_siswa_baru.id_jenis_tinggal',
            'calon_siswa_baru.anak_ke',
            'calon_siswa_baru.dari_x_bersaudara',
            'calon_siswa_baru.jarak_rumah_sekolah',
            'calon_siswa_baru.waktu_tempuh_sekolah_jam',
            'calon_siswa_baru.waktu_tempuh_sekolah_menit',
            'calon_siswa_baru.id_jenis_transportasi',
            'calon_siswa_baru.nomor_kks',
            'calon_siswa_baru.is_penerima_kps',
            'calon_siswa_baru.nomor_kps',
            'calon_siswa_baru.is_punya_kip',
            'calon_siswa_baru.nomor_kip',
            'calon_siswa_baru.nm_tertera_kip',
            'calon_siswa_baru.is_layak_pip',
            'calon_siswa_baru.id_jenis_layak_pip',
            'calon_siswa_baru.asal_sekolah',
            'calon_siswa_baru.asal_sekolah2',
            'calon_siswa_baru.alamat_asal_sekolah',
            'calon_siswa_baru.alamat_asal_sekolah2',
            'calon_siswa_baru.alasan_mutasi',
            'calon_siswa_baru.tanggal_mutasi_masuk',
            'calon_siswa_baru.nomor_sttb',
            'calon_siswa_baru.tanggal_sttb',
            'calon_siswa_baru.nomor_ujian_sebelumnya',
            'calon_siswa_baru.nomor_ijasah_sebelumnya',
            'calon_siswa_baru.nomor_skhus_sebelumnya',
            'calon_siswa_baru.tanggal_skhus_sebelumnya',
            'calon_siswa_baru.jarak_rumah_sekolah',
            'calon_siswa_baru.id_pilihan_jurusan_1',
            'calon_siswa_baru.id_pilihan_jurusan_2',
            'calon_siswa_baru.id_pilihan_jurusan_3',
            'calon_siswa_baru.nomor_ujian',
            'calon_siswa_baru.kegemaran_kesenian',
            'calon_siswa_baru.kegemaran_olahraga',
            'calon_siswa_baru.kegemaran_organisasi',
            'calon_siswa_baru.id_jurusan',
            'calon_siswa_baru.tgl_registrasi',
            'calon_siswa_baru.tgl_submit_form',
            'calon_siswa_baru.tgl_submit_verifikasi',
            ...
            'calon_siswa_baru.tgl_diterima',
            'calon_siswa_baru.tgl_generate_nis',
            'calon_siswa_baru.tgl_cetak_kartu_pelajar',
            'calon_siswa_baru.nm_beasiswa_thn_1',
            'calon_siswa_baru.nm_beasiswa_thn_2',
            'calon_siswa_baru.nm_beasiswa_thn_3',
            'jalur.nm_jalur',
            ...
            'calon_siswa_ortu.nomor_telp_ortu',
            'calon_siswa_ortu.nm_ibu',
            'calon_siswa_ortu.alamat_jalan_ortu',
            'calon_siswa_ortu.alamat_dusun_ortu',
            'calon_siswa_ortu.alamat_kelurahan_ortu',
            'calon_siswa_ortu.almat_rt_ortu',
            'calon_siswa_ortu.alamat_rw_ortu',
            'calon_siswa_ortu.alamat_kecamatan_ortu',
            'calon_siswa_ortu.alamat_kodepos_ortu',
            'calon_siswa_ortu.alamat_kota_ortu',
            'calon_siswa_ortu.alamat_provinsi_ortu',
            'agama.nm_agama',
            'kebutuhan_khusus.nm_kebutuhan_khusus',
            'jenis_tinggal.nm_jenis_tinggal',
            'jenis_transportasi.nm_jenis_transportasi',
            'calon_siswa_ortu.nik_ayah',
            'calon_siswa_ortu.nik_ibu',
            'calon_siswa_ortu.nik_wali',
            'calon_siswa_ortu.nm_wali',
            'calon_siswa_ortu.hub_wali',
            'calon_siswa_ortu.tgl_lahir_ayah',
            'calon_siswa_ortu.tgl_lahir_ibu',
            'calon_siswa_ortu.tgl_lahir_wali',
            'calon_siswa_baru.bahasa_sehari_hari',
            'calon_siswa_ortu.status_ayah',
            'calon_siswa_ortu.status_ibu',
            'calon_siswa_ortu.status_wali',
            'calon_siswa_ortu.alamat_jalan_ayah',
            'calon_siswa_ortu.alamat_dusun_ayah',
            'calon_siswa_ortu.alamat_kelurahan_ayah',
            'calon_siswa_ortu.almat_rt_ayah',
            'calon_siswa_ortu.alamat_rw_ayah',
            'calon_siswa_ortu.alamat_kecamatan_ayah',
            'calon_siswa_ortu.alamat_kodepos_ayah',
            'calon_siswa_ortu.alamat_kota_ayah',
            'calon_siswa_ortu.alamat_provinsi_ayah',
            'calon_siswa_ortu.alamat_jalan_ibu',
            'calon_siswa_ortu.alamat_dusun_ibu',
            'calon_siswa_ortu.alamat_kelurahan_ibu',
            'calon_siswa_ortu.almat_rt_ibu',
            'calon_siswa_ortu.alamat_rw_ibu',
            'calon_siswa_ortu.alamat_kecamatan_ibu',
            'calon_siswa_ortu.alamat_kodepos_ibu',
            'calon_siswa_ortu.alamat_kota_ibu',
            'calon_siswa_ortu.alamat_provinsi_ibu',
            'calon_siswa_fisik.tinggi_badan',
            'calon_siswa_fisik.berat_badan',
            'calon_siswa_fisik.riwayat_penyakit',
            'calon_siswa_fisik.riwayat_kelainan_jasmani',
            'calon_siswa_fisik.golongan_darah',
            'calon_siswa_ortu.id_kebutuhan_khusus_ibu',
            'calon_siswa_ortu.id_kebutuhan_khusus_ayah',
            'calon_siswa_ortu.id_jenis_pendidikan_ayah',
            'calon_siswa_ortu.id_jenis_pekerjaan_ayah',
            'calon_siswa_ortu.id_jenis_penghasilan_ayah',
            'calon_siswa_ortu.id_jenis_pendidikan_ibu',
            'calon_siswa_ortu.id_jenis_pekerjaan_ibu',
            'calon_siswa_ortu.id_jenis_penghasilan_ibu',
            ...
            'jpek_ayah.nm_jenis_pekerjaan as nm_jenis_pekerjaan_ayah',
            'jpek_ibu.nm_jenis_pekerjaan as nm_jenis_pekerjaan_ibu',
            'jpek_wali.nm_jenis_pekerjaan as nm_jenis_pekerjaan_wali',
            'jpeng_ayah.nm_jenis_penghasilan as nm_jenis_penghasilan_ayah',
            'jpeng_ibu.nm_jenis_penghasilan as nm_jenis_penghasilan_ibu',
            'jpeng_wali.nm_jenis_penghasilan as nm_jenis_penghasilan_wali',
            'kota_ayah.nm_kota as nm_kota_ayah',
