...
class LibDataAkademik
{
    ...
    static function fetchDataSemester($auth_data)
    {

        $semester = Semester::select('thn_akademik_semester', 'tahun_ajaran')->where('id_sekolah', '=', $auth_data->pengguna->id_sekolah)->orderBy('thn_akademik_semester', 'asc')->groupBy('tahun_ajaran', 'thn_akademik_semester')->get();
    ...
    static function fetchDataKalenderAkademik($auth_data, $id_semester, $id = null)
    {
        ...
        // get mode view
        if ($id == null) {
            $kalenderAkademik = JadwalKegiatan::select('jadwal_kegiatan.id_jadwal_kegiatan', 'kegiatan.nm_kegiatan', 'kegiatan.deskripsi_kegiatan', 'kegiatan.deskripsi_kegiatan as deskripsi', 'semester.tahun_ajaran', 'semester.nm_semester', 'jadwal_kegiatan.tgl_mulai', 'jadwal_kegiatan.tgl_selesai', 'jadwal_kegiatan.deskripsi')
