...
{
    /** KURIKULUM **/
	static function fetchDataKurikulum($auth_data, $id = null){
    ...
    static function fetchDataKelasMp($auth_data, $id = null){
    ...
    /** MATA PELAJARAN **/
    static function fetchDataMataPelajaran($auth_data, $id = null, $is_datatable = null){
