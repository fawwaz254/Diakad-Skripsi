...
class SetJadwalKelasGuruController extends Controller
{
    ...
    public function viewTambahJadwalKelas(Request $request, $id_kelas, $id_semester)
    {
        ...
        foreach ($jadwal as $j) {
            ...
            // else
            // dd($j['id_jadwal_jam'], $j['id_jadwal_jam_selesai']);
    ...
    public function viewSetKBMTanpaJadwal(Request $request)
    {
        ...
        return view('guru/jadwal/set-jadwal-kelas/kbm-tanpa-jadwal/view-kbm-tanpa-jadwal', compact('auth_data', 'data_kelas', 'data_semester'));
    }
    ...
    public function viewKBMTanpaJadwal(Request $request, $id_kelas, $id_semester)
    {
        ...
        return view('guru/jadwal/set-jadwal-kelas/kbm-tanpa-jadwal/detail-kbm-tanpa-jadwal', compact('auth_data', 'data_semester', 'data_kelas', 'kelas', 'semester', 'id_kelas', 'id_semester'));
    }
