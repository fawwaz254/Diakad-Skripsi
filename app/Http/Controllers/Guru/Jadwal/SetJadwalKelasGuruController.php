...
class SetJadwalKelasGuruController extends Controller
{
    ...
    public function viewTambahJadwalKelas(Request $request, $id_kelas, $id_semester)
    {
        ...
        return view('guru/jadwal/set-jadwal-kelas/tambah-set-jadwal-kelas', compact('auth_data', 'allruangan', 'data_semester', 'data_kelas', 'jadwal_jam', 'jadwal_hari', 'kelas', 'data_kelas_mp', 'semester', 'list_guru', 'data_jenis_mata_pelajaran', 'jam'));
    }
