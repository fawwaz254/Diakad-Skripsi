...
class RekapKesehatanController extends BaseController
{
    ...
    public function viewRekapFormKesehatan(Request $request, $id_bulan = null, $tahun = null){
        ...
        return view('guru/wali-kelas/rekap-kesehatan/view-rekap-kesehatan-siswa',compact('auth_data', 'dates', 'data_bulan', 'bulan', 'data_kelas', 'data_siswa', 'data_pengisian', 'tahun'));
    }
