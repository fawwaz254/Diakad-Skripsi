...
class RekapAbsenTanpaJadwalController extends BaseController
{
    public function viewRekapAbsenTanpaJadwal(Request $request)
    {
        ...
        $data = KelasMp::select('kelas_mp.id_kelas_mp', 'kelas_mp.id_semester', 'mata_pelajaran.kd_mata_pelajaran', 'mata_pelajaran.nm_mata_pelajaran', 'kelas.nm_kelas', 'jadwal_kelas_mp.id_jadwal_kelas_mp', )
