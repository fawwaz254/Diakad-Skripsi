...
namespace App\Http\Controllers\Guru\Sarpras;
...
class KomplainSarprasController extends BaseController
{
    ...
    public function viewKomplainSarpras(Request $request)
    {
        ...
        return view('guru/sarpras/komplain-sarpras/view-komplain-sarpras', compact('auth_data', 'data_ruangan', 'data_buku_alat'));
    }
    ...
    public function viewRuanganKomplainSarpras(Request $request, $id_ruangan)
    {
        ...
        return view('guru/sarpras/komplain-sarpras/view-ruangan-komplain-sarpras', compact('auth_data', 'data_ruangan'));
    }
    ...
    public function editRuanganKomplainSarpras(Request $request, $id_ruangan, $id)
    {
        ...
        return view('guru/sarpras/komplain-sarpras/edit-ruangan-komplain-sarpras', compact('auth_data', 'data_ruangan', 'data_inventaris_ruangan', 'data_komplain_sarpras'));
    }
    ...
    public function viewBukualatKomplainSarpras(Request $request, $id_buku_alat)
    {
        ...
        return view('guru/sarpras/komplain-sarpras/view-bukualat-komplain-sarpras', compact('auth_data', 'data_buku_alat'));
    }
    ...
    public function editBukualatKomplainSarpras(Request $request, $id_buku_alat, $id)
    {
        ...
        return view('guru/sarpras/komplain-sarpras/edit-bukualat-komplain-sarpras', compact('auth_data', 'data_buku_alat', 'data_komplain_sarpras'));
    }
