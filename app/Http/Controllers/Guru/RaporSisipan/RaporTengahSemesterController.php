...
class RaporTengahSemesterController extends Controller
{
    ...
    public function addRaporTengahSemester(Request $request)
    {
        $input = (object) $request->input();
        $auth_data = $input->auth_data;
        ...
        return view('guru/rapor-sisipan/rapor-tengah-semester/add-rapor-tengah-semester', compact('auth_data'), $data);
    }

    public function actionRaporTengahSemester(Request $request, $mode, $id = null)
    {
        ...
        if ($mode == 'delete') {
            ...
            return [
                'status' => 202,
                'path' => 'rapor-sisipan/rapor-tengah-semester',
                ...
                try {
                    ...
                    foreach ($siswa as $s) {
                        // foreach ($komponen_nilai as $komponen) {
                            ...
                            $nilai_rapor_sisipan->id_komponen_nilai                 = 0;
