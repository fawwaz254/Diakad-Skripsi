...
*/
        ...
        return view('ppdb/penetapan/data-penetapan/add-penetapan',compact('auth_data','data_jalur','data_semester_tahun','data_semester_nama','id_penetapan'));
    ...
    public function editPenetapan($id, Request $request) {
        ...
        $data_penetapan = Penetapan::orderBy('id_penetapan','desc')->get();
