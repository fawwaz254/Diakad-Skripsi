...
class RekapPertanggalController extends Controller
{
    ...
    public function chartAllRekapPertanggal(Request $request, $bulan, $tahun)
    {
        // set_time_limit(1800);
        $input = (object) $request->input();
        $auth_data = $input->auth_data;
        ...
        return view('humas/absensi/rekap-pertanggal/chart-rekap-pertanggal', compact('auth_data', 'data_bulan', 'data_tahun', 'dates', 'pengguna', 'bulan', 'tahun', 'hasil'));
    }
