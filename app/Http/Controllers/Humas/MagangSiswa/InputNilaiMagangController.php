...
class InputNilaiMagangController extends BaseController
{
    ...
    public function datatablesKomponenNilaiMagang(Request $request, $id_periode_magang){
        ...
        $nilai_siswa = NilaiMagang::select('nilai_magang.id_nilai_magang', 
                'nilai_magang.id_komponen_magang', 'nilai_magang.besar_nilai_magang', 
                'komponen_magang.nm_komponen_magang', 'periode_magang.nm_periode_magang', 
                'siswa.nis_siswa', 'pengguna.nm_pengguna', 'semester.nm_semester', 'semester.tahun_ajaran')
