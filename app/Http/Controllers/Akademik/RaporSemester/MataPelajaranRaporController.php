...
class MataPelajaranRaporController extends Controller
{
    ...
    public function addKomponenMataPelajaran(Request $request, $id_kelas)
    {
        ...
        $kelompok_mapel_rapor = KelompokMapelRapor::with('sub_kelompok_mapel_rapor')->get();
    ...
    public function actionKomponenMataPelajaran(Request $request, $mode, $id)
    {
        ...
        if ($validator->fails() && $mode != 'delete' && $mode != 'copy') {
            ...
            if ($mode == 'add') {
                ...
                $kelas_rapors = KelasRapor::where('id_kelas', $input->id_kelas)->get();
