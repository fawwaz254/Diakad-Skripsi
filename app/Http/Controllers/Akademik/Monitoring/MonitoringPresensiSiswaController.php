...
class MonitoringPresensiSiswaController extends Controller
{
    public function viewMonitoringPresensiSiswa(Request $request, $id_kelas = null, $id_bulan = null, $tahun = null)
    {
        ...
        return view('akademik/monitoring/view-monitoring-presensi-siswa', compact('auth_data', 'dates', 'data_bulan', 'bulan', 'tahun', 'data_kelas', 'data_siswa', 'data_array_presensi', 'id_kelas'));
    }
}
