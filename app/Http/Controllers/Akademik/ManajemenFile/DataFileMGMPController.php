...
class DataFileMGMPController extends Controller
{
    ...
    public function viewDataFileCategory(Request $request, $id)
    {
        ...
        return view('akademik/manajemen-file/data-file/view-data-file-category', compact('auth_data', 'sub_category', 'category'));
    }
    public function viewDataFileSubCategory(Request $request, $id)
    {
        ...
        return view('akademik/manajemen-file/data-file/view-data-file-sub-category', compact('auth_data', 'sub_category', 'files'));
    }

    public function dropdownCategory(Request $request)
    {
        $input = (object) $request->input();
        $sub_category = SubCategoryFileMGMP::where('category_file_mgmp_id', $input->category_file_id)->get();
        return $sub_category;
    }
    ...
    public function addDataFile(Request $request)
    {
        ...
        $category = CategoriFileMGMP::all();
        $sub_category = SubCategoryFileMGMP::all();

        return view('akademik/manajemen-file/data-file/add-data-file', compact('auth_data', 'category', 'sub_category'));
    }
    ...
    public function actionDataFile(Request $request, $mode, $id = null)
    {
        ...
        if ($mode == 'delete-many') {
            ...
            return [
                ...
                'path' => 'mpmp/data-file-mapel/sub-category/' . $input->sub_category_file_id,
