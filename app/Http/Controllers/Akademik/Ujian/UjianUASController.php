...
class UjianUASController extends BaseController
{
  public function viewUjianUas(Request $request, $id = 1)
  {
    # code...
  ...
  public function addUjianUas(Request $request, $id)
  {
    # code..
    $input = (object) $request->input();
    $auth_data = $input->auth_data;
  ...
  public function addDataUjianUas(Request $request, $online, $id)
  {
    ...
    return view('akademik/ujian/ujian-uas-reguler-online/add-ujian-uas', compact('auth_data', 'kegiatan', 'id', 'online', 'kegiatan', 'kelas_mp', 'ruangan'));
  }

  public function editDataUjianUas(Request $request, $id_ujian_mp)
  {
    # code..
    $input = (object) $request->input();
    $auth_data = $input->auth_data;
    ...
    return view('akademik/ujian/ujian-uas-reguler-online/edit-ujian-uas', compact('auth_data', 'ruangan', 'ujian', 'id_ujian_mp', 'tgl_ujian_mp'));
  }

  public function assignUjianUAS(Request $request, $id)
  {
    # code..
    $input = (object) $request->input();
    $auth_data = $input->auth_data;
    ...
    return view('akademik/ujian/ujian-uas-reguler-online/view-peserta-kelas', compact('auth_data', 'id', 'kelas', 'peserta'));
  }
  ...
  public function actionUjianUas(Request $request, $mode, $id = null)
  {
        ...
        try {
          foreach ($input->id_siswa as $id_siswa) {
            ...
            if ($cekSiswa) {
              ...
              return [
                'status' => 203, // GAGAL
                'message' => 'Tambah Peserta UAS Gagal Dilakukan!'
              ];
            } else {
