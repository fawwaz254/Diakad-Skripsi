...
class UpdateFotoUnitKerjaController extends Controller
{
    ...
    //     $list_unit_kerja = UnitKerja::where('id_sekolah', '=', auth_data()->pengguna->id_sekolah)->get();
    ...
    public function actionViewUpdateFoto(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return [
                ...
                'path' => 'data-sumber-daya/update-foto/view-detail-update-foto/'  . $input->status_join_table
            ];
        }
    }

    public function viewDetailUpdateFoto(Request $request,  $status_join_table = 0)
    {
        # code...
        $input = (object) $request->input();
        $auth_data = auth_data();
        ...
        return view('sumber-daya/data-sumber-daya/update-foto/view-detail-update-foto', compact('auth_data',  'status_join_table'));
    }

    public function datatablesUpdateFoto(Request $request,  $status_join_table)
    {
        $input = (object) $request->input();
        $auth_data = auth_data();
