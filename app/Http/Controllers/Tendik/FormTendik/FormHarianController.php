...
namespace App\Http\Controllers\Tendik\FormTendik;
...
class FormHarianController extends Controller
{
    public function viewInputFormHarian(Request $request)
    {
        ...
        return view('tendik/form-tendik/input-form-harian/view-input-form-harian', compact('auth_data'));
    }
    ...
    public function addInputFormHarian(Request $request, $id_form)
    {
        ...
        return view('tendik/form-tendik/input-form-harian/add-input-form-harian', compact('auth_data', 'form'));
    }
    ...
    public function actionInputFormHarian(Request $request, $mode, $id)
    {
        ...
        if ($validator->fails()) {
            ...
            if (!$now->between($start, $end) && $mode !== 'delete') {
                return [
                    'status' => 300, // FAILED
            ...
            if ($mode == 'add') {
                ...
                return [
                    ...
                    'path' => 'form-tendik/input-form-harian/',
    ...
    public function viewAllSubmittedForm(Request $req, $id_form)
    {
        ...
        return view('tendik/form-tendik/input-form-harian/all-input-form-harian', compact('auth_data', 'beforeJawaban', 'form'));
    }
    ...
    public function editSubmittedForm(Request $request, $id_form)
    {
        ...
        // DebugBar::info($form);
        return view('tendik/form-tendik/input-form-harian/edit-input-form-harian', compact('auth_data', 'form', 'jawaban'));
    }
}
