...
class MonitoringNilaiEkskulController extends BaseController
{
    protected $modul_url = 'ekstrakurikuler';
    protected $menu_url = 'monitoring-nilai-ekskul';

    public function viewMonitoringNilaiEkskul(Request $request)
    {
        ...
        return view(
            'kesiswaan/ekstrakurikuler/monitoring-nilai-ekskul/view-monitoring-nilai-ekskul',
            compact('auth_data','data_ekskul', 'data_semester', 'semester_aktif')
        );
    }

    public function viewDetailMonitoringNilaiEkskul(Request $request, $id_semester, $id_ekskul)
    {
        # code...
        $input = (object) $request->input();
        $auth_data = auth_data();
        ...
        return view('kesiswaan/ekstrakurikuler/monitoring-nilai-ekskul/view-detail-monitoring-nilai-ekskul',compact('auth_data','data_ekskul', 'semester', 'list_komponen', 'jumlah_persentase_komponen', 'list_siswa', 'id_semester', 'id_ekskul'));
    }

    public function printMonitoringNilaiEkskul(Request $request, $id_semester, $id_ekskul)
    {
        $input = (object) $request->input();
        $auth_data = auth_data();
        $auth_data->modul_url = $this->modul_url;
        ...
        return view(
            'kesiswaan/ekstrakurikuler/monitoring-nilai-ekskul/print-monitoring-nilai-ekskul',
