...
namespace App\Http\Controllers\Kesiswaan\PenangananSiswa;
...
class TindakanPelanggaranController extends BaseController{
    ...
    public function viewTindakanPelanggaran(Request $request) {
    	...
    	return view('kesiswaan/penanganan-siswa/tindakan-pelanggaran/view-tindakan-pelanggaran',compact('auth_data'));
    ...
    public function addTindakanPelanggaranNonKBM($id, Request $request) {
        ...
        return view('kesiswaan/penanganan-siswa/tindakan-pelanggaran/add-nonkbm-tindakan-pelanggaran',compact('auth_data','data_pelanggaran_siswa','tgl_pelanggaran','data_jenis_tindakan','id_pengguna','id_tindakan_pelanggaran'));
    }
    ...
    public function addTindakanPelanggaranKBM($id, Request $request) {
        ...
        return view('kesiswaan/penanganan-siswa/tindakan-pelanggaran/add-kbm-tindakan-pelanggaran',compact('auth_data','data_presensi_mp_pelanggaran','tgl_pelanggaran','data_jenis_tindakan','id_tindakan_pelanggaran'));
    }
    ...
    public function editTindakanPelanggaran($id, Request $request) {
        ...
        return view('kesiswaan/penanganan-siswa/tindakan-pelanggaran/edit-tindakan-pelanggaran',compact('auth_data','data_jenis_tindakan','data_tindakan_pelanggaran','tgl_pelanggaran','tgl_tindakan_pelanggaran', 'id_pengguna'));
    ...
    public function datatablesSudahTindakan(Request $request) {
        ...
        return Datatables::of($list_data)
                ...
                ->addColumn('nm_siswa_presensi', function($item){
                    if( ! empty($item->nm_siswa_presensi)){
    ...
    public function actionTindakanPelanggaran(Request $request, $mode, $id = null) {
        ...
        if($validator->fails() && $mode != 'delete') {
            ...
            if($mode == 'add-nonkbm') {
                ...
                $tindakanPelanggaran->aktor_input_tindakan_pelanggaran      = 2;
