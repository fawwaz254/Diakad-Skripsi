...
class JenisTindakanController extends BaseController
{
    ...
    public function addJenisTindakan(Request $request)
    {
        ...
        return view('kesiswaan/penanganan-siswa/jenis-tindakan/add-jenis-tindakan', compact('auth_data', 'id_jenis_tindakan'));
    }
    ...
    public function editJenisTindakan($id, Request $request)
    {
        ...
        return view('kesiswaan/penanganan-siswa/jenis-tindakan/edit-jenis-tindakan', compact('auth_data', 'data_jenis_tindakan'));
    }
