...
class JurusanController extends BaseController
{
    ...
    public function editJurusan($id, Request $request)
    {
        ...
        // filter tingkat
        $jurusan = Jurusan::select()->join('kelas', 'kelas.id_jurusan', '=', 'jurusan.id_jurusan')->get();
        $selected_jurusan = $jurusan->where('id_jurusan', '=', $id)->first();

        return view('pendidikan/data-akademik/jurusan/edit-jurusan', compact('auth_data', 'data_jurusan', 'selected_jurusan'));
    }
