                	...
                	if($check_nis_siswa){
						...
						if(empty($value->kode_voucher)){
							...
							if($find_voucher){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, kode voucher '.$value->kode_voucher.' tidak ditemukan di dalam sistem'
							];
							}
						...
						if(empty($value->agama)){
							...
							$find_agama = Agama::where('nm_agama',$value->agama)->first();
							if($find_agama){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, agama '.$value->agama.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->kota_lahir)){
							...
							$find_kota = Kota::where('nm_kota',$value->kota_lahir)->first();
							if($find_kota){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, kota lahir '.$value->kota_lahir.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->nama_kota_ksk)){
							...
							$find_kota_ksk = Kota::where('nm_kota',$value->nama_kota_ksk)->first();
							if($find_kota_ksk){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, nama kota ksk '.$value->nama_kota_ksk.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->kebutuhan_khusus)){
							...
							$find_kebutuhan_khusus = KebutuhanKhusus::where('nm_kebutuhan_khusus',$value->kebutuhan_khusus)->first();
							if($find_kebutuhan_khusus){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, Kebutuhan Khusus '.$value->kebutuhan_khusus.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->alamat_kota)){
							...
							$find_alamat_kota = Kota::where('nm_kota',$value->alamat_kota)->first();
							if($find_alamat_kota){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, alamat kota '.$value->alamat_kota.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->alamat_provinsi)) {
							...
							$find_provinsi =  Provinsi::where('nm_provinsi',$value->alamat_provinsi)->first();
							if($find_provinsi){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, alamat provinsi '.$value->alamat_provinsi.' tidak ditemukan di dalam sistem'
							];
							}
						...
						if(empty($value->jenis_tinggal)){
							...
							$find_jenis_tinggal = JenisTinggal::where('nm_jenis_tinggal',$value->jenis_tinggal)->first();
							if($find_jenis_tinggal){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, jenis tinggal '.$value->jenis_tinggal.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->jarak_rumah_ke_sekolah_km)){
							...
							$jarak_rumah_ke_sekolah_km = (double)$value->jarak_rumah_ke_sekolah_km;
						}
						...
						if(empty($value->waktu_tempuh_ke_sekolah_jam)){
							...
							$waktu_tempuh_ke_sekolah_jam = (double)$value->waktu_tempuh_ke_sekolah_jam;
						}
						...
						if(empty($value->waktu_tempuh_ke_sekolah_menit)){
							...
							$waktu_tempuh_ke_sekolah_menit = (double)$value->waktu_tempuh_ke_sekolah_menit;
						}
						...
						if(empty($value->jenis_transportasi)) {
							...
							$find_jenis_transportasi = JenisTransportasi::where('nm_jenis_transportasi',$value->jenis_transportasi)->first();
							if($find_jenis_transportasi){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, jenis transportasi '.$value->jenis_transportasi.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->jenis_layak_pip)) {
							...
							$find_jenis_layak = JenisLayakPip::where('nm_jenis_layak_pip',$value->jenis_layak_pip)->first();
							if($find_jenis_layak){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, jenis layak pip '.$value->jenis_layak_pip.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->kota_asal_sekolah_sebelumnya)){
							...
							$find_kota_sekolah_asal = Kota::where('nm_kota',$value->kota_asal_sekolah_sebelumnya)->first();
							if($find_kota_sekolah_asal){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, kota asal sekolah sebelumnya '.$value->kota_asal_sekolah_sebelumnya.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->nilai_shun_sebelumnya)){
							...
							$nilai_shun_sebelumnya = (double)$value->nilai_shun_sebelumnya;
						}
						...
						if(empty($value->jenis_pendidikan_ayah)){
							...
							$find_jenis_pendidikan = JenisPendidikan::where('nm_jenis_pendidikan',$value->jenis_pendidikan_ayah)->first();
							if($find_jenis_pendidikan){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, jenis pendidikan ayah '.$value->jenis_pendidikan_ayah.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->jenis_pekerjaan_ayah)){
							...
							$find_jenis_pekerjaan = JenisPekerjaan::where('nm_jenis_pekerjaan',$value->jenis_pekerjaan_ayah)->first();
							if($find_jenis_pendidikan){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, jenis pekerjaan ayah '.$value->jenis_pekerjaan_ayah.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->jenis_penghasilan_ayah)){
							...
							$find_jenis_penghasilan = JenisPenghasilan::where('nm_jenis_penghasilan',$value->jenis_penghasilan_ayah)->first();
							if($find_jenis_penghasilan){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, jenis penghasilan ayah '.$value->jenis_penghasilan_ayah.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->kebutuhan_khusus_ayah)){
							...
							$find_kebutuhan_khusus = KebutuhanKhusus::where('nm_kebutuhan_khusus',$value->kebutuhan_khusus_ayah)->first();
							if($find_kebutuhan_khusus){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, kebutuhan khusus ayah '.$value->kebutuhan_khusus_ayah.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->jenis_pendidikan_ibu)){
							...
							$find_jenis_pendidikan = JenisPendidikan::where('nm_jenis_pendidikan',$value->jenis_pendidikan_ibu)->first();
							if($find_jenis_pendidikan){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, jenis pendidikan ibu '.$value->jenis_pendidikan_ibu.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->jenis_pekerjaan_ibu)){
							...
							$find_jenis_pekerjaan = JenisPekerjaan::where('nm_jenis_pekerjaan',$value->jenis_pekerjaan_ibu)->first();
							if($find_jenis_pendidikan){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, jenis pekerjaan ibu '.$value->jenis_pekerjaan_ibu.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->jenis_penghasilan_ibu)){
							...
							$find_jenis_penghasilan = JenisPenghasilan::where('nm_jenis_penghasilan',$value->jenis_penghasilan_ibu)->first();
							if($find_jenis_penghasilan){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, jenis penghasilan ibu '.$value->jenis_penghasilan_ibu.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->kebutuhan_khusus_ibu)){
							...
							$find_kebutuhan_khusus = KebutuhanKhusus::where('nm_kebutuhan_khusus',$value->kebutuhan_khusus_ibu)->first();
							if($find_kebutuhan_khusus){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, kebutuhan khusus ibu '.$value->kebutuhan_khusus_ibu.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->jenis_pendidikan_wali)){
							...
							$find_jenis_pendidikan = JenisPendidikan::where('nm_jenis_pendidikan',$value->jenis_pendidikan_wali)->first();
							if($find_jenis_pendidikan){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, jenis pendidikan wali '.$value->jenis_pendidikan_wali.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->jenis_pekerjaan_wali)){
							...
							$find_jenis_pekerjaan = JenisPekerjaan::where('nm_jenis_pekerjaan',$value->jenis_pekerjaan_wali)->first();
							if($find_jenis_pendidikan){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, jenis pekerjaan wali '.$value->jenis_pekerjaan_wali.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->jenis_penghasilan_wali)){
							...
							$find_jenis_penghasilan = JenisPenghasilan::where('nm_jenis_penghasilan',$value->jenis_penghasilan_wali)->first();
							if($find_jenis_penghasilan){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, jenis penghasilan wali '.$value->jenis_penghasilan_wali.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->kebutuhan_khusus_wali)){
							...
							$find_kebutuhan_khusus = KebutuhanKhusus::where('nm_kebutuhan_khusus',$value->kebutuhan_khusus_wali)->first();
							if($find_kebutuhan_khusus){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, kebutuhan khusus wali '.$value->kebutuhan_khusus_wali.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->alamat_kota_orang_tua)){
							...
							$find_alamat_kota = Kota::where('nm_kota',$value->alamat_kota_orang_tua)->first();
							if($find_alamat_kota){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, alamat kota orang tua '.$value->alamat_kota_orang_tua.' tidak ditemukan di dalam sistem'
							];
							}
						}
						...
						if(empty($value->alamat_provinsi_orang_tua)) {
							...
							$find_provinsi =  Provinsi::where('nm_provinsi',$value->alamat_provinsi_orang_tua)->first();
							if($find_provinsi){
								...
								return [
								'status' 	=> 203, // GAGAL
								'message'	=> 'Upload Data Siswa Gagal, alamat provinsi orang tua '.$value->alamat_provinsi_orang_tua.' tidak ditemukan di dalam sistem'
							];
							}
						...
						if(empty($value->tinggi_badan_cm)){
							...
							$tinggi_badan_cm = (double)$value->tinggi_badan_cm;
						}
						...
						if(empty($value->berat_badan_kg)){
							...
							$berat_badan_kg = (double)$value->berat_badan_kg;
						}
