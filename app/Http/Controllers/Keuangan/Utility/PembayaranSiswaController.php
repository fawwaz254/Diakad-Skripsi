...
class PembayaranSiswaController extends BaseController
{
    ...
    public function getTagihanBelumTerbayar($auth_data, $id_siswa, $mode)
    {
        ...
        $list_data = TagihanBiaya::select(
            ...
            'biaya_sekolah.id_biaya_sekolah',
            'biaya_sekolah.id_kelompok_biaya',
            'biaya_sekolah.id_semester',
            'kelompok_biaya.nm_kelompok_biaya',
            'semester.tahun_ajaran',
            'semester.nm_semester',
            'semester.thn_akademik_semester',
            'biaya.nm_biaya',
            'detail_biaya.validasi_biaya',
            'detail_biaya.id_jenis_detail_biaya',
            'jenis_detail_biaya.nm_jenis_detail_biaya',
            'detail_biaya.id_bulan',
            'bulan.kode_bulan',
            'bulan.nm_bulan',
            'tagihan_biaya.besar_biaya',
            'tagihan_biaya.denda_biaya',
    ...
    public function printPembayaranSiswa(Request $request, $id_pengguna = null, $tgl_pembayaran = null)
    {
        ...
        $cekKelas = Siswa::where('id_pengguna', $id_pengguna)->where('id_kelas', null)->first();
        if ($cekKelas) {
