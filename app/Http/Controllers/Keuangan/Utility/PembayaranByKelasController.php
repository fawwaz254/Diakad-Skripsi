...
class PembayaranByKelasController extends BaseController
{
    ...
    public function viewDetailPembayaranByKelas(Request $request, $tahun_akademik_semester, $id_kelas){
        ...
        return view('keuangan/utility/pembayaran-by-kelas/view-pembayaran-by-kelas',compact('auth_data', 'data_semester', 'data_kelas', 'tahun_akademik_semester', 'id_kelas', 'data_siswa', 'data_tagihan', 'data_bulan_tagihan'));
    }
