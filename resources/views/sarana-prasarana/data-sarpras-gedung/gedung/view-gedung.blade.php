<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#data-sarpras-gedung/gedung/add') }}"><i
                    class="material-icons">note_add</i><span>Tambah Gedung</span></a></h2>
    </div>
...
<script>
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'nm_jenis_gedung',
                name: 'nm_jenis_gedung'
            },
            {
                data: 'kode_gedung',
                name: 'kode_gedung'
