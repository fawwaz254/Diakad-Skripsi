<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#pemasukan-sekolah/input-pemasukan/add') }}"><i
                    class="material-icons">note_add</i><span>Tambah Pemasukan</span></a></h2>
    </div>
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [{
            ...
            },
            {
                ...
                name: 'pemasukan_biaya_subkategori.nm_pemasukan_biaya_subkategori'
            },
            {
                data: 'nm_pengguna',
            ...
            {
                data: 'tgl_pemasukan_biaya',
                name: 'pemasukan_biaya.tgl_pemasukan_biaya'
            },
            {
                data: 'besar_pemasukan_biaya',
                name: 'pemasukan_biaya.besar_pemasukan_biaya'
            },
            {
                data: 'is_upload_file',
                name: 'is_upload_file',
