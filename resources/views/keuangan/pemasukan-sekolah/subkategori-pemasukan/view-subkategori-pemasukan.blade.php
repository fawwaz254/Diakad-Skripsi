<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#pemasukan-sekolah/subkategori-pemasukan/add') }}"><i
                    class="material-icons">note_add</i><span>Tambah Sub-Kategori Pemasukan</span></a></h2>
    </div>
...
<script>
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'nm_pemasukan_biaya_subkategori',
                name: 'nm_pemasukan_biaya_subkategori'
            },
            {
                data: 'keterangan_pemasukan_biaya_subkategori',
                name: 'keterangan_pemasukan_biaya_subkategori'
            },
            {
                data: 'action',
                name: 'action',
