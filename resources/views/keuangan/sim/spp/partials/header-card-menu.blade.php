    ...
    <ol class="breadcrumb breadcrumb-col-teal">
        <li class="dropdown">
            ...
            <ul class="dropdown-menu pull-left">
                ...
                <li><a href="{{Request::segment(1)}}#sim/spp/penerimaan" class="target-link waves-effect waves-block">Penerimaan Lain-Lain</a></li>
                <li><a href="{{Request::segment(1)}}#sim/spp/tunggakan" class="target-link waves-effect waves-block">Tunggakan Tahun Lalu</a></li>
            </ul>
        </li>
        <li><a href="{{Request::segment(1)}}#sim/spp/pemasukan" class="target-link">PEMASUKAN</a></li>
