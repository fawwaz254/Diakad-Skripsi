    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            @if($semester_aktif->nm_semester == 'Ganjil')
              <a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#sim/spp/setting-tunggakan-tahun-lalu/add')}}"><i class="material-icons">add</i><span>Tambah Tunggakan Tahun Lalu</span></a>
            @else
               <a class="btn bg-blue waves-effect" disabled><i class="material-icons">add</i><span>Tambah Tunggakan Tahun Lalu</span></a>
            @endif
