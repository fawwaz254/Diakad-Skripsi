            ...
            <div class="card">
                <div class="body">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <button class="btn btn-block bg-btn-submit waves-effect" onclick="filterAction()"><i class="material-icons">save</i><span>Cari Pemasukan</span></button>
                        </div>
                    </div>
...
var datatable_url   = base_url + '/' + role_url + '/sim/spp/detail-penerimaan/datatables';
var edit_url = role_url + '#' + 'sim/spp/detail-penerimaan/edit';
var delete_url = base_url + '/' + role_url + '/sim/spp/detail-penerimaan/delete';
    ...
    columns: [
        ...
        { data: 'action', name: 'action', searchable: false, orderable: false,
            render: function(data){
                return '<a class="target-link btn btn-info btn-circle waves-effect waves-float" href="'+ edit_url
                        + '/' + data.id + '">' + '<i class="material-icons">edit</i>'
                        + '</a> '
