        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                <div class="body">
                    ...
                    <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/spp/action-setting-tunggakan-tahun-lalu/edit/'.$data->id_tutup_buku_tahunan_biaya)}}">
                    {{csrf_field()}}
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-4">
                         ...
                         <div class="col-md-4">
                            ...
                            <input type="number" name="jml_tunggakan_biaya" class="form-control" value="{{$data->jml_tunggakan_biaya}}" required="" aria-required="true" aria-invalid="true">
                        </div>
