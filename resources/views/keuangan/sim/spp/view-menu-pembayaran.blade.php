                            ...
                            <tbody>
                                ...
                                @endif
                                    ...
                                    @if(!empty($tagihan) > 0)
                                        ...
                                        <a target="_blank" href="keuangan/sim/spp/print-pembayaran/{{$tagihan->id_pembayaran_biaya}}"><b style="color: #4caf50;">Print {{date_format(date_create($tagihan->tgl_pembayaran),'d/m')}}</b></a>
                                            @if($tagihan->is_request==0)
                                            <br>
