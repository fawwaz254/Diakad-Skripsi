    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        EDIT KETERANGAN SUB-KATEGORI PENGELUARAN <br> 
                ...
                <div class="body">
                    <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/action-kategori-pengeluaran/edit-ket-subkategori/'.$data_ket_subkategori_rapb->id_ket_subkategori_rapb)}}">
                        {{csrf_field()}}
