<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link "
                href="{{ url(Request::segment(1) . '#rapb/kategori-pengeluaran/sub/' . $data_subkategori_rapb->id_kategori_rapb) }}"><i
                    class="material-icons">backspace</i><span>Kembali Ke Sub-Kategori</span></a></h2>
    </div>
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#rapb/kategori-pengeluaran/sub/ket/add/' . $data_subkategori_rapb->id_kategori_rapb . '/' . $data_subkategori_rapb->id_subkategori_rapb) }}"><i
                    class="material-icons">note_add</i><span>Tambah Keterangan Sub-Kategori Pengeluaran</span></a></h2>
    </div>
...
<script>
    ...
    var modul_url = 'rapb';
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'kategori-pengeluaran/sub/ket/datatables/' +
        '{{ $data_subkategori_rapb->id_kategori_rapb }}' + '/' + '{{ $data_subkategori_rapb->id_subkategori_rapb }}';
    var edit_url = role_url + '#' + modul_url + '/' + 'kategori-pengeluaran/sub/ket/edit/' +
        '{{ $data_subkategori_rapb->id_kategori_rapb }}' + '/' + '{{ $data_subkategori_rapb->id_subkategori_rapb }}';
    var delete_url = base_url + '/' + role_url + '/' + modul_url + '/' +
        'action-kategori-pengeluaran/delete-ket-subkategori';
