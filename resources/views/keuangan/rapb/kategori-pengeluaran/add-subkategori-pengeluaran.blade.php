    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        TAMBAH SUB-KATEGORI PENGELUARAN <br> 
                        Kategori : {{ $data_kategori_rapb->kode_kategori_rapb }} - {{ $data_kategori_rapb->nm_kategori_rapb }}
                    </h2>
                </div>
                <div class="body">
                    <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/action-kategori-pengeluaran/add-subkategori/'.$id_subkategori_rapb)}}">
                        {{csrf_field()}}
