    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        TAMBAH KETERANGAN SUB-KATEGORI PENERIMAAN <br> 
                ...
                <div class="body">
                    <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/action-kategori-penerimaan/add-ket-subkategori/'.$id_ket_subkategori_rapb)}}">
                        {{csrf_field()}}
