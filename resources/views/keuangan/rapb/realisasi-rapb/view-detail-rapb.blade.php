    ...
    <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/post-view-rapb')}}">
                        {{csrf_field()}}
                        <div class="row clearfix">
...
<script>
    ...
    var modul_url               = 'rapb';
    var datatable_url_tinggi    = base_url + '/' + role_url + '/' + modul_url + '/' + 'realisasi-rapb/datatables/rapb-tinggi/' + id_semester_mulai + '/' + id_semester_selesai;
    ...
    var primary_table_tinggi = $('#primary_table_tinggi').DataTable({
        ...
        columns: [
            ...
            { data: 'jml_realisasi', name: 'jml_realisasi' },
