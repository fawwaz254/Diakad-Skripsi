<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link "
                href="{{ url(Request::segment(1) . '#utility/pembayaran-siswa/view-detail-siswa/' . $nis_siswa . '/' . $nis_nama_siswa_asli) }}"><i
            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="table-responsive">
                        <table
                            ...
                            <tr>
                                ...
                                <td style="width: 50%">
                                    {{ $tagihan->nm_kelompok_biaya . ' (' . $tagihan->tahun_ajaran . ' ' . $tagihan->nm_semester . ')' }}
                                </td>
                            </tr>
                            <tr>
                    ...
                    <form id="form-validation" method="POST"
                        action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/action-pembayaran-siswa/add/1') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="hidden" class="form-control" name="id_tagihan_biaya" required=""
                                    aria-required="true" aria-invalid="true"
                                    value="{{ $tagihan->id_tagihan_biaya }}">
                                <input type="hidden" class="form-control" name="besar_pembayaran_lama"
                                    required="" aria-required="true" aria-invalid="true"
                                    value="{{ $tagihan->besar_pembayaran == null ? '0' : $tagihan->besar_pembayaran }}">
                                <input type="hidden" class="form-control" name="nis_siswa" required=""
                                    aria-required="true" aria-invalid="true" value="{{ $nis_siswa }}">
                                <input type="hidden" class="form-control" name="nis_nama_siswa_asli" required=""
                                    aria-required="true" aria-invalid="true" value="{{ $nis_nama_siswa_asli }}">
                            </div>
                        </div>
                        <div class="row clearfix">
