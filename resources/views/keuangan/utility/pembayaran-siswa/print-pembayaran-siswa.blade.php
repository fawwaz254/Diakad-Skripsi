    ...
    <div class="page">
        ...
        <table>
            <tr>
                ...
                <td colspan=6>
                    <h1 align="center">KWITANSI PEMBAYARAN<br> {{ strtoupper($auth_data->sekolah_data->nm_sekolah) }}
                    </h1>
                </td>
            </tr>
            <tr>
        ...
        <table border="0" style="width: 100%;">
            <tr>
                <td></td>
                <td><b>Pembayaran Tanggal
                        {{ indonesiaDate(\Carbon\Carbon::parse($tgl_pembayaran)->format('Y-m-d')) }}</b></td>
            </tr>
            <tr>
                <td></td>
                <td>
        ...
        @if ($nama_sekolah == 'SMP Muhammadiyah 6 Krian')
            <p>Total Tagihan SPP yang Belum Terbayar Periode {{ $semester_aktif->tahun_ajaran }} :
                {{ 'Rp ' . number_format($tagihan_belum_terbayar_spp) }}</p>
            ...
            @endif
            <p>Total Tagihan Lain - lain yang Belum Terbayar Periode {{ $semester_aktif->tahun_ajaran }} :
                {{ 'Rp ' . number_format($tagihan_belum_terbayar_non_spp) }}</p>
