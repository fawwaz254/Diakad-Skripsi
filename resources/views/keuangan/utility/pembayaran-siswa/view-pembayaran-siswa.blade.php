    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/post-view-pembayaran-siswa')}}">
                        {{csrf_field()}}
...
<script>
    ...
    var datatable_url   = base_url + '/' + role_url + '/' + modul_url + '/' + 'pembayaran-siswa/datatables/' + nis_nama_siswa ;
    var detail_url        = role_url + '#' + modul_url + '/' + 'pembayaran-siswa/view-detail-siswa';
        ...
        columns: [
            ...
            { data: 'action', name: 'action', searchable: false, orderable: false,
                render: function(data){
                    return '<a class="target-link btn btn-info btn-circle waves-effect waves-circle waves-float" href="'+ detail_url + '/' + data.id +'/' + data.id_asli +'">'+
