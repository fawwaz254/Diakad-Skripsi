             ...
             <div class="card">
                 ...
                 <div class="body">
                                     ...
                                     @else
                                         ...
                                         @foreach ($data_jalur as $data)
                                             @if ($data->id_jalur == $id_jalur)
                                                 <option value="{{ $data->id_jalur }}" selected>{{ $data->nm_jalur }}
                                                 </option>
                                             @else
                                                 <option value="{{ $data->id_jalur }}">{{ $data->nm_jalur }}</option>
                                             @endif
                     ...
                     <form id="form-validation1" method="POST"
                         action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/action-tagihan-siswa/add') }}">
                         ...
                         <div class="row clearfix">
                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 ...
                                 <input type="hidden" class="form-control" name="id_jalur" required=""
                                     aria-required="true" aria-invalid="true" value="{{ $id_jalur }}">
                                 <input type="hidden" class="form-control" name="is_insert_replace" required=""
                                     aria-required="true" aria-invalid="true" value="{{ $is_insert_replace }}">
                                 <button class="btn btn-block bg-blue waves-effect" type="submit"><i
                                         class="material-icons">save</i><span>Save Tagihan</span></button>
                             </div>
                         </div>
