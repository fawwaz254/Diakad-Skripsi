                ...
                <div class="body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h2 class="card-inside-title">Setting bulan/tanggal</h2>
                            <input class="with-gap radio-col-light-green form-control validate" type="radio"
                                name="setting_year" value="{{ now()->subYears(1)->format('Y') }}"
                                id="{{ now()->subYears(1)->format('Y') }}" onchange="changeSettingYear()" />
                            <label for="{{ now()->subYears(1)->format('Y') }}"> {{ now()->subYears(1)->format('Y') }}
                            </label>

                            <input class="with-gap radio-col-light-green form-control validate" type="radio"
                                name="setting_year" value="{{ now()->format('Y') }}" id="{{ now()->format('Y') }}"
                                checked onchange="changeSettingYear()" />
                            <label for="{{ now()->format('Y') }}"> {{ now()->format('Y') }} </label>
                            <br>
                            <button class="btn waves-effect btn-filter-month"
                                onclick="filterMonth(this, 1)">Januari</button>
                            <button class="btn waves-effect btn-filter-month"
                                onclick="filterMonth(this, 2)">Februari</button>
                            <button class="btn waves-effect btn-filter-month"
                                onclick="filterMonth(this, 3)">Maret</button>
                            <button class="btn waves-effect btn-filter-month"
                                onclick="filterMonth(this, 4)">April</button>
                            <button class="btn waves-effect btn-filter-month"
                                onclick="filterMonth(this, 5)">Mei</button>
                            <button class="btn waves-effect btn-filter-month"
                                onclick="filterMonth(this, 6)">Juni</button>
                            <button class="btn waves-effect btn-filter-month"
                                onclick="filterMonth(this, 7)">Juli</button>
                            <button class="btn waves-effect btn-filter-month"
                                onclick="filterMonth(this, 8)">Agustus</button>
                            <button class="btn waves-effect btn-filter-month"
                                onclick="filterMonth(this, 9)">September</button>
                            <button class="btn waves-effect btn-filter-month"
                                onclick="filterMonth(this, 10)">Oktober</button>
                            <button class="btn waves-effect btn-filter-month"
                                onclick="filterMonth(this, 11)">November</button>
                            <button class="btn waves-effect btn-filter-month"
                                onclick="filterMonth(this, 12)">Desember</button>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input class="with-gap radio-col-light-green form-control validate" type="radio"
                                name="print_setting" value="self" id="self" onchange="changeSettingSession()"
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <ul>
                                <li><a style="cursor: pointer;" onclick="printPembayaranSiswa('siswa')">Rekap per
                                        Siswa</a></li>
                                <li><a style="cursor: pointer;" onclick="printPembayaranSiswa('kelas')">Rekap per
                                        Kelas</a></li>
                                <li><a style="cursor: pointer;" onclick="printPembayaranSiswa('tingkat')">Rekap per
                                        Tingkat</a></li>
                                <li><a style="cursor: pointer;" onclick="printPembayaranSiswa('tanggal')">Rekap per
                                        Tanggal</a></li>
                                <li><a style="cursor: pointer;" onclick="printPembayaranSiswa('bulan')">Rekap per
                                        Bulan (Laporan Tahunan)</a></li>
                                <li><a style="cursor: pointer;" onclick="printPembayaranSiswa('kategori')">Rekap per
                                        Kategori</a></li>
                                <li><a style="cursor: pointer;" onclick="printPembayaranSiswa('detail')">Rekap
                                        Detail</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <ul>
                                <li><a style="cursor: pointer;" onclick="printKeluar('kategori')">Rekap per
                                        Kategori</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <ul>
                                <li><a style="cursor: pointer;" onclick="printKas('detail-reguler')">Rekap Detail
                                        Reguler</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <ul>
                                <li><a style="cursor: pointer;" onclick="printPembayaranSiswa('siswa-online')">Rekap
                                        per Siswa</a></li>
                            </ul>
                        </div>
                    </div>
...
<script>
    function printPembayaranSiswa(jenis) {
        ...
        if (start_date == null || end_date == null || start_date == '' || end_date == '') {
            ...
            if (end_date < start_date) {
                ...
                window.open(print_laporan_url + '/' + 'print-pembayaran-siswa' + '/' + jenis + '/' + start_date + '/' +
                    end_date, "_blank");
                $('button').removeAttr('disabled', 'disabled');
            }
        }
    ...
    function printKeluar(jenis) {
        ...
        if (start_date == null || end_date == null || start_date == '' || end_date == '') {
            ...
            if (end_date < start_date) {
                ...
                window.open(print_laporan_url + '/' + 'print-pengeluaran' + '/' + jenis + '/' + start_date + '/' +
                    end_date, "_blank");
                $('button').removeAttr('disabled', 'disabled');
            }
        }
    ...
    function printKas(jenis) {
        ...
        if (start_date == null || end_date == null || start_date == '' || end_date == '') {
            ...
            if (end_date < start_date) {
                ...
                window.open(print_laporan_url + '/' + 'print-arus-kas' + '/' + jenis + '/' + start_date + '/' +
                    end_date, "_blank");
                $('button').removeAttr('disabled', 'disabled');
            }
        }
        ...
        if (start_date == null || end_date == null || start_date == '' || end_date == '') {
            ...
            if (end_date < start_date) {
                ...
                if (s.getMonth() == e.getMonth() && s.getFullYear() == e.getFullYear()) {
                    window.open(print_laporan_url + '/' + 'print-laporan-bulanan' + '/' + jenis + '/' + start_date +
                        '/' + end_date, "_blank");
                } else {
    ...
    function changeSettingYear() {
        var start_date = $('input[name=start_date]').val();
        var end_date = $('input[name=end_date]').val();
        var this_year = $('input[name=setting_year]:checked').val();
