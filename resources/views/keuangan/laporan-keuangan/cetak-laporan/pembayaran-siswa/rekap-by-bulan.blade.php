    ...
    <div class="page">
        ...
        <table cellspacing="0" cellpadding="10" style="width: 100%;">
            <tr>
                ...
                <td colspan=6>
                    <h1 align="center">LAPORAN PEMBAYARAN SISWA PER BULAN<br>
            ...
            @if (isset($data_laporan['data']))
                @foreach ($data_laporan['data'] as $data)
                    <tr>
                        ...
                        <td style="text-align: right;"><b>{{ 'Rp ' . number_format($data['total_pembayaran']) }}</b>
                        </td>
                    </tr>
                @endforeach
            @endif
...
<script>
    ...
    var end_date = '{{ $end_year }}';

    document.title = 'Rekap per Bulan (Laporan Tahunan)' + ' - ' + start_date + ' - ' + end_date;
    window.print();
</script>
