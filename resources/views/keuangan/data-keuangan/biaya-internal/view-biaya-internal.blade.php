<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#data-keuangan/biaya-internal/add') }}"><i
                    class="material-icons">note_add</i><span>Tambah Biaya Internal</span></a></h2>
    </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <button class="btn btn-block bg-btn-submit waves-effect" onclick="filterAction()"><i
                                    class="material-icons">save</i><span>Ubah Filter</span></button>
                        </div>
                    </div>
