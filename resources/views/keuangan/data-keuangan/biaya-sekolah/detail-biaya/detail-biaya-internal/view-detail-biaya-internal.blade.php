<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link m-b-15" href="{{url(Request::segment(1).'#data-keuangan/biaya-sekolah/detail-biaya/' . ($biaya_sekolah->id_biaya_sekolah ?? null) )}}"><i class="material-icons">backspace</i><span>Kembali</span></a></h2>
