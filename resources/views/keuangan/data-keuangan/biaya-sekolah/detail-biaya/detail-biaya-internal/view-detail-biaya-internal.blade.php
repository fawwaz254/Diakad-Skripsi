<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link m-b-15"
                href="{{ url(Request::segment(1) . '#data-keuangan/biaya-sekolah/detail-biaya/' . ($biaya_sekolah->id_biaya_sekolah ?? null)) }}"><i
                    class="material-icons">backspace</i><span>Kembali</span></a></h2>
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#data-keuangan/biaya-sekolah/detail-biaya/detail-biaya-internal/add/' . Request::segment(6)) }}"><i
...
<script>
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' +
        'biaya-sekolah/detail-biaya/detail-biaya-internal/datatables/' + id_detail_biaya;
    ...
    var delete_url = base_url + '/' + role_url + '/' + modul_url + '/' +
        'biaya-sekolah/detail-biaya/detail-biaya-internal/action-detail-biaya-internal/' + id_detail_biaya + '/delete';
