            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="body" id="khusus-login">
                        <form id="form-validation" method="POST" action="{{url('send-link-reset-password')}}">
                            {{csrf_field()}}
                            ...
                            <center>
                                <p>Masukkan alamat email yang anda gunakan pada diakad dan kami akan mengirimkan anda link untuk reset ulang password</p>
                                <br>
                            </center>
                            <div class="row clearfix">
                                <div class="col-xs-12">
                                    <label class="form-label" style="color: #14142C; font-weight:300;">Email</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="email" class="form-control" name="email" required="" aria-required="true" aria-invalid="true" style="background-color: transparent;">
                                        </div>
                                    </div>
                                </div>
