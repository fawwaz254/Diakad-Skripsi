<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#penetapan/data-penetapan/add/') }}"><i
                    class="material-icons">note_add</i><span>Tambah Penetapan</span></a></h2>
    </div>
...
<script>
    ...
    var penetapan_penerimaan_url = base_url + '/' + role_url + '#' + modul_url + '/' +
        'data-penetapan/view-penetapan-penerimaan';
            ...
            },
            {
                ...
                render: function(data) {
                    return '<a class="target-link btn btn-info btn-circle waves-effect waves-circle waves-float" href="' +
                        ...
                        '</button>' +
                        '<a class="" href="' + penetapan_penerimaan_url + '/' + data.id + '">' +
                        '    <i class="">lihat penerimaan</i>' +
                        '</a> ';
                }
            }
        ]
