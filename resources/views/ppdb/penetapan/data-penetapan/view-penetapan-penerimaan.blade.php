<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link "
                href="{{ url(Request::segment(1) . '#penetapan/data-penetapan') }}"><i
                    class="material-icons">backspace</i><span>Kembali</span></a></h2>
    </div>
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#penetapan/data-penetapan/add-penetapan-penerimaan/' . $data_penetapan_penerimaan->id_penetapan) }}"><i
                    class="material-icons">note_add</i><span>Tambah Penetapan Penerimaan</span></a></h2>
    </div>
...
<script>
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' +
        'data-penetapan/datatables-penetapan-penerimaan/{{ $data_penetapan_penerimaan->id_penetapan }}';
