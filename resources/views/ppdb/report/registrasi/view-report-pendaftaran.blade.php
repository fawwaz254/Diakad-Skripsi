    ...
    <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover dataTable display responsive nowrap" id="primary_table_{{ $jurusan->id_jurusan }}">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>No Ujian</th>
    ...
    <script>
        ...
        var primary_table_{{ $jurusan->id_jurusan }} = $('#primary_table_'+id_jurusan).DataTable({
            ...
            columns: [
                ...
                { data: 'nomor_ujian', name: 'calon_siswa_baru.nomor_ujian' },
                ...
                { data: 'nomor_hp_ortu', name: 'calon_siswa_ortu.nomor_hp_ortu'},
                { data: 'nm_sekolah_asal', name: 'calon_siswa_sekolah.nm_sekolah_asal'},
                { data: 'nm_ayah', name: 'calon_siswa_ortu.nm_ayah'},
                { data: 'nm_ibu', name: 'calon_siswa_ortu.nm_ibu'},
                { data: 'nomor_telp_ortu', name: 'calon_siswa_ortu.nomor_telp_ortu'}
            ]
        });

        primary_table_{{ $jurusan->id_jurusan }}.on( 'draw', function () {
            primary_table_{{ $jurusan->id_jurusan }}.column(0, {search:'applied', order:'applied'}).nodes().each( function (cell, i) {
