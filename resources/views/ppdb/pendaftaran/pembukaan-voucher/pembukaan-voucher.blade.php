...
<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#pendaftaran/pembukaan-voucher')}}"><i class="material-icons">keyboard_backspace</i><span>Kembali</span></a></h2>
    </div>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable display responsive nowrap" id="primary_table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-danger btn-circle waves-effect waves-circle waves-float" onclick="deleteAction('ppdb/pendaftaran/pembukaan-voucher/{{$penerimaan->id_penerimaan}}/delete', this)" data-id="{{$tarif->id_voucher_tarif}}">
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable display responsive nowrap" id="tabel-voucher">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-danger btn-circle waves-effect waves-circle waves-float" onclick="deleteAction('ppdb/pendaftaran/pembukaan-voucher/{{$penerimaan->id_penerimaan}}/delete-voucher', this)" data-id="{{$voucher->id_voucher}}">
                                                <i class="material-icons">delete_forever</i>
                                            </button>
                                        </td>
                                    </tr>
