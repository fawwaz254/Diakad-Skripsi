<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#pendaftaran/syarat-penerimaan') }}"><i
                ...
                <div class="body" style="padding-bottom:50px;">
                    ...
                    <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="target-link btn btn-info btn-circle waves-effect waves-circle waves-float"
                                                href="{{ url(Request::segment(1) . '#pendaftaran/syarat-penerimaan/' . $syarat_umum->id_penerimaan . '/edit/' . $syarat_umum->id_penerimaan_syarat) }}"><i
                                                    class="material-icons">edit</i></a>

                                            <button
                                                class="btn btn-danger btn-circle waves-effect waves-circle waves-float"
                                                onclick="deleteAction('ppdb/pendaftaran/syarat-penerimaan/{{ $syarat_umum->id_penerimaan }}/delete', this)"
                                                data-id="{{ $syarat_umum->id_penerimaan_syarat }}">
                        ...
                        <h2><a class="btn bg-green waves-effect target-link"
                                href="{{ url(Request::segment(1) . '#pendaftaran/syarat-penerimaan/' . $penerimaan->id_penerimaan . '/add') }}"><i
                                    class="material-icons">note_add</i><span>Tambah Syarat Umum</span></a></h2>
                    </div>
                    ...
                    <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                @forelse($penerimaan_syarat_khusus as $k => $khusus)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="target-link btn btn-info btn-circle waves-effect waves-circle waves-float"
                                                href="{{ url(Request::segment(1) . '#pendaftaran/syarat-penerimaan/' . $khusus->id_penerimaan . '/edit/' . $khusus->id_penerimaan_syarat . '?type=khusus') }}"><i
                                                    class="material-icons">edit</i></a>

                                            <button
                                                class="btn btn-danger btn-circle waves-effect waves-circle waves-float"
                                                onclick="deleteAction('ppdb/pendaftaran/syarat-penerimaan/{{ $khusus->id_penerimaan }}/delete', this)"
                                                data-id="{{ $khusus->id_penerimaan_syarat }}">
                                                <i class="material-icons">delete_forever</i>
                                            </button>
                                        </td>
                                    </tr>
                        ...
                        <h2><a class="btn bg-green waves-effect target-link"
                                href="{{ url(Request::segment(1) . '#pendaftaran/syarat-penerimaan/' . $penerimaan->id_penerimaan . '/add?type=khusus') }}"><i
                                    class="material-icons">note_add</i><span>Tambah Syarat Khusus</span></a></h2>
                    </div>
                </div>
            </div>
        </div>
