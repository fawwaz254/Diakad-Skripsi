        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                    <div class="header bg-lime">
                        <h2>SYARAT PENERIMAAN</h2>
                    </div>
                    <div class="body">
                        <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/'.Request::segment(3).'/post-view-syarat-penerimaan')}}">
                            {{csrf_field()}}
                            ...
                            <button type="submit" class="btn btn-primary waves-effect" ><i class="material-icons">save</i><span>Edit Syarat Penerimaan</span></button>
                        </form>
                    </div>
                </div>
            </div>
