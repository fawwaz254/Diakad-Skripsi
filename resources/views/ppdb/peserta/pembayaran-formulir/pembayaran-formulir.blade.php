            ...
            <div class="card">
                    ...
                    <div class="body" style="padding-bottom:50px;">
                        ...
                        <div class="{{($voucher==null?'hidden':'')}}" style="margin-top:40px;">
                            ...
                            @if($voucher->tgl_ambil != null)
                            <form id="form-validation1" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/pembayaran-formulir/'.$voucher->kode_voucher.'/bayar-voucher')}}">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom:0px !important;">
                                    ...
                                    <input type="text" class="form-control simulateplz targetdisabled" id="besar_biaya" name="besar_biaya" aria-required="true" aria-invalid="true" value="{{ $voucher->besar_biaya }}">
                                    @else
                                    <input type="text" class="form-control simulateplz targetdisabled" id="besar_biaya" name="besar_biaya" aria-required="true" aria-invalid="true" value="{{ $voucher->tarif }}">
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row clearfix" style="margin-bottom:28px">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom:0px !important;">
                                    @if($voucher->tgl_bayar != null)
                                    <select class="form-control show-tick targetdisabled" name="metode_pembayaran" id="metode_pembayaran" >
                                        <option value="">-</option>
                                        <option value="0" {{ ($voucher->is_tagih_bank != "1"?'selected':'') }}>Manual (Cash)</option>
                                        <option value="1" {{ ($voucher->is_tagih_bank == "1"?'selected':'') }}>Via Bank (Transfer)</option>
                                    </select>
                                    @else 
                                    <select class="form-control show-tick targetdisabled" name="metode_pembayaran" id="metode_pembayaran" >
                                        <option value="">-</option>
                            ...
                            <div class="{{ ($voucher->is_tagih_bank == '1'?'':'hidden') }}" id="transfer-section">
                            <div class="card-inside-title">
                                Nomor Transaksi
                                <small class="form-text text-muted">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom:0px !important;">
                                    <input type="text" class="form-control simulateplz targetdisabled" id="nomor_transaksi" name="nomor_transaksi" aria-required="true" aria-invalid="true" value="{{ $voucher->nomor_transaksi }}">
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 via" style="margin-bottom:0px !important;">
                                    <select class="form-control show-tick targetdisabled" name="id_bank" id="id_bank">
                                        <option value="">-</option>
                                        @foreach($bank as $bnk)
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom:0px !important;">
                                    <select class="form-control show-tick targetdisabled" name="id_bank_via" id="id_bank_via">
                                        <option value="">-</option>
                            ...
                            <h2>
                                @if( $voucher->tgl_bayar != null )
                                    <button class="btn bg-red waves-effect" onclick="deleteAction('ppdb/peserta/pembayaran-formulir/reset-voucher', this)" data-id="{{$voucher->kode_voucher}}">
                                        <i class="material-icons">delete_forever</i><span>Reset Voucher</span>
                                    </button>
                                @endif
                                <button class="btn bg-green waves-effect" type="submit" {{ ($voucher->tgl_bayar != null? 'disabled':'')  }}><i class="material-icons">note_add</i><span>Bayar Voucher</span></button>
                            </h2>
                            </form>
                            <!-- end form -->
