                        ...
                        <table class="table table-bordered table-striped table-hover dataTable display responsive nowrap"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="vertical-align : middle;text-align:center;">Tendik yang sudah selesai
                                    </th>
...
<script type="text/javascript">
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'category_jurnal_harian_tendik.unit_kerja.nm_unit_kerja',
                name: 'category_jurnal_harian_tendik.unit_kerja.nm_unit_kerja'
            },
            {
                data: 'selesai',
                name: 'selesai',
            ...
            {
                data: 'category_jurnal_harian_tendik.description',
                name: 'category_jurnal_harian_tendik.description'
            },
            {
                data: 'action',
                name: 'action',
