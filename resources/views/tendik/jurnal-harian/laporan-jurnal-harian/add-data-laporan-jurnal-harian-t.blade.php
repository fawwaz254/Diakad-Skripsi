                    ...
                    <form id="form-upload" method="POST"action="{{url(Request::segment(1).'/'.Request::segment(2).'/'.Request::segment(3).'/action-kerja-harian/add/0')}}">
                        ...
                        <h2 class="card-inside-title">
                         ...
                         <select class="form-control show-tick" name="unit_kerja">
                             ...
                             @foreach($unit_kerja as $kerja)
                             <option value="{{ $kerja->category_jurnal_harian_tendik->id_category_jh_tendik}}">
                                 {{ $kerja->category_jurnal_harian_tendik->unit_kerja->nm_unit_kerja }}
                             </option>
                             @endforeach
                         </select>
                         <h2 class="card-inside-title">
                         ...
                         <select class="form-control show-tick" name="jenis">
                             ...
                             <option value="{{ $nama_jenis->jenis_jurhart}}">
