<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{url(Request::segment(1).'#siswa/update-foto/')}}"><i
                ...
                <div class="body">
                    <div id="frmFileUpload" class="dropzone">
                        <div class="dz-message">
                            ...
                            <em>(Sistem kami akan secara otomatis menyambungkan nama file dengan NIS Siswa yang telah ada di sistem.)</em>
                        </div>
                    </div>
