                     ...
                     <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tambah-data-wali-murid">
                            <form id="form-validation1" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/action-setting-wali-murid/add/'.$id_wali_murid)}}" autocomplete="off">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" class="form-control" name="nm_wali_murid" required="" aria-required="true" aria-invalid="true">
                                    </div>
                                </div>
                                <h2 class="card-inside-title">
                                    No. HP Wali Murid
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <input type="text" class="form-control" name="gelar_depan" aria-required="true" aria-invalid="true">
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <h2 class="card-inside-title">
                                            Gelar Belakang
                                        </h2>
                                        <input type="text" class="form-control" name="gelar_belakang" aria-required="true" aria-invalid="true">
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
