<div class="container-fluid">
    <div class="block-header">
		<h2><a class="btn bg-blue waves-effect target-link " href="{{url(Request::segment(1).'#siswa/setting-wali-murid/view-kelas/'.$kelas->id_kelas)}}"><i class="material-icons">backspace</i><span>Kembali</span></a></h2>
	</div>
                ...
                <div class="body">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <form id="form-upload" action="{{url(Request::segment(1).'/'.Request::segment(2).'/'.Request::segment(3).'/upload/'.$kelas->id_kelas)}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                Pilih File Excel
