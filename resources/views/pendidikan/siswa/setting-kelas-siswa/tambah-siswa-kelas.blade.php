        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header bg-green">
                    <h2>
                        Tambah Siswa {{$siswa->nm_pengguna}}
                    </h2>
                </div>
                <div class="body">
                    <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/action-setting-kelas-siswa/tambah-siswa/'.$siswa->id_siswa)}}">
                        {{csrf_field()}}
