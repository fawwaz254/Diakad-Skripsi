            ...
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="POST"
                        action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/post-view-histori-admisi-siswa') }}">
                        {{ csrf_field() }}
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <a class="btn btn-block bg-blue waves-effect target-link "
                                href="{{ url(Request::segment(1) . '#data-kesiswaan/admisi-siswa/view-detail/' . $nis_siswa) }}"><i
                                    class="material-icons">library_add</i><span>Tambah Admisi</span></a>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'histori-admisi-siswa/datatables/' +
        nis_siswa;
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'keterangan_admisi',
                name: 'keterangan_admisi'
            },
            {
                data: 'action',
                name: 'action',
