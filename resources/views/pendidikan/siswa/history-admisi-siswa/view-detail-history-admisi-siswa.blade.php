            ...
            <div class="card">
                <div class="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <!-- <button class="btn btn-block bg-red waves-effect" type="submit"><i class="material-icons">save</i><span>Save</span></button> -->
                            <a class="btn btn-block bg-blue waves-effect target-link " href="{{url(Request::segment(1).'#siswa/admisi-siswa/view-detail/'.$nis_siswa)}}"><i class="material-icons">library_add</i><span>Tambah Admisi</span></a>
                        </div>
                    </div>
                </div>
            </div>
