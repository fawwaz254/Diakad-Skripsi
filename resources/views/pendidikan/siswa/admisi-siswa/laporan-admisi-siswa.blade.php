<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link "
                href="{{ url(Request::segment(1) . '#data-kesiswaan/admisi-siswa/generate') }}"><i
                    class="material-icons">backspace</i><span>GENERATE ADMISI</span></a></h2>
    </div>
            ...
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="POST"
                        action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/post-view-laporan-admisi-siswa') }}">
                        {{ csrf_field() }}
