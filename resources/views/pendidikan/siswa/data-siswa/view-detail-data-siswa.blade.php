         ...
         columns: [{
             ...
             },
             {
                 ...
                 render: function(data) {
                     if (data.link_google_drive) {
                         return '<p>' + data.nm_sekolah + '</p>' +
                             '<a class="btn bg-blue btn-circle waves-effect waves-circle waves-float" target="_blank" href="' +
                             data.link_google_drive + ' ">' +
                             '    <i class="material-icons">attach_file</i>' +
                             '</a>';
                     } else if (data.nm_sekolah) {
                         return '<p>' + data.nm_sekolah + '</p>';
                     } else {
                         return '';
                     }
