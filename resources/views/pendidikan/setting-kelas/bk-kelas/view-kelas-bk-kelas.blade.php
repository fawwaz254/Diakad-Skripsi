<div class="container-fluid">
    ...
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link "
                href="{{ url(Request::segment(1) . '#setting-kelas/setting-bk-kelas') }}"><i
                    class="material-icons">backspace</i><span>Kembali Pilih Kelas</span></a></h2>
    </div>
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#setting-kelas/bk-kelas/add/' . $data_kelas->id_kelas) }}"><i
                    class="material-icons">note_add</i><span>Tambah BK Kelas</span></a></h2>
    </div>
