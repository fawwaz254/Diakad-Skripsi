    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        EDIT RUANGAN KELAS {{$data_kelas->nm_kelas}}
                    </h2>
                </div>
                <div class="body">
                    <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/action-ruangan-kelas/edit/'.$data_ruangan_kelas->id_ruangan_kelas)}}">
                        {{csrf_field()}}
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <select class="form-control show-tick" name="id_ruangan">
                                    ...
                                    @if($data->id_ruangan == $data_ruangan_kelas->id_ruangan)
                                    <option value="{{$data->id_ruangan}}" selected>{{$data->nm_ruangan}}</option>
                                    @else
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <select class="form-control show-tick" name="is_aktif">
                                    @if($data_ruangan_kelas->is_aktif == 0)
