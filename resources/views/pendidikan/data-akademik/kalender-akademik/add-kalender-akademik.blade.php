    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        TAMBAH KALENDER AKADEMIK SEMESTER {{$data_semester->tahun_ajaran}} {{$data_semester->nm_semester}}
                    </h2>
                </div>
                <div class="body">
                    <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/action-kalender-akademik/add/'.$id_jadwal_kegiatan)}}">
                        {{csrf_field()}}
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <select class="form-control show-tick" name="id_kegiatan">
                                    ...
                                    <option value="{{$data->id_kegiatan}}">{{$data->kode_kegiatan}} - {{$data->nm_kegiatan}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
