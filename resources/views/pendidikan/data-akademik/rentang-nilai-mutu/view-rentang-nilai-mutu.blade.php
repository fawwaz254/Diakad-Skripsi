<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#data-akademik/rentang-nilai-mutu/add') }}"><i
                    class="material-icons">note_add</i><span>Tambah Rentang Nilai Mutu</span></a></h2>
    </div>
...
<script>
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'nilai_min_peraturan_nilai',
                name: 'nilai_min_peraturan_nilai'
            },
            {
                data: 'nilai_max_peraturan_nilai',
                name: 'nilai_max_peraturan_nilai'
            },
            {
