                                        ...
                                        <select class="form-control show-tick" name="id_guru" required="">
                                            @foreach ($data_guru as $r)
                                                <option value="{{ $r->id_guru }}"
                                                    {{ !empty($selected_guru) && $selected_guru->id_guru == $r->id_guru ? 'selected' : '' }}>
                                                    {{ $r->gelar_depan ? $r->gelar_depan : '' }} {{ $r->nm_pengguna }}
...
@if (!empty($selected_guru) && !empty($selected_semester))
    ...
    <script type="text/javascript">
        let id_guru = '{{ $selected_guru->id_guru }}',
            id_semester = '{{ $selected_semester->id_semester }}';

        var modul_url = 'laporan-akademik';
        var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'jurnal-guru/datatables/' + id_guru + '/' +
            id_semester;

        var print_pdf = base_url + '/' + role_url + '/' + modul_url + '/jurnal-guru/print-pdf';
