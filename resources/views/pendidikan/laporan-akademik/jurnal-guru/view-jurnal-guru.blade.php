                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <select class="form-control show-tick" name="id_semester" required="">
                                            ...
                                            <option value="{{$data->id_semester}}" {{((!empty($selected_semester) && $selected_semester->id_semester == $data->id_semester)? 'selected' : ($data->is_aktif_semester == 1 && empty($selected_semester)))? 'selected' : ''}}>
                                                {{$data->tahun_ajaran}}
                                                {{$data->nm_semester}} 
