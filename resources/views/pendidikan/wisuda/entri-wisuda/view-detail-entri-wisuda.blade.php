<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link "
                href="{{ url(Request::segment(1) . '#wisuda/entri-wisuda') }}"><i
    ...
    <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                {{ csrf_field() }}
                <div class="header">
                    <h2>ENTRI DATA WISUDA @if (is_null($data_periode_wisuda))
                        @else
...
<script>
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'entri-wisuda/datatables/' +
                    ...
                    if (data.id != null) {
                        if (data.status_wisuda == 2) {
                            ...
                            return '<a class="target-link btn btn-info btn-circle waves-effect waves-circle waves-float" href="' +
                                input_url + '/' + data.id + '/' + id_periode_wisuda + '/' + id_kelas +
                                '">' +
