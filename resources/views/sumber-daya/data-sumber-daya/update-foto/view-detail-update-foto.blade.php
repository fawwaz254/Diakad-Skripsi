     ...
     <div class="row clearfix">
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
             <div class="card">
                 {{ csrf_field() }}
                 <div class="header">
                     <h2>Data Guru dan Tendik</h2>
                 </div>
                 <div class="body">
                     <form id="form-validation" method="POST"
                         action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/post-view-update-foto') }}">
                         {{ csrf_field() }}
                         <div class="row clearfix">
                             ...
                             <div class="col-md-12 col-sm-12 col-xs-12">
                                 ...
                                 <select class="form-control show-tick" name="status_join_table" id="status_join_table">
                                     <option value="0" @if ($status_join_table == 0) selected @endif>-- Semua
                                         --</option>
                                     <option value="1" @if ($status_join_table == 1) selected @endif>Tendik
                                     </option>
                                     <option value="2" @if ($status_join_table == 2) selected @endif>Guru
                                     </option>
                     ...
                     <div class="table-responsive">
                         <div class="row clearfix">
                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <a class="btn btn-block bg-btn-submit waves-effect target-link"
                                     href="{{ url(Request::segment(1) . '#data-sumber-daya/update-foto/batch') }}"><i
                                         class="material-icons">cloud_upload</i><span>Upload Batch Foto</span></a>
                             </div>
                         </div>
                         <table
 ...
 <script>
     ...
     var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'update-foto/datatables/' +
         status_join_table;
