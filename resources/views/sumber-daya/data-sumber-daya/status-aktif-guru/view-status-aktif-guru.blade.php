...
<script>
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'status-aktif-guru/datatables';
    var edit_url = role_url + '#' + modul_url + '/' + 'status-aktif-guru/edit';
    var delete_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'action-status-aktif-guru/delete';
