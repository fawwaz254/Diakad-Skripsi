    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/action-jabatan-pegawai/edit/'.$data_jabatan_pegawai->id_jabatan_pegawai)}}">
                        {{csrf_field()}}
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="form-control" name="nm_jabatan_pegawai" required="" aria-required="true"
                                    aria-invalid="true" value="{{$data_jabatan_pegawai->nm_jabatan_pegawai}}">
                            </div>
                        </div>
                        <h2 class="card-inside-title">
                            Deskripsi
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="form-control" name="deskripsi_jabatan_pegawai" required="" aria-required="true"
                                    aria-invalid="true" value="{{$data_jabatan_pegawai->deskripsi_jabatan_pegawai}}">
                            </div>
                        </div>
                        <h2 class="card-inside-title">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="form-control" name="tipe_jabatan_pegawai" required="" aria-required="true"
                                    aria-invalid="true" value="{{$data_jabatan_pegawai->tipe_jabatan_pegawai}}">
                            </div>
                        </div>
                        <h2 class="card-inside-title">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="form-control" name="kode_jabatan_pegawai" required="" aria-required="true"
                                    aria-invalid="true" value="{{$data_jabatan_pegawai->kode_jabatan_pegawai}}">
                            </div>
                        </div>
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
