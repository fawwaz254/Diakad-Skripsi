<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#data-sumber-daya/jabatan-pegawai/add') }}"><i
                    class="material-icons">note_add</i><span>Tambah Jabatan Pegawai</span></a></h2>
    </div>
...
<script>
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'nm_jabatan_pegawai',
                name: 'nm_jabatan_pegawai'
            },
            {
                data: 'deskripsi_jabatan_pegawai',
                name: 'deskripsi_jabatan_pegawai'
            },
            {
                data: 'tipe_jabatan_pegawai',
                name: 'tipe_jabatan_pegawai'
            },
            {
                data: 'kode_jabatan_pegawai',
                name: 'kode_jabatan_pegawai'
            },
            {
                data: 'action',
                name: 'action',
