            ...
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/action-input-tendik/add/'.$id_staff)}}">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="datepicker form-control" name="tgl_lahir" aria-required="true"
                                        aria-invalid="true">
                            </div>
                        </div>
                        <h2 class="card-inside-title">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="form-control" name="nip_staff" required="" aria-invalid="true">
                            </div>
                        </div>
                        <h2 class="card-inside-title">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="datepicker form-control" name="tgl_sk_pengangkatan" aria-required="true"
                                        aria-invalid="true">
                            </div>
                        </div>
                        <h2 class="card-inside-title">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="datepicker form-control" name="tgl_mulai_pns" aria-required="true"
                                        aria-invalid="true">
                            </div>
                        </div>
                        <h2 class="card-inside-title">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="datepicker form-control" name="tgl_sk_penugasan" aria-required="true"
                                        aria-invalid="true">
                            </div>
                        </div>
                        <h2 class="card-inside-title">
