<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link "
                href="{{ url(Request::segment(1) . '#guru/input-guru') }}"><i
            ...
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="POST"
                        action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/action-input-guru/edit/' . $guru->id_guru) }}">
                        {{ csrf_field() }}

                        <div id="exTab2" class="">	
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a  href="#1" data-toggle="tab">Identitas Pendidik dan Tenaga Pendidik</a>
                                </li>
                                <li>
                                    <a href="#2" data-toggle="tab">Data Pribadi</a>
                                </li>
                                <li>
                                    <a href="#3" data-toggle="tab">Kepegawaian</a>
                                </li>
                                <li>
                                    <a href="#4" data-toggle="tab">Kompetensi Khusus</a>
                                </li>
                                <li>
                                    <a href="#5" data-toggle="tab">Kontak</a>
                                </li>
                                <li>
                            ...
                            <div class="tab-content ">
                                <div class="tab-pane active" id="1">
                                    <h2 class="card-inside-title">
                                        Nama Guru <span style="color:red;">*</span> <small><strong>*Nama tanpa gelar</strong></small>
                                    </h2>
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control" name="nm_pengguna" required=""
                                                aria-invalid="true" value="{{ $guru->nm_pengguna }}">
                                        </div>
                                    </div>
                                    <h2 class="card-inside-title">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <select class="form-control show-tick" name="jenis_kelamin">
                                                ...
                                                <option value="1" @if ($guru->jenis_kelamin == 1) selected @endif>Laki-Laki
                                                </option>
                                                <option value="2" @if ($guru->jenis_kelamin == 2) selected @endif>Perempuan
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <select class="form-control show-tick" name="id_kota_lahir">
                                                ...
                                                @foreach ($kota as $data)
                                                    <option value="{{ $data->id_kota }}"
                                                        @if ($data->id_kota == $guru->id_kota_lahir) selected @endif>{{ $data->nm_kota }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <input type="text" class="datepicker form-control" name="tgl_lahir" aria-invalid="true"
                                            ...
                                            <select class="form-control show-tick" name="alamat_provinsi">
                                                ...
                                                @foreach ($provinsi as $data)
                                                    <option value="{{ $data->id_provinsi }}"
                                                        @if ($data->id_provinsi == $guru->alamat_provinsi) selected @endif>
                                                        {{ $data->nm_provinsi }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <select class="form-control show-tick" name="alamat_kota">
                                                ...
                                                @foreach ($kota as $data)
                                                    <option value="{{ $data->id_kota }}"
                                                        @if ($guru->alamat_kota == $data->id_kota) selected @endif>{{ $data->nm_kota }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                            ...
                                            <select class="form-control show-tick" name="id_agama">
                                                ...
                                                @foreach ($agama as $data)
                                                    <option value="{{ $data->id_agama }}"
                                                        @if ($data->id_agama == $guru->id_agama) selected @endif>{{ $data->nm_agama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                            ...
                                            <select class="form-control show-tick" name="id_unit_kerja" required="">
                                                ...
                                                @foreach ($data_unit_kerja as $data)
                                                    <option value="{{ $data->id_unit_kerja }}"
                                                        @if ($guru->id_unit_kerja == $data->id_unit_kerja) selected @endif>
                                                        {{ $data->nm_unit_kerja }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <select class="form-control show-tick" name="id_jenis_kepegawaian">
                                                ...
                                                @foreach ($pegawai as $data)
                                                    <option value="{{ $data->id_jenis_kepegawaian }}"
                                                        @if ($data->id_jenis_kepegawaian == $guru->id_jenis_kepegawaian) selected @endif>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control" name="nip_guru" required=""
                                                aria-invalid="true" value="{{ $guru->nip_guru }}">
                                        </div>
                                    </div>
                                    <h2 class="card-inside-title">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <select class="form-control show-tick" name="id_jenis_ptk">
                                                ...
                                                @foreach ($ptk as $data)
                                                    <option value="{{ $data->id_jenis_ptk }}"
                                                        @if ($guru->id_jenis_ptk == $data->id_jenis_ptk) selected @endif>
                                                        {{ $data->nm_jenis_ptk }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control" name="nomor_sk_pengangkatan"
                                                aria-invalid="true" value="{{ $guru->nomor_sk_pengangkatan }}">
                                        </div>
                                    </div>
                                    <h2 class="card-inside-title">
                                            ...
                                            <select class="form-control show-tick" name="id_jenis_lembaga_pengangkat">
                                                ...
                                                @foreach ($pengangkat as $data)
                                                    <option value="{{ $data->id_jenis_lembaga_pengangkat }}"
                                                        @if ($guru->id_jenis_lembaga_pengangkat == $data->id_jenis_lembaga_pengangkat) selected @endif>
                                            ...
                                            <select class="form-control show-tick" name="id_jenis_sumber_gaji">
                                                ...
                                                @foreach ($gaji as $data)
                                                    <option value="{{ $data->id_jenis_sumber_gaji }}"
                                                        @if ($guru->id_jenis_sumber_gaji == $data->id_jenis_sumber_gaji) selected @endif>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control" name="nomor_kartu_pegawai"
                                                aria-invalid="true" value="{{ $guru->nomor_kartu_pegawai }}">
                                        </div>
                                    </div>
                                    <h2 class="card-inside-title">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control" name="nomor_kartu_pasangan"
                                                aria-invalid="true" value="{{ $guru->nomor_kartu_pasangan }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <select class="form-control show-tick" name="is_lisensi_kepsek">
                                                <option value="0" @if ($guru->is_lisensi_kepsek == 0) selected @endif>Tidak Punya
                                                    Lisensi</option>
                                                <option value="1" @if ($guru->is_lisensi_kepsek == 1) selected @endif>Punya Lisensi
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <select class="form-control show-tick" name="id_jenis_keahlian_lab">
                                                ...
                                                @foreach ($lab as $data)
                                                    <option value="{{ $data->id_jenis_keahlian_lab }}"
                                                        @if ($guru->id_jenis_keahlian_lab == $data->id_jenis_keahlian_lab) selected @endif>
                                            ...
                                            <select class="form-control show-tick" name="id_status_pengguna" required="">
                                                ...
                                                @foreach ($data_status_aktif_guru as $data)
                                                    <option value="{{ $data->id_status_pengguna }}"
                                                        @if ($guru->id_status_pengguna == $data->id_status_pengguna) selected @endif>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <select class="form-control show-tick" name="status_kawin">
                                                ...
                                                <option value="2" @if ($guru->status_kawin == 2) selected @endif>Belum Kawin
                                                </option>
                                                <option value="3" @if ($guru->status_kawin == 3) selected @endif>Janda/Duda
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <select class="form-control show-tick" name="id_jenis_pekerjaan_pasangan_ptk">
                                                ...
                                                @foreach ($pekerjaan as $data)
                                                    <option value="{{ $data->id_jenis_pekerjaan }}"
                                                        @if ($guru->id_jenis_pekerjaan_pasangan_ptk == $data->id_jenis_pekerjaan) selected @endif>
