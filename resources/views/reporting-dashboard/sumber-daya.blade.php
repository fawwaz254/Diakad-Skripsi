...
<body>
    <section class="section">
        <div class="container-fluid">
            ...
            <div class="block-header">
                <h2><a class="btn bg-blue waves-effect" href="{{url('reporting-dashboard')}}"><i class="material-icons">backspace</i><span>Kembali</span></a>&nbsp; &nbsp; SUMBER DAYA - {{\App\Models\Sekolah::first()->nm_sekolah}}</h2>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                DATA SUMBER DAYA {{$semester_aktif->tahun_ajaran}} ({{$semester_aktif->nm_semester}})
                            </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
