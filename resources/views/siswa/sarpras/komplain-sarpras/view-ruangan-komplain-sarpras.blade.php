<div class="container-fluid">
    ...
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#sarpras/komplain-sarpras/ruangan-sarpras/add/' . $data_ruangan->id_ruangan) }}"><i
    ...
    <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                {{ csrf_field() }}
                <div class="header">
                    <h2>KOMPLAIN SARPRAS RUANGAN ({{ $data_ruangan->nm_ruangan }} -
                        {{ $data_ruangan->nm_jenis_ruangan }})</h2>
                </div>
                <div class="body">
...
<script>
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' +
        'komplain-sarpras/ruangan-sarpras/datatables/' + id_ruangan;
