    ...
    <div class="block-header">
        @if ($auth_data->sekolah_data->nm_singkat_sekolah == 'smawh2')
            <h2><a class="btn bg-blue waves-effect target-link"
                    href="{{ url(Request::segment(1) . '#' . Request::segment(2) . '/tracer-alumni') }}"><i
                        class="material-icons">backspace</i><span>Kembali</span></a></h2>
        @else
            <h2><a class="btn bg-blue waves-effect target-link"
                    href="{{ url(Request::segment(1) . '#' . Request::segment(2)) }}"><i
                        class="material-icons">backspace</i><span>Kembali</span></a></h2>
        @endif
    </div>
                    ...
                    @if (!empty($alumni))
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <input type="number" class="form-control" name="nomor_hp" required=""
                                aria-required="true" aria-invalid="true" value="{{ $alumni->calon_siswa->nomor_hp }}">
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    ...
                    @else
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="alamat_siswa" required=""
                                ...
                                @if (
                                    !empty(
                                        $siswa->calon_siswa->alamat_kecamatan &&
                                            $siswa->calon_siswa->alamat_kelurahan &&
                                            $siswa->calon_siswa->alamat_dusun &&
                                            $siswa->calon_siswa->alamat_rt &&
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <select class="form-control show-tick" name="jenis_sekolah">
                                        <option @if (!isset($alumni)) selected @endif disabled>Pilih Jenis
                                        </option>
