<div class="container-fluid">
    <div class="block-header">
        <h2>
            <a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#skpi/data-kegiatan-siswa/add')}}"><i class="material-icons">note_add</i><span>Tambah Kegiatan Siswa</span></a>
        </h2>
    </div>
...
<script>
    ...
    var datatable_url   = base_url + '/' + role_url + '/' + modul_url + '/' + 'data-kegiatan-siswa/datatables';
