<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{url(Request::segment(1).'#skpi/data-prestasi-siswa')}}"><i
            ...
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="post"
                        action="{{url(Request::segment(1).'/'.Request::segment(2).'/data-prestasi-siswa/action/edit/'.$prestasi->id_prestasi_siswa)}}">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control show-tick" name="peringkat_prestasi_siswa">
                                    <option value="1" {{$prestasi->peringkat_prestasi_siswa == '1' ? 'selected' : ''}}>
                                        Peringkat 1</option>
                                    <option value="2" {{$prestasi->peringkat_prestasi_siswa == '2' ? 'selected' : ''}}>
                                        Peringkat 2</option>
                                    <option value="3" {{$prestasi->peringkat_prestasi_siswa == '3' ? 'selected' : ''}}>
                                        Peringkat 3</option>
                                    <option value="4" {{$prestasi->peringkat_prestasi_siswa == '4' ? 'selected' : ''}}>
                                        Juara Harapan 1</option>
                                    <option value="5" {{$prestasi->peringkat_prestasi_siswa == '5' ? 'selected' : ''}}>
                                        Juara Harapan 2</option>
                                    <option value="6" {{$prestasi->peringkat_prestasi_siswa == '6' ? 'selected' : ''}}>
                                        Juara Harapan 3</option>
                                    <option value="7" {{$prestasi->peringkat_prestasi_siswa == '7' ? 'selected' : ''}}>
                                        Peserta</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="penyelenggara_prestasi_siswa" required=""
                                    value="{{$prestasi->penyelenggara_prestasi_siswa}}" aria-required="true"
                                    aria-invalid="true">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="datepicker form-control" name="tgl_prestasi_siswa" required=""
                                    aria-required="true"
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control show-tick" name="jenis_lomba_siswa">
                                ...
                                <option value="Individu"
                                    {{$prestasi->jenis_lomba_siswa == 'Individu' ? 'selected' : ''}}>Individu</option>
                                <option value="Kelompok"
                                    {{$prestasi->jenis_lomba_siswa == 'Kelompok' ? 'selected' : ''}}>Kelompok</option>
                            </select>
                        </div>
                ...
                <div class="alert alert-warning">
                    <strong>Catatan !</strong> Untuk link sertifikat pastikan anda mengupload di google drive dengan
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <input type="text" class="form-control" name="link_sertifikat"
                            value="{{$prestasi->link_sertif_prestasi_siswa}}" required="" aria-required="true"
                            aria-invalid="true">
                    </div>
                </div>
