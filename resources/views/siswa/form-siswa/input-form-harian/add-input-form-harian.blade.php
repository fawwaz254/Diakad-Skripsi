<div class="container-fluid">
    ...
    <form id="form-upload" method="POST"
        ...
        @foreach ($form->pertanyaan_form as $pertanyaan_form)
            <input type="hidden" name="id_pertanyaan_form[]" value="{{ $pertanyaan_form->id_pertanyaan_form }}">
            ...
            <div class="row clearfix">
				...
				word-wrap: break-word;">{{ $pertanyaan_form->nm_pertanyaan_form }}</pre>
                            @if ($pertanyaan_form->jenis_pertanyaan == '1')
                                <textarea class="form-control" name="jawaban_pertanyaan[]" data-sample-short required></textarea>
                            @elseif($pertanyaan_form->jenis_pertanyaan == '2')
                                <input type="file" class="form-control" name="jawaban_pertanyaan[]"
