    ...
    <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="body">
                    <div
                        style="padding: 10px 20px; border-radius: 8px; background-color: yellow; width: 20rem; box-shadow: 0 0 5px rgba(0, 0, 0, 0.05);">
                        <h1 style="margin-bottom: 0; color: black;">{{ $total_poin }}</h1>
                        <p style="font-size: 13px; color: black;">Total Poin Pelanggaran</p>
                    </div>
...
<script>
    ...
    var datatable_nonkbm_url = base_url + '/' + role_url + '/' + modul_url + '/' +
        'riwayat-pelanggaran/datatables-non-kbm';
    ...
    var primary_table_nonkbm = $('#primary_table_nonkbm').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'nm_jenis_tindakan',
                name: 'nm_jenis_tindakan'
            },
            {
                data: 'catatan_tindakan_pelanggaran',
                name: 'catatan_tindakan_pelanggaran'
            },
            {
                data: 'tgl_tindakan_pelanggaran',
                name: 'tgl_tindakan_pelanggaran'
            },
            {
