        ...
        <ol type="A" style="margin-top: 30px;">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td>:
                        {{ $siswa->tanggal_skhus_sebelumnya ? date('d F Y', strtotime($siswa->tanggal_skhus_sebelumnya)) : '-' }}
            ...
            {{-- show uploaded file (akte, kk, ijazah) --}}
            @if ($siswa->path_file_akte != null && $siswa->path_file_kk != null && $siswa->path_file_ijazah != null)
                <div class="pagebreak"></div>
                <li style="font-weight: 500;margin-top: 30px;">LAMPIRAN DOKUMEN SISWA</li>
                ...
                <img src="{{ Storage::disk('spaces')->url($siswa->path_file_akte) }}"
                    style="width: 80%; display: block; margin: 0 auto; margin-top: 10px; margin-bottom: 10px; border: 1px solid #000;">
                <div class="pagebreak"></div>
                <table style="width: 100%;">
                    <tr>
                        <td>61.</td>
                ...
                <img src="{{ Storage::disk('spaces')->url($siswa->path_file_kk) }}"
                    style="width: 80%; display: block; margin: 0 auto; margin-top: 10px; margin-bottom: 10px; border: 1px solid #000;">
                <div class="pagebreak"></div>
                <table style="width: 100%;">
                    <tr>
                ...
                <img src="{{ Storage::disk('spaces')->url($siswa->path_file_ijazah) }}"
                    style="width: 80%; display: block; margin: 0 auto; margin-top: 10px; margin-bottom: 10px; border: 1px solid #000;">
            @else
                <li style="font-weight: 500;margin-top: 30px;">LAMPIRAN DOKUMEN SISWA</li>
