...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="target-link" href="{{url(Request::segment(1).'#akademik/kalender-akademik')}}">
                <div class="card">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="target-link" href="{{url(Request::segment(1).'#keuangan/tagihan')}}">
                <div class="card">
                    <div class="body bg-green" style="text-align: -webkit-center;">
                        <img class="media-object" src="{{url('media/flaticon/receipt.png')}}" width="64" height="64">
                        <h5>
                        Tagihan Siswa
                        </h5>
                        <small>Lihat tagihan SPP maupun tagihan kegiatan sekolah lainnya</small>
                    </div>
                </div>
            </a>
        </div>
