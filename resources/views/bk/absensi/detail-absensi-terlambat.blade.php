...
<script type="text/javascript">
    ...
    function editAbsensi(id_presensi_pengguna) {
        window.open(base_url +
            '/{{ Request::segment(1) }}#{{ Request::segment(2) }}/{{ Request::segment(3) }}/editnotes/' +
            id_presensi_pengguna + '/' +
            $id_kelas + '/' + $date, '_blank');
    }

    function addAbsensi(id_pengguna) {
        window.open(base_url +
            '/{{ Request::segment(1) }}#{{ Request::segment(2) }}/{{ Request::segment(3) }}/addnotes/' +
            id_pengguna + '/' +
            $id_kelas + '/' + $date, '_blank');
    }
