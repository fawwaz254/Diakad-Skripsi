...
<script>
    ...
    var datatable_url_belum_nonkbm  = base_url + '/' + role_url + '/' + modul_url + '/' + 'tindakan-pelanggaran/datatables-belum-nonkbm';
    var datatable_url_belum_kbm     = base_url + '/' + role_url + '/' + modul_url + '/' + 'tindakan-pelanggaran/datatables-belum-kbm';
    var datatable_url_sudah         = base_url + '/' + role_url + '/' + modul_url + '/' + 'tindakan-pelanggaran/datatables-sudah';
        ...
        columns: [
            ...
            { data: 'action', name: 'action', searchable: false, orderable: false,
                render: function(data){
                    ...
                    '</a> '+
                    '<button class="btn btn-danger btn-circle waves-effect waves-circle waves-float" onclick="deleteActionTindakan(\''+ delete_url +'\', this)" data-id="'+  data.id +'">'+
