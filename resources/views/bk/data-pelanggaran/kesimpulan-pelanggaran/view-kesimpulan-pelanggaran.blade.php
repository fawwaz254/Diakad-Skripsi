<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#data-pelanggaran/kesimpulan-pelanggaran/add')}}"><i class="material-icons">note_add</i><span>Tambah Kesimpulan Pelanggaran</span></a></h2>
    </div>
