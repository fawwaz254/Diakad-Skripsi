        ...
        <h2>
            <a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#' . Request::segment(2) . '/' . Request::segment(3) . '/add') }}"><i
                    class="material-icons">add</i><span>Tambah Jurnal Harian</span></a>
...
<script type="text/javascript">
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'tambah-jurnal-harian/datatables';
    var edit_url = role_url + '#' + modul_url + '/' + 'tambah-jurnal-harian/edit';
    var delete_url = base_url + '/' + role_url + '/' + modul_url + '/' +
        'tambah-jurnal-harian/action-jurnal-harian/delete';
