        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/tambah-jurnal-pimpinan/action-setting-jurnal-pimpinan/edit/'.$guru->id_jurnal_pimpinan)}}">
                            {{csrf_field()}}
