        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="block-header">
                <h2><a class="btn bg-blue waves-effect target-link"
                        href="{{ url(Request::segment(1) . '#rapor-semester/komponen-mata-pelajaran/add/' . $id_kelas) }}"><i
                        ...
                        href="{{ url(Request::segment(1) . '#rapor-semester/komponen-mata-pelajaran/copy/' . $id_kelas) }}"><i
