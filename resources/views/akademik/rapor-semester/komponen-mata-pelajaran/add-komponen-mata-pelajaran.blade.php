                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <select class="form-control show-tick" name="id_kelompok_mapel_rapor" required="">
                                    @foreach ($kelompok_mapel_rapor as $kel_sisipan)
                                        @if ($kel_sisipan->sub_kelompok_mapel_rapor->count() > 0)
                                            @foreach ($kel_sisipan->sub_kelompok_mapel_rapor as $sub_kelompok_mapel_rapor)
                                                <option
                                                    value="{{ $sub_kelompok_mapel_rapor->id_sub_kelompok_mapel_rapor }}">
                                                    {{ $kel_sisipan->nm_kelompok_mapel_rapor . ' - ' . $sub_kelompok_mapel_rapor->nm_sub_kelompok_mapel_rapor }}
                                                </option>
                                            @endforeach
                                        @else
                                            <option value="{{ $kel_sisipan->id_kelompok_mapel_rapor }}">
                                                {{ $kel_sisipan->nm_kelompok_mapel_rapor }}</option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
