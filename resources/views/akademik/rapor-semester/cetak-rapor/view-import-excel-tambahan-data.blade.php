    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                <div class="header">
                    <h2>
                        UPLOAD NILAI RAPOR SISIPAN PENGEMBANGAN DIRI
                    </h2>
                </div>
                <div class="body">
                    <div class="row clearfix">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <form id="form-upload"
                                action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/' . Request::segment(3) . '/' . Request::segment(4) . '/' . Request::segment(5)) }}"
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <ul>
                                <li>1. Download Template Exel</li>
                                <li>2. Isi Nilai, (Jangan merubah kolom lain kecuali kolom nilai)</li>
                                <li>3. Upload</li>
                            </ul>
                            </a>
                        </div>
