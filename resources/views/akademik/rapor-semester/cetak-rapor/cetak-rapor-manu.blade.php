                            ...
                            @foreach ($kelompok['data'] as $key => $data2)
                                ...
                                @for ($i = 1; $i < $jumlah; $i++)
                                    <tr>
                                        ...
                                        <td style="text-align: center;font-weight: bold;" rowspan="2">
                                            {{ isset($nilai_siswa[$siswa->id_siswa . $data2['id_mata_pelajaran'][$i] . 'rata-rata']) ? $nilai_siswa[$siswa->id_siswa . $data2['id_mata_pelajaran'][$i] . 'rata-rata'] : '' }}
                                        </td>
                                        <td>
                                            {{ isset($nilai_siswa[$siswa->id_siswa . $data2['id_mata_pelajaran'][$i] . 'keterangan']) ? $nilai_siswa[$siswa->id_siswa . $data2['id_mata_pelajaran'][$i] . 'keterangan'] : '' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ isset($nilai_siswa[$siswa->id_siswa . $data2['id_mata_pelajaran'][$i] . 'keterangan2']) ? $nilai_siswa[$siswa->id_siswa . $data2['id_mata_pelajaran'][$i] . 'keterangan2'] : '' }}
                                        </td>
