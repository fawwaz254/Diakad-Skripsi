                    ...
                    <div class="tab-content">
                            ...
                            @if ($id == '0')
                                <div class="block-header">
                                    <h2><a class="btn bg-blue waves-effect target-link"
                                            href="{{ url(Request::segment(1) . '#ujian/ujian-uts-reguler-online/add/0') }}"><i
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="ujian-online">
                            @if ($id == '0')
                                <div class="block-header">
                                    <h2><a class="btn bg-blue waves-effect target-link"
                                            href="{{ url(Request::segment(1) . '#ujian/ujian-uts-reguler-online/add/1') }}"><i
...
<script>
    ...
    var datatable_online_url = base_url + '/' + role_url + '/' + modul_url + '/' +
        'ujian-uts-reguler-online/datatables/1';
    var datatable_reguler_url = base_url + '/' + role_url + '/' + modul_url + '/' +
        'ujian-uts-reguler-online/datatables/0';
