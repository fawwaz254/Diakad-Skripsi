    ...
    <div class="block-header">
        <h2>
            <a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#ujian/ujian-uts-reguler-online') }}"><i
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="header">
                    ...
                    <h2>{{ $kelas->nm_ujian_mp }} @if ($kelas->is_online == 0)
                            Reguler
                        @else
                            Online
                        @endif
                ...
                <div class="body">
                    <div class="table-responsive">
                        <form id="form-validation1" method="POST"
                            action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/action-ujian-uts/assign/' . $kelas->id_ujian_mp) }}">
                            {{ csrf_field() }}
                            @if ($peserta == null)
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <button class="btn btn-block bg-red waves-effect" type="submit"><i
                                            class="material-icons">save</i><span>Tambahkan ke Ujian</span></button>
                                </div>
                            @endif
                            <table
...
<script type="text/javascript">
    ...
    var datatable_reguler_url = base_url + '/' + role_url + '/' + modul_url + '/' +
        'ujian-uts-reguler-online/datatablesSiswa/' + id;
