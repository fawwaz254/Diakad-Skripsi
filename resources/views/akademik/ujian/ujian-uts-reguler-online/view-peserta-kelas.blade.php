            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="table-responsive">
                        <form id="form-validation1" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/action-ujian-uts/assign/'.$kelas->id_ujian_mp)}}">
                            {{csrf_field()}}
                            @if($peserta == null)
...
<script type="text/javascript">
    ...
    var modul_url               = 'ujian';
    var datatable_reguler_url   = base_url + '/' + role_url + '/' + modul_url + '/' + 'ujian-uts-reguler-online/datatablesSiswa/' + id;
