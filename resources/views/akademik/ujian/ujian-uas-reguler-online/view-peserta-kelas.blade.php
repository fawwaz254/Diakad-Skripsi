    ...
    <div class="block-header">
        <h2>
            <a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#ujian/ujian-uas-reguler-online') }}"><i
                ...
                <div class="body">
                    <div class="table-responsive">
                        <form id="form-validation1" method="POST"
                            action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/action-ujian-uas/assign/' . $kelas->id_ujian_mp) }}">
                            {{ csrf_field() }}
                            @if ($peserta == null)
...
<script type="text/javascript">
    ...
    var datatable_reguler_url = base_url + '/' + role_url + '/' + modul_url + '/' +
        'ujian-uas-reguler-online/datatablesSiswa/' + id;
