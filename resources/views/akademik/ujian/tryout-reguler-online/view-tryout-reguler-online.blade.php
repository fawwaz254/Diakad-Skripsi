                    ...
                    <div class="body">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade active in" id="ujian-reguler">
                                @if($id == '0')
                                    <div class="block-header">
                                        <h2><a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#ujian/try-out-reguler-online/add/0')}}"><i class="material-icons">note_add</i><span>Tambah UTS Reguler</span></a></h2>
                                    </div>
                                @elseif($id == '1')
                                    <div class="block-header">
                                        <h2><a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#ujian/try-out-reguler-online/add/0')}}"><i class="material-icons">note_add</i><span>Tambah UAS Reguler</span></a></h2>
                                    </div>
                                @else
                                    <div class="block-header">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="ujian-online">
                                @if($id == '0')
                                    <div class="block-header">
                                        <h2><a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#ujian/try-out-reguler-online/add/1')}}"><i class="material-icons">note_add</i><span>Tambah UTS Online</span></a></h2>
                                    </div>
                                @elseif($id == '1')
                                    <div class="block-header">
                                        <h2><a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#ujian/try-out-reguler-online/add/1')}}"><i class="material-icons">note_add</i><span>Tambah UAS Online</span></a></h2>
                                    </div>
                                @else
                                    <div class="block-header">
...
<script>
    ...
    var modul_url       = 'ujian';
    var datatable_online_url   = base_url + '/' + role_url + '/' + modul_url + '/' + 'try-out-reguler-online/datatables/1';
    var datatable_reguler_url   = base_url + '/' + role_url + '/' + modul_url + '/' + 'try-out-reguler-online/datatables/0';

    var add_url        = role_url + '#' + modul_url + '/' + 'try-out-reguler-online/add';
    var assign_url        = role_url + '#' + modul_url + '/' + 'try-out-reguler-online/assign';
    var edit_url        = role_url + '#' + modul_url + '/' + 'try-out-reguler-online/edit';
    var delete_url      = base_url + '/' + role_url + '/' + modul_url + '/' + 'action-try-out/delete';
