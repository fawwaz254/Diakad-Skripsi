    ...
    <div class="block-header">
        <h2>
            <a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#aktivitas-semester/monitoring-kelas') }}">
...
<script>
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'monitoring-kelas/datatables/' +
    id_semester;
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'nm_pengampu',
                name: 'kelas_mp.pengampu_mp_utama.guru.pengguna.nm_pengguna'
            },
            {
            ...
            {
                data: 'jadwal_jam_mulai.nm_jadwal_jam',
                searchable: false,
                orderable: false
            },
            {
                data: 'jadwal_jam_selesai.nm_jadwal_jam',
                searchable: false,
                orderable: false
            },
            {
                data: 'ruangan.kapasitas_ruangan',
                searchable: false,
                orderable: false
            },
            {
