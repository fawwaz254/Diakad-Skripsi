    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        TAMBAH KOMPONEN NILAI MAPEL
                        {{ strtoupper($data_kelas->nm_mata_pelajaran) . ' (' . strtoupper($data_kelas->kd_mata_pelajaran) . ') Kelas ' . strtoupper($data_kelas->nm_kelas) }}
                    </h2>
                </div>
                <div class="body">
                    <form id="form-validation" method="POST"
                        action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/action-komponen-nilai/add/' . $id_komponen_mp) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="form-control" name="nm_komponen_mp" required=""
