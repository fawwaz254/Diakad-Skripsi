<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link " href="{{url(Request::segment(1).'#aktivitas-semester/usulan-mata-ajar/view-semester-usulan-mata-ajar/'.$id)}}"><i class="material-icons">backspace</i><span>Kembali</span></a></h2>
    </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                    ...
                    <div class="header bg-light-green">
                        <h2>Pilih Mata Pelajaran Yang Ditawarkan</h2>
                        <br>
...
<script>
    ...
    var datatable_url   = base_url + '/' + role_url + '/' + modul_url + '/' + 'usulan-mata-ajar/datatablesMapel/'+ id_semester;
    var edit_url        = role_url + '#' + modul_url + '/' + 'usulan-mata-ajar/add/'+ id_semester;
