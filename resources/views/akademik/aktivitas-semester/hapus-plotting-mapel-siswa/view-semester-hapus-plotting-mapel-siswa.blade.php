<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link "
                href="{{ url(Request::segment(1) . '#aktivitas-semester/hapus-plotting-mapel-siswa') }}"><i
                    class="material-icons">backspace</i><span>Kembali</span></a>
            <a class="btn bg-red waves-effect target-link "
                href="{{ url(Request::segment(1) . '#aktivitas-semester/hapus-plotting-mapel-siswa-otomatis') }}"><i
                    class="material-icons">delete</i><span>Hapus Duplicate Data Otomatis</span></a>
        </h2>
    </div>
...
<script>
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'hapus-plotting-mapel-siswa/datatables/' +
        id_semester;
    var detail_url = role_url + '#' + modul_url + '/' +
        'hapus-plotting-mapel-siswa/view-detail-hapus-plotting-mapel-siswa';
