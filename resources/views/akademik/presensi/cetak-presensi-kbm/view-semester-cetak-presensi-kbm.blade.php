<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link "
                href="{{ url(Request::segment(1) . '#presensi/cetak-presensi-kbm') }}"><i
...
<script>
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'cetak-presensi-kbm/datatables/' +
        id_semester;
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'status_plotting',
                name: 'status_plotting'
            },
            {
                data: 'action',
                name: 'action',
