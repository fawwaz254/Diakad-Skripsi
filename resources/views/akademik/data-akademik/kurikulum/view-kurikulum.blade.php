<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#data-akademik/kurikulum/add')}}"><i class="material-icons">note_add</i><span>Tambah Kurikulum</span></a></h2>
    </div>
...
responsive: true,
        ...
        columns: [
            ...
            { data: 'keterangan_kurikulum', name: 'keterangan_kurikulum' },
