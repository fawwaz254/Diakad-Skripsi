    ...
    <div class="page">
            ...
            <tbody class="body">
                ...
                <tr>
                    <td colspan="2" style="font-weight: bold;">
                        {{ isset($kelompok['nama']) ? $kelompok['nama'] : '' }}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        ...
                        {{ isset($nilai_siswa[$siswa->id_siswa . $data2['id_mata_pelajaran'][0] . $komponen->id_komponen_jenis_rapor]) && $nilai_siswa[$siswa->id_siswa . $data2['id_mata_pelajaran'][0] . $komponen->id_komponen_jenis_rapor] != '0' ? $nilai_siswa[$siswa->id_siswa . $data2['id_mata_pelajaran'][0] . $komponen->id_komponen_jenis_rapor] : '-' }}
                    </td>
                    @endforeach
                </tr>
                @for ($i = 1; $i < $jumlah; $i++) <tr>
                    <td></td>
        ...
        <table cellspacing="0" cellpadding="10" style="width: 90%; margin: 0 auto; ">
            ...
            <tr>
                ...
                @if ($key == '0')
                <td rowspan="{{ $kelompok_pribadi_sisipan[1]->pribadi_sisipan->count() }}"></td>
                <td rowspan="{{ $kelompok_pribadi_sisipan[1]->pribadi_sisipan->count() }}" colspan="2">
