            ...
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="POST"
                        action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/cetak-rapor/actionDeskripsi/edit/' . $rapor_sisipan_deskripsi->id_rapor_sisipan_deskripsi) }}">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <select class="form-control show-tick" name="nm_mata_pelajaran">
                                    ...
                                    @foreach ($mata_pelajaran as $mapel)
                                        <option value="{{ $mapel->nm_mata_pelajaran }}"
                                            @if ($mapel->nm_mata_pelajaran == $rapor_sisipan_deskripsi->nm_mata_pelajaran) selected @endif>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="number" class="form-control" name="tingkat" required=""
                                    ...
                                    value="{{ $rapor_sisipan_deskripsi->tingkat }}">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="number" class="form-control" name="kd_deskripsi" required=""
                                    aria-required="true" aria-invalid="true"
                                    value="{{ $rapor_sisipan_deskripsi->kd_deskripsi }}">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="form-control" name="deskripsi1" required=""
                                    aria-required="true" aria-invalid="true"
                                    value="{{ $rapor_sisipan_deskripsi->deskripsi1 }}">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="form-control" name="deskripsi2" required=""
                                    aria-required="true" aria-invalid="true"
                                    value="{{ $rapor_sisipan_deskripsi->deskripsi2 }}">
