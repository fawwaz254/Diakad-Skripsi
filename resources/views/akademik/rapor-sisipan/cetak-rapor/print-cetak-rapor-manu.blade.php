            ...
            <table cellspacing="0" cellpadding="10" style="width: 90%; margin: 0 auto;">
                <thead class="head" style="background-color: #C2D69B">
                    <tr>
                        ...
                        <th rowspan="2" style="text-align: center;font-weight: bold;">RATA_RATA</th>
                    </tr>
                    <tr>
                        ...
                        @if (isset($kelompok['data']))
                            @foreach ($kelompok['data'] as $key => $data2)
                                ...
                                <tr>
                                    ...
                                    @endforeach
                                    <td style="text-align: center;font-weight: bold;">
                                        {{ isset($nilai_siswa[$siswa->id_siswa . $data2['id_mata_pelajaran'][0]]) ? $nilai_siswa[$siswa->id_siswa . $data2['id_mata_pelajaran'][0]] / 3 : '' }}
                                    </td>
