            ...
            <table cellspacing="0" cellpadding="10" style="width: 90%; margin: 0 auto;">
                ...
                <tbody class="body">
                    ...
                    @foreach ($data as $kelompok)
                        <tr>
                            <td colspan="9" style="font-weight: bold; background-color: #ccffff">
                                    ...
                                    <td style="text-align: center;">
                                        @php
                                            ...
                                            if (isset($nilai_siswa[$siswa->id_siswa . $data2['id_mata_pelajaran'][0]]) && isset($data2['kkm'][0])) {
                                                if (intval($nilai_siswa[$siswa->id_siswa . $data2['id_mata_pelajaran'][0]] / 4) >= $data2['kkm'][0]) {
                                                    $keterangan = 'Tuntas';
                                                } elseif (intval($nilai_siswa[$siswa->id_siswa . $data2['id_mata_pelajaran'][0]] / 4) < $data2['kkm'][0]) {
                    ...
                    <tr>
                        <td style="text-align: center;background-color: #99cccc;font-weight: bold;" colspan="3">
