        ...
        <div class="page">
            <table cellspacing="0" cellpadding="10" style="width: 90%; margin: 0 auto;" style="border-style : hidden">
                ...
                <tr style="border-style : hidden">
                    ...
                    <td style="border-style : hidden;width: 24%;font-weight: bold;">Konsentrasi Keahlian
                    </td>
                    <td style="border-style : hidden;width: 1%;font-weight: bold;"> :
                    </td>
                    <td style="border-style : hidden;width: 25%;font-weight: bold;">
            ...
            <table cellspacing="0" cellpadding="10" style="width: 90%; margin: 0 auto;">
                <thead class="head" style="background-color: #C2D69B">
                    <tr>
                        ...
                        <td colspan="3" style="text-align: center;font-weight: bold;">Formatif</td>
                        <td rowspan="2" style="text-align: center;font-weight: bold;">Nilai STS</td>
                    </tr>
                    <tr>
                ...
                <tbody class="body">
                    ...
                    @foreach ($data as $kelompok)
                        ...
                        @elseif($kelompok['nama'] == 'Kelompok A ( UMUM )')
                            @php
                                $kelompok['nama'] = 'A. Kelompok Mata Pelajaran Umum';
                            @endphp
                        @elseif($kelompok['nama'] == 'Kelompok B ( UMUM )')
                            @php
                                $kelompok['nama'] = 'B. Kelompok Mata Pelajaran Kejuruan';
                            @endphp
                        @endif
                        <tr>
