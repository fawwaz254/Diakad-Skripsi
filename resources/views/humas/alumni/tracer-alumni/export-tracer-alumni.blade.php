            ...
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="POST" class="row"
                        action="{{ url(Request::segment(1) . '/' . Request::segment(2)) }}/tracer-alumni/cetak">
                        {{ csrf_field() }}
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                            @if (!empty($id_kelas) && !empty($tahun_lulus))
                                <a href="humas/alumni/tracer-alumni/export-alumni/B9hY715573740185cd3a4424b336/2022"
                                    target="_blank" style="margin-top: 30px" class="btn bg-green waves-effect ">
                                    <i class="material-icons">local_printshop</i> Cetak</a>
                            @else
                                <a href="humas/alumni/tracer-alumni/alumni/export-alumni/B9hY715573740185cd3a4424b336/2022"
