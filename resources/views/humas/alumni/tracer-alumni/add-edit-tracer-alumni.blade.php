				...
				<div class="body">
					<form id="form-validation" method="POST" class="row"
						...
						<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
							...
							<input type="number" class="form-control" name="tahun_lulus" required="" aria-required="true"
								aria-invalid="true" value="{{(!empty($alumni))? $alumni->tahun_lulus : ''}}">
						</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							...
							<input type="text" class="form-control" name="nomor_hp" required="" aria-required="true"
								aria-invalid="true" value="{{(!empty($alumni))? $alumni->calon_siswa->nomor_hp : ''}}">
						</div>
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
