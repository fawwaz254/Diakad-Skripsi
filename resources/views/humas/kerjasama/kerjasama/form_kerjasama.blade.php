                ...
                <div class="body">
                    <form id="form-validation" method="POST" class="row"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          ...
                          <input type="date" class="form-control" name="tanggal_kerjasama" aria-required="true" aria-invalid="true" value="{{(!empty($kerjasama))? $kerjasama->tanggal_kerjasama : ''}}">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <button id="submit" class="btn btn-block bg-red waves-effect" type="submit">
                                  <i class="material-icons">save</i><span> {{!empty($kerjasama)? 'Update' : 'Save'}} </span>
                                </button>
                            </div>
                        </div>
                    </form>
