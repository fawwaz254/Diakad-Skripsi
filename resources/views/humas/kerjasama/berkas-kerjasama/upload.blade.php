            ...
            <div class="body">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <input type="text" class="form-control" name="nm_kerjasama" required="" aria-required="true"
                        aria-invalid="true" value="{{$kerjasama->nm_kerjasama}}"  readonly>
                    </div>
                </div>
                <h2 class="card-inside-title">
                    Jenis Kerjasama
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <input type="text" class="form-control" name="jenisKerjasama" required="" aria-required="true"
                        aria-invalid="true" value="{{$kerjasama->jenisKerjasama->nm_jenis_kerjasama}}" readonly>
                    </div>
                </div>
                <h2 class="card-inside-title">
                    Instansi
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        aria-invalid="true" value="{{$kerjasama->instansi->nm_instansi}}" readonly>
                    </div>
                </div>
                <h2 class="card-inside-title">
                    Tanggal Kerjasama
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <input type="text" class="form-control" name="tanggal_kerjasama" required="" aria-required="true"
                        aria-invalid="true" value="{{$kerjasama->tanggal_kerjasama}}" readonly>
                    </div>
                </div>
                <h2 class="card-inside-title">
                    Status Kerjasama
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        aria-invalid="true" value="{{$kerjasama->status}}" readonly>
                    </div>
                </div>
            </div>
          </div>
            ...
            <div class="row clearfix">
                @forelse($kerjasama->berkasKerjasama as $berkas)
                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                        <form style="display: flex; flex-direction: column" id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/'. Request::segment(3) . "/delete/$berkas->id_berkas_kerjasama")}}">
                        {{csrf_field()}}
