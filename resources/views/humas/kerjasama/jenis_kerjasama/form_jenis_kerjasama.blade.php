            ...
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="POST" class="row"
                        ...
                        {{csrf_field()}}
                        <input type="hidden" name="id_instansi" value="{{ !empty($jenisKerjasama) ? $jenisKerjasama->id_jenisKerjasama : ''}}">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <h2 class="card-inside-title"> Jenis Kerjasama </h2>
                          <input type="text" class="form-control" name="nm_jenis_kerjasama" aria-required="true" aria-invalid="true" value="{{(!empty($jenisKerjasama))? $jenisKerjasama->nm_jenis_kerjasama : ''}}" >
                        </div>
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <button id="submit" class="btn btn-block bg-red waves-effect" type="submit">
                                  <i class="material-icons">save</i><span> {{!empty($jenisKerjasama)? 'Update' : 'Save'}} </span>
                                </button>
                            </div>
                        </div>
                    </form>
