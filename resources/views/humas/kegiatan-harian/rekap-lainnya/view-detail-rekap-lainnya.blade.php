<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="header">
                    <h2>Data Pengisian Form Kegiatan Harian {{ $pengguna->fullname() }} Tanggal
                        {{ date_format(date_create($date), 'd M Y') }}</h2>
                </div>
                <div class="body">
...
<script>
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' + menu_url + '/datatables/detail';
        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data) {
                    return '<h4><span class="label" style="background-color: #' + data.warna_keadaan +
                        ';">' + data.status + '</span></h4>';
                }
            },
            {
                ...
                render: function(data) {
                    return '<a class="target-link btn btn-info btn-circle waves-effect waves-circle waves-float" href="' +
                        ...
                        '</a> ' +
                        '<button class="btn btn-danger btn-circle waves-effect waves-circle waves-float" onclick="deleteItemAction(\'' +
