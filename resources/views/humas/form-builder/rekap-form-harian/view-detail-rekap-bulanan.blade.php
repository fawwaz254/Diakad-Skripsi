    ...
    <script>
        ...
        var buttonConfigHumas = {
            buttons: [{
                ...
                text: 'PRINT',
                className: "btn-gradient waves-effect",
                action: function(e, dt, node, config) {
                    window.location.href = '{{ url("humas#form-builder/rekap-form/rekap-bulanan-form-harian/export/" . $form->id_form . "/" . $bulan->id_bulan . "/" . $tahun) }}';
                }
            }, ],
            dom: {
                button: {
