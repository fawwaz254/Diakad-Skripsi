    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="POST" action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/list-form/pertanyaan/action-pertanyaan-form/add/0') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                <div id="tambah">
                                    <button class="btn btn-success btn-block" type="button"><i class="material-icons">add</i> Tambah</button>
                                </div>
                            </div>
                        </div>
                        @else
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="number" class="form-control" name="urutan" required="" aria-required="true" aria-invalid="true" value="{{ $urutan }}">
                            </div>
                        </div>
