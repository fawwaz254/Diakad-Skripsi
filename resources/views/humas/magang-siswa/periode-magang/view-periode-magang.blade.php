<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#magang-siswa/periode-magang/add') }}"><i
                    class="material-icons">note_add</i><span>Tambah Periode Magang</span></a></h2>
    </div>
...
<script>
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'nomor_sk_periode_magang',
                name: 'nomor_sk_periode_magang'
            },
            {
                data: 'besar_biaya',
                name: 'besar_biaya'
