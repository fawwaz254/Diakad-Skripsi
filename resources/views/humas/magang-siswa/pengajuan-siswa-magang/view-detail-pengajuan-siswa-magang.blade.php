<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link "
                href="{{ url(Request::segment(1) . '#magang-siswa/pengajuan-siswa-magang') }}"><i
...
<script>
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'pengajuan-siswa-magang/datatables/' +
                ...
                render: function(data) {
                    if (data.id != null) {
                        ...
                        return '<button class="btn btn-info btn-circle waves-effect waves-circle waves-float" onclick="pengajuanAction(\'' +
                            pengajuan_url + '\', this)" data-id-siswa="' + data.id_siswa +
            ...
            if (result) {
                $.ajax({
                    ...
                    url: pengajuan_url + '/0/' + item.attr('data-id-siswa') + '/' + item.attr(
                        'data-id-periode-magang') + '/' + item.attr('data-id-rekanan-magang'),
