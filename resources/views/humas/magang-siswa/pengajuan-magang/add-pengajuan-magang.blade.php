<div class="container-fluid">
    <div class="block-header">
         <h2><a class="btn bg-blue waves-effect target-link " href="{{url(Request::segment(1).'#magang-siswa/pengajuan-magang')}}"><i class="material-icons">backspace</i><span>Kembali</span></a></h2>
    </div>
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2> 
                        PENGAJUAN SISWA MAGANG Rekanan :  {{$data_rekanan_magang->nm_rekanan_magang}}  Periode : {{$data_periode_magang->nm_periode_magang}} 
                    </h2>
                </div>
                <div class="body">
...
<script type="text/javascript">
    ...
    var datatable_url   = base_url + '/' + role_url + '/' + modul_url + '/' + 'pengajuan-magang/datatables-list-siswa/'+$('#rm').val()+"/"+$('#pm').val();
