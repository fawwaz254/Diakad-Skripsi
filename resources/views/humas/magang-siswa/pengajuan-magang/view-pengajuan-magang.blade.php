<div class="container-fluid">
    <div class="block-header">
        <h2>
            <a class="btn bg-blue waves-effect" onclick="pengajuanSiswaMagang()"><i class="material-icons">note_add</i><span>Tambah Siswa Magang</span></a>
            <a class="btn bg-green waves-effect" href="{{url(Request::segment(1).'#'.Request::segment(2).'/'.Request::segment(3).'/import-excel')}}"><i class="material-icons">attach_file</i><span>Import Siswa Magang</span></a>
        </h2>
    </div>
                ...
                <div class="body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <select class="form-control show-tick" name="id_rekanan_magang" id="id_rekanan_magang" required>
...
<form id="form-validation" method="post"  action="{{url(Request::segment(1).'/'.Request::segment(2).'/pengajuan-magang/action-pengajuan-magang')}}">
{{csrf_field()}}
            ...
            { data: 'action', name: 'action', searchable: false, orderable: false,
                render: function(data){
                    ...
                    if(data.status_apv_pengambilan_magang == 2){
                        html +=  '<button class="btn btn-warning btn-circle waves-effect waves-circle waves-float" onclick="pengajuanAction(\''+ data.id +'\', \`tidak-diapprove`\)">'+
                    ...
                    if(data.status_apv_pengambilan_magang == 1){
                             ...
                             html += '<button class="btn btn-success btn-circle waves-effect waves-circle waves-float" onclick="pengajuanAction(\''+ data.id +'\', \`pengubahan-status-magang`\)">'+
                            '    <i class="material-icons">input</i>'+
                            '</button> ';
