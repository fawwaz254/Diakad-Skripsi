                        ...
                        <table class="table table-bordered" width="600px">
                            <thead style="background:#9C27B0;color:white">
                                <tr>
                                    ...
                                    <th>Unit Kerja</th>
                                    <th style="text-align: center;">Hadir</th>
                                    <th style="text-align: center;">Hadir <br>Terlambat</th>
                                    {{-- <th style="text-align: center;">Belum Hadir</th> --}}
                                    <th style="text-align: center;">Izin</th>
                                    <th style="text-align: center;">Sakit</th>
                                    <th style="text-align: center;">Alpha</th>
                                    <th style="text-align: center;">Tidak <br> Checkout</th>
                                    <th style="text-align: center;">Pulang <br> Lebih Awal</th>
                                    <th style="text-align: center;">Telat, <br> Pulang Lebih Awal</th>
                                    <th style="text-align: center;">Kosong</th>
                                    <th style="text-align: center;">Libur</th>
                                    <th style="text-align: center;">Telat, <br> Tidak Checkout</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $key => $r)
                                    ...
                                    @endif
                                            ...
                                            <td style="text-align: center;">{{ $r['pulang'] }}</td>
                                            {{-- <td style="text-align: center;">{{ $r['tidakCheckout'] }}</td> --}}
                                            <td style="text-align: center;">{{ $r['telatDanPulangLebihAwal'] }}</td>
                                            <td style="text-align: center;">{{ $r['kosong'] }}</td>
                                            <td style="text-align: center;">{{ $r['libur'] }}</td>
                                            <td style="text-align: center;">{{ $r['Telat & Tidak Checkout'] }}</td>
