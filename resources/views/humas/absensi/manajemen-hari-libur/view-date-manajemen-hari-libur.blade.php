                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-5">
                            ...
                            <input type="date" class="form-control" name="date"
                                aria-required="true" value="{{$date}}" aria-invalid="true">
                        </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{$column['extra_money']}}</td>
                                <td style="text-align: center;display:flex;justify-content:center">
                                    @if (!$column['manajemen_hari_libur_id'])
                                    <button type="button" class="btn bg-teal waves-effect" onclick="addAbsensi('{{$column['date_value']}}')">
                                        <i class="material-icons">edit</i>
                                    </button>
                                    @else
                                    <button type="button" class="btn bg-teal waves-effect" onclick="editAbsensi('{{$column['date_value']}}')">
                                        <i class="material-icons">edit</i>
                                    </button>
                                    <button data-date={{$column['date_value']}} style="margin-left:3px;" class="btn bg-red waves-effect delete-record">
