<div class="container-fluid">
    ...
    <form method="POST" id="form-validation" action="{{ url()->current() }}">
        {{ csrf_field() }}
                    ...
                    <div class="body">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input type="date" value="{{ $holiday['date'] }}" name="date" class="form-control"
                                    required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input type="text" value="{{ $holiday['explanation'] }}" name="explanation"
