            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header bg-black">
                        <h2>
                            EDIT DATA DOKUMEN {{$dokumen->nm_arsip_dokumen}}
                        </h2>
                    </div>
                    <div class="body">
                        <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/action-input-dokumen/edit/'.$dokumen->id_arsip_dokumen)}}">
                            {{csrf_field()}}
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select class="form-control show-tick" name="id_arsip_loker">
                                        ...
                                        @foreach($loker as $data)
                                            <option value="{{$data->id_arsip_loker}}" @if($data->id_arsip_loker == $dokumen->id_arsip_loker) selected @endif>
                                                {{$data->nm_arsip_loker}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select class="form-control show-tick" name="id_arsip_pemilik">
                                        ...
                                        @foreach($pemilik as $data)
                                            <option value="{{$data->id_arsip_pemilik}}" @if($data->id_arsip_pemilik == $dokumen->id_arsip_pemilik) selected @endif>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select class="form-control show-tick" name="id_unit_kerja">
                                        ...
                                        @foreach($unit as $data)
                                            <option value="{{$data->id_unit_kerja}}" @if($data->id_unit_kerja == $dokumen->id_unit_kerja) selected @endif>
                                                {{$data->nm_unit_kerja}}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    aria-invalid="true" value="{{$dokumen->nm_arsip_dokumen}}">
                                </div>
                            </div>
                            <h2 class="card-inside-title">
                                Kode Katalog
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    aria-invalid="true" value="{{$dokumen->kode_katalog}}">
                                </div>
                            </div>
                            <h2 class="card-inside-title">
                                Nomor Arsip Dokumen
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    aria-invalid="true" value="{{$dokumen->nomor_arsip_dokumen}}">
                                </div>
                            </div>
                            <h2 class="card-inside-title">
                                Jumlah Halaman
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    aria-invalid="true" value="{{$dokumen->jumlah_halaman}}">
                                </div>
                            </div>
                            <h2 class="card-inside-title">
                                Tanggal Penyusunan
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    aria-invalid="true" value="{{$dokumen->tgl_penyusunan}}">
                                </div>
                            </div>
                            <h2 class="card-inside-title">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    aria-invalid="true" value="{{$dokumen->contact_person}}">
                                </div>
                            </div>
