    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        TAMBAH Dokumen Tanda Tangan Digital
                    </h2>
                </div>
                <div class="body">
                    <form id="form-upload" method="POST"
                        action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/tanda-tangan-digital/action-tanda-tangan-digital/add/0') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea rows="4" class="form-control no-resize" id="editor1" name="isi_dokumen" required=""
                                            aria-required="true" aria-invalid="true" value=""></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
