    ...
    <div class="block-header">
        <h2>
            <a class="btn bg-blue waves-effect target-link"
                href="{{url(Request::segment(1) . '#manajemen-file/data-file/add')}}">
                    ...
                    <div id="folderContainer" class="row">
                        @foreach($category as $r)       
                            <div class="col-md-3 folder-item">
                                <a href="{{url(Request::segment(1) . '#manajemen-file/data-file/category/' . $r->category_file_id)}}" style="color: inherit;text-decoration: inherit;" class="folder-link">
                                    <div class="folder">
                                        <center>
                                            <i class="material-icons" style="color:#DAA520; font-size: 45px;">folder</i>
                                        </center>
                                        <center style="overflow-x: hidden;">
