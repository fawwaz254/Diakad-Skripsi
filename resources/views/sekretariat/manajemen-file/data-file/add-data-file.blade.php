                ...
                <div class="body">
                    <form id="form-upload" method="POST"
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="demo-radio-button">
                                    <input name="file_from" onchange="change_file_from()" type="radio" id="radio_4"
                                        value="1" checked="" class="with-gap" />
                                    <label for="radio_4">File Dari Komputer</label>
                                    <input name="file_from" onchange="change_file_from()" type="radio" id="radio_5"
                        ...
                        <div class="row clearfix" id="place_file">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <label>File ( pdf , pptx , docx , xlsx , xlsm , png , jpg , jpeg | Max 50 File | max 10 MB per-upload )</label>
                                <input type="file" class="form-control" id="file"
                                    accept=".pdf, .pptx, .docx, .xlsx, .xlsm, .png, .jpg, .jpeg" name="file[]"
                                    multiple />
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <textarea rows="4" cols="50" class="form-control" name="keterangan" required=""
        ...
        $.ajax({
            ...
            complete: function(data) {
                ...
                data.responseJSON.forEach(d => {
                    html +=
                        `<option value="${d.sub_category_file_id}">${d.sub_category_file_name}</option>`;
                });
