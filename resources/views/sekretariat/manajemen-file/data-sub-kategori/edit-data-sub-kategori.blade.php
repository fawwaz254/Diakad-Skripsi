        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/data-sub-kategori/action-data-sub-kategori/edit/'.$sub_data_kategori->sub_category_file_id)}}">
                            {{csrf_field()}}
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    aria-invalid="true" value="{{$sub_data_kategori->sub_category_file_name}}">
                                </div>
                            </div>
                            <h2 class="card-inside-title">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            aria-invalid="true" value="">{{$sub_data_kategori->sub_category_file_explanation}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <select class="form-control" name="category_file_id">
                                    @foreach ($data_kategori as $value)
                                        @if($sub_data_kategori->category_file_id == $value->category_file_id)
                                           <option value= "{{$value->category_file_id}}" selected="">{{$value->category_file_name}}</option>
                                        @else
