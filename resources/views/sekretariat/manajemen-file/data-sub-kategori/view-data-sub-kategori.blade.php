    ...
    <div class="block-header">
        <h2>
            <a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#manajemen-file/data-sub-kategori/add') }}"><i
...
<script>
    ...
    var delete_url = base_url + '/' + role_url + '/' + modul_url + '/' +
        'data-sub-kategori/action-data-sub-kategori/delete';
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'category_file',
                name: 'category_file.category_file_name'
            },
            {
                data: 'action',
                name: 'action',
