<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                    <div class="header">
                        <h2>Data Laporan Wali Kelas Role {{$laporan_wali_kelas->role->nm_role}} Semester {{$laporan_wali_kelas->semester->tahun_ajaran}} {{$laporan_wali_kelas->semester->nm_semester}} Bulan {{$laporan_wali_kelas->bulan->nm_bulan}}</h2>
                    </div>
                    <div class="body">
