<div class="container-fluid">
    <div class="block-header">
        <h2>
            <a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#data-sekretariat/data-loker-almari/add')}}"><i class="material-icons">note_add</i><span>Tambah Data Loker/Almari</span></a>
        </h2>
    </div>
