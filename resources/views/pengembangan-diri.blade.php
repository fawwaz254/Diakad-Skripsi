<table class="table table-bordered">
    ...
    <thead>
        <tr>
            ...
            @foreach ($data['kelompok_pribadi_sisipan'] as $kelompok_pribadi_sisipan)
                @foreach ($kelompok_pribadi_sisipan->pribadi_sisipan as $pribadi_sisipan)
                    <td style="text-align: center;font-weight: bold;">{{ $pribadi_sisipan->nm_pribadi_sisipan }}</td>
                @endforeach
            @endforeach
        </tr>
    </thead>
