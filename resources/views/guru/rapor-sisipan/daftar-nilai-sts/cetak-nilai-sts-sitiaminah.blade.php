        ...
        <table cellspacing="0" cellpadding="10" style="width: 90%; margin: 0 auto;">
            <thead class="head">
                <tr>
                    ...
                    <td rowspan="2" style="text-align: center;font-weight: bold;">KKM<br></td>
                    <td colspan="2" style="text-align: center;font-weight: bold;">Pengetahuan</td>
                    <td colspan="2" style="text-align: center;font-weight: bold;">Keterampilan</td>
                </tr>
                <tr>
                ...
                @foreach ($list_siswa as $siswa)
                    <tr>
                        ...
                        <td style="text-align: center;">
                            {{ $nilai_siswa['kkm'] != '0' ? $nilai_siswa['kkm'] : null }}
