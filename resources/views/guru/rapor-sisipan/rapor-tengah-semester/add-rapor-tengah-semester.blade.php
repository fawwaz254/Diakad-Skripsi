<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#rapor-sisipan/rapor-tengah-semester') }}"><i
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <form id="form-validation" method="POST"
                        action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/rapor-tengah-semester/action-rapor-tengah-semester/add/0') }}">
                        {{ csrf_field() }}
                        <div class="row clearfix">
                            <div class="col-md-4">
