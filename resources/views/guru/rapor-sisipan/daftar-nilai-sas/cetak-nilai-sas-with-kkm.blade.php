        ...
        <table cellspacing="0" cellpadding="10" style="width: 90%; margin: 0 auto;">
            <thead class="head">
                <tr>
                    ...
                    <td colspan="3" style="text-align: center;font-weight: bold;">NILAI</td>
                ...
                <tr>
                    ...
                    <td style="text-align: center;font-weight: bold;">UTS</td>
                    <td style="text-align: center;font-weight: bold;">UAS</td>
                </tr>
                {{-- <tr>
                    <td colspan="2" style="text-align: center;font-weight: bold;">NOMOR</td>
                    <td rowspan="2" style="text-align: center;font-weight: bold;">NAMA SISWA<br></td>
                    <td colspan="4" style="text-align: center;font-weight: bold;">KKM</td>
                    <td colspan="4" style="text-align: center;font-weight: bold;">UTS</td>
                    <td rowspan="2" style="text-align: center;font-weight: bold;">UAS</td>
                </tr>
                <tr>
                    <td style="text-align: center;font-weight: bold;">URT</td>
                    <td style="text-align: center;font-weight: bold;">INDUK</td>
            ...
            <tbody class="body">
                ...
                @foreach ($list_siswa as $siswa)
                    <tr>
                        ...
                        <td style="text-align: center;">{{ round($nilai_komponen[$siswa->id_siswa . 'kkm']) }}</td>
                        <td style="text-align: center;">{{ round($nilai_komponen[$siswa->id_siswa . 'uts']) }}</td>
                        <td style="text-align: center;">{{ round($nilai_komponen[$siswa->id_siswa . 'uas']) }}</td>
                        {{-- <td style="text-align: center;">
