            ...
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="POST"
                        action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/tambah-nilai-rapor-semester/action/editNilai/' . $id_rapor) }}">
                        {{ csrf_field() }}
...
<script type="text/javascript">
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'tambah-nilai-rapor-semester/getNilai/' +
        id_rapor;
