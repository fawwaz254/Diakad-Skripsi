                ...
                <div class="body">
                    <div class="row clearfix">
                        <form class="form-validation" id="form-validation" method="POST"
                            ...
                            {{csrf_field()}}
                            <input type="hidden" name="id_paket_soal" @if($item) value="{{$item->id_paket_soal}}" @endif>
                            <div class="row clearfix">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="title" required=""
                                                aria-required="true" aria-invalid="true" @if($item)
                                                value="{{$item->text}}" @endif>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select class="form-control show-tick" name="nilai" required="">
                                                @if($item)
                                                <option @if($item->nilai == 20) selected @endif value="20">20 Point per
                                                    Soal</option>
                                                <option @if($item->nilai == 10) selected @endif value="10">10 Point per
                                                    Soal</option>
                                                <option @if($item->nilai == 5) selected @endif value="5">5 Point per
                                                    Soal</option>
                                                @else
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select class="form-control show-tick" name="kelas" required="" required="">
                                                @if($item)
                                                @foreach ($kelas as $k)
                                                <option @if($item->id_kelas ==  $k->id_kelas) selected @endif value="{{ $k->id_kelas }}">{{ $k->nm_kelas }}</option>
                                                @endforeach
                                                @else
                                        ...
                                        <div class="form-line">
                                            <select class="form-control show-tick" name="waktu_pengerjaan" required="">
                                                ...
                                                <option @if($item->waktu_pengerjaan == 30) selected @endif value="30">30
                                                    Menit</option>
                                                <option @if($item->waktu_pengerjaan == 20) selected @endif value="20">20
                                                    Menit</option>
                                                <option @if($item->waktu_pengerjaan == 10) selected @endif value="10">10
                                                    Menit</option>
                                                @else
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="datetime-local" class="form-control" name="waktu_selesai"
                                            required="" aria-required="true" aria-invalid="true" @if($item)
                                            value="{{ $item->waktu_selesai }}" @endif>
