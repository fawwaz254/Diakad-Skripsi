    ...
    <div class="row clearfix">
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <div class="row clearfix">
                        <form class="form-validation" id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/paket-soal')}}">
                            {{csrf_field()}}
                            <input type="hidden" name="question_package_id" @if($item) value="{{$item->question_package_id}}" @endif>
                            <div class="row clearfix">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="title" required="" aria-required="true" aria-invalid="true" @if($item) value="{{$item->title}}" @endif>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select class="form-control show-tick" name="waktu_pengerjaan" required="">
                                                <option disabled selected value="">-- Pilih Durasi Pengerjaan --</option>
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        {{-- <label class="form-label">Title</label> --}}
                                        <input type="datetime-local" class="form-control" name="waktu_mulai" required="" aria-required="true" aria-invalid="true" @if($item) value="" @endif>
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="datetime-local" class="form-control" name="waktu_selesai" required="" aria-required="true" aria-invalid="true" @if($item) value="" @endif>
