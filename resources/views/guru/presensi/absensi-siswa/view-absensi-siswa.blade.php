                ...
                <div class="body">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="uts_with_icon_title">
                            <form id="form-validation-uts" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/post-uts-absensi-siswa')}}">
                                    {{csrf_field()}}
                                <h2 class="card-inside-title">
                                    Ujian UTS
                                </h2>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="uas_with_icon_title">
                            <form id="form-validation-uas" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/post-uas-absensi-siswa')}}">
                                    {{csrf_field()}}
                                <h2 class="card-inside-title">
                                    Ujian UAS
                                </h2>
