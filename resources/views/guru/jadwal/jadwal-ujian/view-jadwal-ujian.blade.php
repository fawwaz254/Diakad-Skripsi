                    ...
                    <div class="body">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade active in" id="uts_with_icon_title">
                                <div class="body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hover dataTable display" id="primary_table_uts" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="uas_with_icon_title">
                                <div class="body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hover dataTable display" id="primary_table_uas" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Mata Pelajaran</th>
...
<script>
    ...
    var primary_table_uts = $('#primary_table_uts').DataTable({
        ...
        columns: [
            ...
            { data: 'status_pjmp_uts', name: 'status_pjmp_uts'},
    ...
    var primary_table_uas = $('#primary_table_uas').DataTable({
        ...
        columns: [
            ...
            { data: 'nm_kelas', name: 'nm_kelas'},
            { data: 'nm_ruangan', name: 'nm_ruangan'},
            { data: 'status_pjmp_uas', name: 'status_pjmp_uas'},
            { data: 'is_online', name: 'is_online'}
        ]
    });
