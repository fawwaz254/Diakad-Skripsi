    ...
    <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                    ...
                    <div class="body">
                        <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/action-absensi-siswa/add-kbm/'.$id_kelas_mp)}}">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <textarea name="uraian_materi">{{$data_kelas->uraian_materi}}</textarea>
                                </div>
                            </div>
                            <h2 class="card-inside-title">
                                Waktu Mulai
...
responsive: true,
        ...
        columns: [
            ...
            { data: 'alasan', name: 'alasan', searchable: false, orderable: false,
                render: function(data){
                    return '<select class="form-control show-tick" name="alasan[]"><option value="">'+ data.hadir + '</option><option value="2">'+ data.alasan_2 + '</option><option value="3">'+ data.alasan_3 + '</option><option value="4">'+ data.alasan_4 + '</option></select>';
