            ...
            <div class="card">
                <div class="header">
                    <h2>
                        ...
                        <a target="_blank" href="{{url(Request::segment(1).'/'.Request::segment(2).'/'.Request::segment(3).'/'.$data_kelas->id_kelas.'/'.$bulan->id_bulan.'/'.$tahun.'/download')}}" class="btn btn-success waves-effect"><i class="material-icons">print</i><span>Download Excel</span></a>
                    </h2>
                </div>
                <div class="body">
...
function filterAction(){
    loadURI('{{Request::segment(2)}}/{{Request::segment(3)}}/{{$data_kelas->id_kelas}}/' + $('select[name=id_bulan]').val() + '/' + $('select[name=tahun]').val());
}
