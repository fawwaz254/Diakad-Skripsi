    ...
    <div class="block-header">
        <h2>
            <a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#' . Request::segment(2) . '/data-kegiatan/add') }}"><i
                    class="material-icons">note_add</i><span>Tambah Kegiatan</span></a>
        </h2>
    </div>
...
<script>
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'data-kegiatan/datatables';
    var edit_url = role_url + '#' + modul_url + '/' + 'data-kegiatan/edit';
    var delete_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'data-kegiatan/action/delete';
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [{
            ...
            },
            {
                ...
                name: 'tingkat_prestasi_siswa.nm_tingkat_prestasi_siswa'
            },
            {
                data: 'tgl_kegiatan',
                name: 'tgl_kegiatan'
