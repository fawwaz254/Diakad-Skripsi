            ...
            <div class="card" style="margin-top: 10px">
                ...
                <div class="body">
                    ...
                    <div class="header">
                        ...
                        SEMESTER {{$semester->tahun_ajaran}} {{$semester->nm_semester}}</h2>
                    </div>
                    <div class="body">
...
<script>
    ...
    var modul_url       = 'guru-kpi';
    var datatable_url   = base_url + '/' + role_url + '/' + modul_url + '/' + 'rekap-nilai-kpi/datatables' + '/'+ id_kelas;
    var add_url        = role_url + '#' + modul_url + '/' + 'rekap-nilai-kpi/rekap-nilai';
