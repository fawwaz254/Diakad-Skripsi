                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form id="formUpload" method="POST"
                            action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/action-upload-dokumen/upload/' . $dokumen->id_arsip_dokumen) }}"
                        ...
                        <form id="form-validation" method="POST"
                            action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/action-upload-dokumen/delete-file/' . $dokumen->id_arsip_dokumen) }}">
