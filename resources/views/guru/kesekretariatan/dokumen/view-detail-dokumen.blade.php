<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#kesekretariatan/dokumen/') }}"><i
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <input type="text" class="form-control" name="kode_katalog" required=""
                                aria-required="true" aria-invalid="true" value="{{ $dokumen->kode_katalog }}" readonly>
                        </div>
                    </div>
                    <h2 class="card-inside-title">
                        Unit Kerja
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <input type="text" class="form-control" name="nomor_arsip_dokumen" required=""
                                aria-required="true" aria-invalid="true" value="{{ $dokumen->nomor_arsip_dokumen }}"
                                readonly>
                        </div>
                    </div>
                    <h2 class="card-inside-title">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <input type="text" class="form-control" name="id_arsip_pemilik" required=""
                                aria-required="true" aria-invalid="true" value="{{ $dokumen->nm_arsip_pemilik }}"
                                readonly>
                        </div>
                    </div>
                    <h2 class="card-inside-title">
