<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <select class="form-control show-tick" name="id_arsip_loker">
                                ...
                                @foreach ($loker as $data)
                                    <option value="{{ $data->id_arsip_loker }}"
                                        @if (!empty($dokumen->id_arsip_dokumen)) @if ($data->id_arsip_loker == $dokumen->id_arsip_loker) selected @endif
                                        @endif>
                                        {{ $data->nm_arsip_loker }}
                                    </option>
                                @endforeach
                            ...
                            <select class="form-control show-tick" name="id_arsip_pemilik">
                                ...
                                @foreach ($pemilik as $data)
                                    <option value="{{ $data->id_arsip_pemilik }}"
                                        @if (!empty($dokumen->id_arsip_dokumen)) @if ($data->id_arsip_pemilik == $dokumen->id_arsip_pemilik) selected @endif
                                        @endif>
                            ...
                            <select class="form-control show-tick" name="kategori" onchange="subKategori()">
                                ...
                                @foreach ($kategori as $data)
                                    <option value="{{ $data->id_arsip_kategori }}"
                                        @if (!empty($dokumen->id_arsip_dokumen)) @if ($data->id_arsip_kategori == $dokumen->id_arsip_kategori) selected @endif
                                        @endif>
                            ...
                            <select class="form-control show-tick" name="id_unit_kerja">
                                ...
                                @foreach ($unit as $data)
                                    <option value="{{ $data->id_unit_kerja }}"
                                        @if (!empty($dokumen->id_arsip_dokumen)) @if ($data->id_unit_kerja == $dokumen->id_unit_kerja) selected @endif
                                        @endif>
                                        {{ $data->nm_unit_kerja }}
                                    </option>
                                @endforeach
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <input type="text" class="form-control" name="nm_arsip_dokumen" required=""
                                ...
                                value="@if (!empty($dokumen->id_arsip_dokumen)) {{ $dokumen->nm_arsip_dokumen }} @endif">
                        </div>
                    </div>
                    <h2 class="card-inside-title">
                        Kode Katalog
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <input type="text" class="form-control" name="kode_katalog" required=""
                                aria-required="true" aria-invalid="true"
                                value="@if (!empty($dokumen->id_arsip_dokumen)) {{ $dokumen->kode_katalog }} @endif">
                        </div>
                    </div>
                    <h2 class="card-inside-title">
                        Nomor Arsip Dokumen
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <input type="text" class="form-control" name="nomor_arsip_dokumen" required=""
                                aria-required="true" aria-invalid="true"
                                value="@if (!empty($dokumen->id_arsip_dokumen)) {{ $dokumen->nomor_arsip_dokumen }} @endif">
                        </div>
                    </div>
                    <h2 class="card-inside-title">
                        Jumlah Halaman
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <input type="text" class="form-control" name="jumlah_halaman" required=""
                                aria-required="true" aria-invalid="true"
                                value="@if (!empty($dokumen->id_arsip_dokumen)) {{ $dokumen->jumlah_halaman }} @endif">
                        </div>
                    </div>
                    <h2 class="card-inside-title">
                        Tanggal Penyusunan
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <input type="text" class="datepicker form-control" name="tgl_penyusunan" required=""
                                aria-required="true" aria-invalid="true"
                                value="@if (!empty($dokumen->id_arsip_dokumen)) {{ $dokumen->tgl_penyusunan }} @endif">
                        </div>
                    </div>
                    <h2 class="card-inside-title">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <input type="text" class="form-control" name="contact_person" required=""
                                aria-required="true" aria-invalid="true"
                                value="@if (!empty($dokumen->id_arsip_dokumen)) {{ $dokumen->contact_person }} @endif">
                        </div>
                    </div>
                    <h2 class="card-inside-title">
                        Dokumen
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <select class="form-control" name="is_publik" id="is_publik">
                                ...
                                <option value="1"
                                    @if (!empty($dokumen->id_arsip_dokumen)) @if ($dokumen->is_publik == 1) selected @endif
                                    @endif>Publik</option>
                                <option value="0"
                                    @if (!empty($dokumen->id_arsip_dokumen)) @if ($dokumen->is_publik == 0) selected @endif
                                    @endif>Terbatas</option>
                            </select>
                        </div>
                    </div>
                    <div class="row clearfix">
            ...
            <div id="hak_akses"
                @if (!empty($dokumen->id_arsip_dokumen)) @if ($dokumen->is_publik == 1) style="display: none" @endif
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                        ...
                                        @if (!empty($dokumen->id_arsip_dokumen)) @if ($dokumen_akses->firstWhere('status_join_table', 1)) checked @endif
                                        @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2"
                                        ...
                                        @if (!empty($dokumen->id_arsip_dokumen)) @if ($dokumen_akses->firstWhere('status_join_table', 2)) checked @endif
                                        @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox3"
                                        ...
                                        @if (!empty($dokumen->id_arsip_dokumen)) @if ($dokumen_akses->firstWhere('status_join_table', 3)) checked @endif
                                        @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox4"
                                        ...
                                        @if (!empty($dokumen->id_arsip_dokumen)) @if ($dokumen_akses->firstWhere('status_join_table', 4)) checked @endif
                                        @endif>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox5"
                                        ...
                                        @if (!empty($dokumen->id_arsip_dokumen)) @if ($dokumen_akses->firstWhere('status_join_table', 5)) checked @endif
                                        @endif>
                                ...
                                @foreach ($unit as $unit_kerja)
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox"
                                            id="inlineCheckbox{{ $end }}" name="unit_kerja[]"
                                            value="{{ $unit_kerja->id_unit_kerja }}"
                                            @if (!empty($dokumen->id_arsip_dokumen)) @if ($dokumen_akses->firstWhere('id_unit_kerja', $unit_kerja->id_unit_kerja)) checked @endif
                                            @endif>
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $.each(result, function(key, item) {
                    html += '<option value="' + item.id_arsip_subkategori + '">' + item
                        .nm_arsip_subkategori + '</option>'
                });
                ...
                success: function(result) {
                    ...
                    $.each(result, function(key, item) {
                        if (id_subkategori == item.id_arsip_subkategori) {
                            html += '<option value="' + item.id_arsip_subkategori +
                                '" selected>' + item.nm_arsip_subkategori + '</option>'
                        } else {
                            html += '<option value="' + item.id_arsip_subkategori + '">' +
                                item.nm_arsip_subkategori + '</option>'
                        }
                    });
                    $('select[name=id_arsip_subkategori]').html(html);
                }
