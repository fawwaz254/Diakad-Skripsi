        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data) {
                    return '<a class="target-link btn btn-warning btn-circle waves-effect waves-circle waves-float" href="' +
                        detail_url + '/' + data.id + '">' +
                        ...
                        '</a> ' +
                        '<a class="target-link btn btn-success btn-circle waves-effect waves-circle waves-float" href="' +
                        upload_url + '/' + data.id + '">' +
