    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form id="form-upload" method="POST"action="{{url(Request::segment(1).'/'.Request::segment(2).'/'.Request::segment(3).'/action-kerja-harian/edit/'.$laporan_kerja_harian->id_laporan_kerja_harian)}}">
                        {{csrf_field()}}
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="datepicker form-control" value="{{$tanggal}}" name="tanggal" required="" aria-required="true"
                                        aria-invalid="true">
                            </div>
                        </div>
                        ...
                        <div class="demo-radio-button">
                            <input name="status" type="radio" value="1" id="radio_1" {{$laporan_kerja_harian->status == 1 ? 'checked' : ''}}/>
