<div class="container-fluid">
    <div class="block-header">
        <h2>
            <a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#jurnal-pimpinan/laporan-jurnal-pimpinan/add')}}"><i class="material-icons">add</i><span>Tambah Laporan Jurnal Pimpinan</span></a>
