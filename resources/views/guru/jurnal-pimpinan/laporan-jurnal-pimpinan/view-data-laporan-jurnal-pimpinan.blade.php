    ...
    <div class="block-header">
        <h2>
            <a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#jurnal-pimpinan/laporan-jurnal-pimpinan/add') }}"><i
                    class="material-icons">add</i><span>Tambah Laporan Jurnal Pimpinan</span></a>
                        ...
                        <table
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="vertical-align : middle;text-align:center;">Uraian Kegiatan</th>
...
<script type="text/javascript">
    ...
    var delete_url = base_url + '/' + role_url + '/' + modul_url + '/' +
        'laporan-jurnal-pimpinan/action-kerja-harian/delete';
