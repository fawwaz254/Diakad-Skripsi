    ...
    <div class="block-header">
        <h2>
            <a class="btn bg-green "
                href="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/rapor-sisipan-input-non-mapel/template-excel-pengembangan-diri/' . $id_kelas) }}"
            ...
            <a class="btn bg-green waves-effect target-link"
                href="{{ url(Request::segment(1) . '#' . Request::segment(2) . '/rapor-sisipan-input-non-mapel/importExcel') }}"><i
