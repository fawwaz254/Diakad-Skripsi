        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data) {
                    return `<span class="badge bg-pink">` + data.prestasi_siswa_not_approved +
                        ` belum diapprove</span> <span class="badge bg-teal">` + data
                        .prestasi_siswa_approved + ` sudah diapprove</span>`
                }
            },
            {
                data: 'kegiatan',
                ...
                orderable: false,
                render: function(data) {
                    return `<span class="badge bg-pink">` + data.kegiatan_siswa_not_approved +
                        ` belum diapprove</span> <span class="badge bg-teal">` + data
                        .kegiatan_siswa_approved + ` sudah diapprove</span>`
                }
            },
            {
                data: 'action',
