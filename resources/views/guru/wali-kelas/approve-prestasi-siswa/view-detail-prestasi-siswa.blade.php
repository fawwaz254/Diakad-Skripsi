...
<script>
    ...
    var datatable_url_prestasi = base_url + '/' + role_url + '/' + modul_url + '/' +
        'approve-prestasi-siswa/prestasi/datatables/' + id_siswa;
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data) {
                    if (data.status == 0) {
                        return '<button class="btn btn-info" onclick="approveAction(\'' +
    ...
    var datatable_url_kegiatan = base_url + '/' + role_url + '/' + modul_url + '/' +
        'approve-prestasi-siswa/kegiatan/datatables/' + id_siswa;
