        ...
        <h2>
            ...
            <a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#' . Request::segment(2) . '/' . Request::segment(3) . '/' . Request::segment(4) . '/add/' . $id_siswa) }}"><i
                    class="material-icons">note_add</i><span>Tambah Informasi Tambahan</span></a>
        </h2>
    </div>
...
<script>
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' +
        'input-skpi-siswa/informasi-tambahan/datatables';
    var edit_url = role_url + '#' + modul_url + '/' + 'input-skpi-siswa/informasi-tambahan/edit';
    var delete_url = base_url + '/' + role_url + '/' + modul_url + '/' +
        'input-skpi-siswa/informasi-tambahan/action/delete';
