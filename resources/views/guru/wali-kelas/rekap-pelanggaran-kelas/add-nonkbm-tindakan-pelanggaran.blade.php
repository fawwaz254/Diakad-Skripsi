            ...
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="POST"
                        action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/action-tindakan-pelanggaran/add-nonkbm/' . $id_tindakan_pelanggaran) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="form-control" aria-invalid="true" readonly
                                    value="{{ $data_pelanggaran_siswa->nm_siswa }}">
                            </div>
                        </div>
                        <h2 class="card-inside-title">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="form-control" aria-invalid="true" readonly
                                    value="{{ $data_pelanggaran_siswa->catatan_pelanggaran }}">
                            </div>
                        </div>
                        @if ($id_pengguna == $data_pelanggaran_siswa->created_by)
                            <h2 class="card-inside-title">
                                Catatan Khusus <sup style="color: red"> Readonly</sup>
                                <small><b>* Ditampilkan Khusus, Tidak Untuk Diakses User Lain</b></small>
                            </h2>
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <input type="hidden" class="form-control" name="id_pelanggaran_siswa" required=""
                                    aria-required="true" aria-invalid="true"
                                    value="{{ $data_pelanggaran_siswa->id_pelanggaran_siswa }}">
                            </div>
                        </div>
                        <div class="row clearfix">
