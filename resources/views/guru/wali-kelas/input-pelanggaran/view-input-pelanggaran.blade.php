<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link" href="{{url(Request::segment(1).'#wali-kelas/input-pelanggaran/add')}}"><i class="material-icons">note_add</i><span>Tambah Pelanggaran Siswa</span></a></h2>
    </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                    ...
                    <div class="header bg-orange">
                        <h2>DATA PELANGGARAN SISWA KELAS {{$wali_kelas->nm_kelas}}</h2>
                    </div>
                    <div class="body">
