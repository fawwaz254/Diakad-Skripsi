                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <a href="{{ $f->is_google_drive == 1 ? $f->link_file : Storage::disk('spaces')->url($f->link_file) }}"
                                    ...
                                    <div class="file">
                                        <div style="text-align: center;">
                                            ...
                                            @elseif($f->extension_file == 'png' || $f->extension_file == 'jpg' ||
                                            $f->extension_file == 'jpeg')
                                            <i class="material-icons"
                                                style="color:blue;font-size: 45px;width:45px">collections_icon</i>
                                            @elseif($f->extension_file == 'pptx' || $f->extension_file == 'docx' ||
                                            $f->extension_file == 'xlsx')
                                            <i class="material-icons"
                                ...
                                <div class="form-check delete-many"
                                    ...
                                    <input type="checkbox" class="form-check-input" value="{{ $f->file_pengguna_id }}"
                                        name="id_file[]" id="id_file[{{ $f->file_pengguna_id }}]" required>
