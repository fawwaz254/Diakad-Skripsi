<div class="container-fluid">
    ...
    <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="block-header">
            <a class="btn btn-block bg-red waves-effect" href="{{url(Request::segment(1).'/'. $auth_data->modul_url .'/'. $auth_data->menu_url. '/print/'.$id_semester.'/'.$id_ekskul)}}" target="_blank"><i class="material-icons">print</i><span>Cetak</span></a>
        </div>
    </div>
