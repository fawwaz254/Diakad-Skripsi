<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#ekstrakurikuler/setting-peserta-ekskul/view-ekskul/' . $id_semester . '/' . $id_ekskul) }}"><i
            ...
            <div class="card">
                ...
                <div class="body">
                    <form id="form-validation" method="POST"
                        action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/post-add-setting-peserta-ekskul') }}">
                        {{ csrf_field() }}
                                    ...
                                    <select class="form-control show-tick" name="id_kelas">
                                        @foreach ($data_kelas as $data)
                                            <option value="{{ $data->id_kelas }}"
                                                @if ($id_kelas == $data->id_kelas) selected @endif>{{ $data->nm_kelas }}
                                            </option>
                                        @endforeach
                                    </select>
                                @else
...
<script>
    ...
    var datatable_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'setting-peserta-ekskul/datatables-siswa/' +
        id_kelas;
