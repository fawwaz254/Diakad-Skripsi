    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card is-gap">
                ...
                <div class="body">
                    <form id="form-validation" method="POST" action="{{url(Request::segment(1).'/'.Request::segment(2).'/post-view-setting-peserta-ekskul')}}">
                        {{csrf_field()}}
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                @if($id_ekskul != null)
                                    <select class="form-control show-tick" name="id_ekskul">
                                        ...
                                        <option value="{{$data->id_ekskul}}" @if($id_ekskul == $data->id_ekskul) selected @endif>{{$data->nm_ekskul}}</option>
                                        @endforeach
                                    </select>
                                @else
                                    <select class="form-control show-tick" name="id_ekskul">
