    ...
    <div class="block-header">
        <h2>
            <a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#ekstrakurikuler/setting-pelatih-ekskul/view-pelatih') }}"><i
                    class="material-icons">people</i><span>Data Pelatih Ekskul</span></a>
        </h2>
    </div>
