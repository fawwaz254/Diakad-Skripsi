    ...
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#ekstrakurikuler/setting-pelatih-ekskul') }}"><i
                    class="material-icons">backspace</i><span>Kembali</span></a></h2><br>
        <h2>
            <a class="btn bg-blue waves-effect target-link"
                href="{{ url(Request::segment(1) . '#ekstrakurikuler/setting-pelatih-ekskul/add') }}"><i
                    class="material-icons">note_add</i><span>Tambah Data Pelatih Ekskul</span></a>
        </h2>
    </div>
...
<script>
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'nomor_hp_pelatih_ekskul',
                name: 'nomor_hp_pelatih_ekskul'
            },
            {
                data: 'alamat_pelatih_ekskul',
                name: 'alamat_pelatih_ekskul'
            },
            {
                data: 'is_aktif',
                name: 'is_aktif'
