<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link " href="{{url(Request::segment(1).'#siswa/evaluasi-siswa/view-detail/'.$nis_nama_siswa_asli)}}"><i class="material-icons">backspace</i><span>Kembali</span></a></h2>
    </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="body">
                    ...
                    <div class="table-responsive">
                       <table class="table table-bordered table-striped table-hover dataTable display responsive nowrap" id="primary_table_beasiswa">
                            <thead>
                                <tr>
                                    <th>No. </th>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="body">
                    ...
                    <div class="table-responsive">
                       <table class="table table-bordered table-striped table-hover dataTable display responsive nowrap" id="primary_table_prestasi">
                            <thead>
                                <tr>
                                    <th>No. </th>
                                    <th>Nama Prestasi</th>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="body">
                    ...
                    <div class="table-responsive">
                       <table class="table table-bordered table-striped table-hover dataTable display responsive nowrap" id="primary_table_ekskul">
                            <thead>
                                <tr>
                                    <th>No. </th>
...
<script>
    ...
    var modul_url       = 'siswa';
    var datatable_url_beasiswa   = base_url + '/' + role_url + '/' + modul_url + '/' + 'evaluasi-siswa/datatables-beasiswa/' + nis_nama_siswa ;
    var datatable_url_prestasi   = base_url + '/' + role_url + '/' + modul_url + '/' + 'evaluasi-siswa/datatables-prestasi/' + nis_nama_siswa ;
    var datatable_url_ekskul   = base_url + '/' + role_url + '/' + modul_url + '/' + 'evaluasi-siswa/datatables-ekskul/' + nis_nama_siswa ;
    ...
    var primary_table_beasiswa = $('#primary_table_beasiswa').DataTable({
        ...
        columns: [
            ...
            { data: 'jenis_beasiswa_siswa', name: 'jenis_beasiswa_siswa' },
            { data: 'tahun_mulai_beasiswa_siswa', name: 'tahun_mulai_beasiswa_siswa' },
            { data: 'tahun_selesai_beasiswa_siswa', name: 'tahun_selesai_beasiswa_siswa' },
            { data: 'keterangan_beasiswa_siswa', name: 'keterangan_beasiswa_siswa' }
        ]
    });
    ...
    var primary_table_prestasi = $('#primary_table_prestasi').DataTable({
        ...
        columns: [
            ...
            { data: 'lokasi_penyelenggara', name: 'lokasi_penyelenggara' },
