<div class="container-fluid">
    <div class="block-header">
        <h2><a class="btn bg-blue waves-effect target-link " href="{{url(Request::segment(1).'#siswa/pembayaran/view-detail/'.$nis_nama_siswa_asli)}}"><i class="material-icons">backspace</i><span>Kembali</span></a></h2>
    </div>
...
<script>
    ...
    var modul_url                   = 'siswa';
    var datatable_tagihan_url       = base_url + '/' + role_url + '/' + modul_url + '/' + 'pembayaran/datatables-tagihan/' + id_pengguna + '/' + nis_nama_siswa;
    var datatable_riwayat_bayar_url = base_url + '/' + role_url + '/' + modul_url + '/' + 'pembayaran/datatables-riwayat-bayar/' + id_pengguna;
