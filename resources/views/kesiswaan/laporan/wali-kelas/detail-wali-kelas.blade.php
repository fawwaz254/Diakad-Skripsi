<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="header">
                    <h2>Data Laporan Wali Kelas Semester {{ $laporan_wali_kelas->semester->tahun_ajaran }}
...
<form id="form-validation" method="post"
    action="{{ url(Request::segment(1) . '/' . Request::segment(2) . '/wali-kelas/action-detail-wali-kelas') }}">
    {{ csrf_field() }}
    <!-- Modal Update Status -->
    ...
    var primary_table = $('#primary_table').DataTable({
        ...
        columns: [{
            ...
            },
            {
                ...
                orderable: false,
                render: function(data) {
                    return '<a class="btn btn-info btn-circle waves-effect waves-circle waves-float" onclick="updateStatus(\'' +
                        data.id + '\', \`pengajuan`\)">' +
    ...
    function updateStatus(id) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var nama = response.guru.pengguna.gelar_depan + ' ' + response.guru.pengguna.nm_pengguna +
                    ' ' + response.guru.pengguna.gelar_belakang;
                $('#nama').val(nama);
