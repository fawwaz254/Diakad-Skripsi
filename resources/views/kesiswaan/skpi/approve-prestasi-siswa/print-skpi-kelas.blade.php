...
<body>
    @foreach ($data as $dsiswa)
        @php
            ...
            $prestasi = $kprestasi->where('id_siswa', $dsiswa->id_siswa);
            $kegiatan = $kkegiatan->where('id_siswa', $dsiswa->id_siswa);
            $informasi_tambahan_ekstrakurikuler = $kinformasi_tambahan_ekstrakurikuler->where(
                'id_siswa',
                $dsiswa->id_siswa,
            );
            $informasi_produk_lomba = $kinformasi_produk_lomba->where('id_siswa', $dsiswa->id_siswa);
            $informasi_tambahan = $kinformasi_tambahan->where('id_siswa', $dsiswa->id_siswa);
        @endphp
        <div class="bg">
            <img class="logo"
        ...
        @endif --}}
            ...
            <table class="bg-color"
                style="width: 80%;border-collapse: collapse;margin-left: auto;margin-right: auto;">
                <tr>
                ...
                <tr>
                    ...
                    <td>Memiliki kemampuan hidup mandiri, kerjasama, disiplin, tanggung jawab, dan tenggang rasa
                        terhadap
                        sesama
                    </td>
                    {{-- @if ($siswa->keterangan_kelas == 'Internasional') --}}
                ...
                <tr>
                    ...
                    <td>Bekerjasama dan memiliki kepekaan sosial serta kepedulian terhadap masyarakat dan lingkungannya
                    </td>
                    {{-- @if ($siswa->keterangan_kelas == 'Internasional') --}}
            ...
            <table class="bg-color"
                style="width: 80%;margin-top: -20px; border-collapse: collapse; margin-left: auto;">
                <tr>
                    <td>3.{{ $urutan }}1</td>
