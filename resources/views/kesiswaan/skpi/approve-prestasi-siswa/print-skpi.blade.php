...
<body>
  ...
  margin-right: auto; background-color: rgb(214, 227, 188);">
      <tr>
        <td colspan=9>
          <p align="center">Alamat : {{ $auth_data->sekolah_data->alamat_jalan }}
            {{ $auth_data->sekolah_data->alamat_kelurahan }} Tlp. {{ $auth_data->sekolah_data->nomor_telp_sekolah }} –
            {{ $auth_data->sekolah_data->nomor_fax_sekolah }} Kecamatan {{ $auth_data->sekolah_data->alamat_kecamatan }}
            Kabupaten {{ $auth_data->sekolah_data->kota->nm_kota }}, Kode Pos
            {{ $auth_data->sekolah_data->alamat_kodepos }} <br>E-mail : {{ $auth_data->sekolah_data->email_sekolah }}
    ...
    <table class="header" cellspacing="0" cellpadding="10" style="width: 100%;">
      @if($siswa->keterangan_kelas == 'Internasional')
      <h4 class="text-center" style="margin-top: 10px; font-family: 'Franklin Gothic Demi Cond, monospace"><b>SURAT
          KETERANGAN PENDAMPING IJAZAH</b></h4>
      @else
      <h4 class="text-center" style="margin-top: 20px;  font-family: 'Franklin Gothic Demi Cond, monospace"><b>SURAT
          KETERANGAN PENDAMPING IJAZAH</b></h4>
      @endif
    ...
    margin-right: auto;">Surat Keterangan Pendamping Ijazah yang dikeluarkan oleh
        {{ $auth_data->sekolah_data->nm_sekolah }} sebagai pelengkap ijazah yang menerangkan capaian pembelajaran dan
        prestasi dari pemegang ijazah selama masa studi
        @if($siswa->keterangan_kelas == 'Internasional')
        <br><i>The Diploma Supplement is issued by {{ $auth_data->sekolah_data->nm_sekolah }} Sidoarjo accompanies a
          higher education certificate providing a standardized description of the nature, level, context, content, and
...
margin-right: auto;">
        ...
        <tr>
          ...
          @if($siswa->keterangan_kelas == 'Internasional')
          <td style="width: 55%;"><i>Have the ability to live independently, cooperation, discipline, responsibility,
        ...
        <table cellspacing="0" style="width: 80%; border:none; margin:auto; text-align:left; ">
          ...
          <tr style="vertical-align: top;top:20px">
            ...
            <td style="border: none; position: relative;">
              ...
              <img style="position: absolute; top: 5%;" src="{{ asset('media/ttd/smpypm1.png') }}" alt="TTD"
                width="160px" height="160px" class="ttd">
              <br>
              <br>
              <br>
              <br>
