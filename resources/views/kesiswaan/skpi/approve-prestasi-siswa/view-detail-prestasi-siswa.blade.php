...
<script>
    ...
    var datatable_url_prestasi = base_url + '/' + role_url + '/' + modul_url + '/' +
        'approve-prestasi-siswa/prestasi/datatables/' + id_siswa + '/' + param;
            ...
            },
            {
                ...
                render: function(data) {
                    ...
                    html += ' <a class="btn btn-warning" href="' + edit_prestasi + '/' + data.id +
                        ...
                        '</a> '
                    if (data.status == 0) {
                        html += '<button class="btn btn-info" onclick="approveAction(\'' +
                            approve_prestasi + '\', this)" data-id="' + data.id + '">' +
                            'Aprrove' +
                            '</button>';
    ...
    // datatable kegiatan
    var datatable_url_kegiatan = base_url + '/' + role_url + '/' + modul_url + '/' +
        'approve-prestasi-siswa/kegiatan/datatables/' + id_siswa + '/' + param;
    ...
    var primary_table2 = $('#primary_table2').DataTable({
        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data) {
                    html = '';
                    html += ' <a class="target-link btn btn-warning" href="' + edit_kegiatan + '/' +
                        data.id + '">' +
                        'Edit' +
                        '</a> '
                    if (data.status == 0) {
                        html += '<button class="btn btn-info" onclick="approveAction(\'' +
                            approve_kegiatan + '\', this)" data-id="' + data.id + '">' +
                            'Aprrove' +
                            '</button>';
                        html += ' <button class="btn btn-danger" onclick="rejectAction(\'' +
    ...
    var datatable_url_informasi_tambahan = base_url + '/' + role_url + '/' + modul_url + '/' +
        'approve-prestasi-siswa/informasi-tambahan/datatables/' + id_siswa + '/' + param;
    var approve_informasi_tambahan = base_url + '/' + role_url + '/' + modul_url + '/' +
        'approve-prestasi-siswa/informasi-tambahan';
    var reject_informasi_tambahan = base_url + '/' + role_url + '/' + modul_url + '/' +
        'reject-prestasi-siswa/informasi-tambahan';
    ...
    var primary_table3 = $('#primary_table3').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'jenis_informasi_tambahan',
                name: 'jenis_informasi_tambahan'
            },
            {
                data: 'nm_informasi_tambahan',
                name: 'nm_informasi_tambahan'
            },
            {
                data: 'nm_informasi_tambahan_eng',
                name: 'nm_informasi_tambahan_eng'
            },
            {
                data: 'keterangan',
                name: 'keterangan',
            ...
            },
            {
                ...
                render: function(data) {
                    html = '';
                    html += ' <a class="target-link btn btn-warning" href="' + edit_informasi_tambahan +
                        '/' + data.id + '">' +
                        'Edit' +
                        '</a> '
                    if (data.status == 0) {
