<div class="container-fluid">
    <div class="block-header">
        <h2>
            <a class="btn bg-blue waves-effect" href="{{url(Request::segment(1).'/skpi/approve-prestasi-siswa/print-skpi/'.Request::segment(4))}}"><i class="material-icons">print</i><span>Print SKPI</span></a>
        </h2>
    </div>
